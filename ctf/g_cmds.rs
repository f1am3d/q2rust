...
extern "C" {
    ...
    fn PMenu_Next(ent: *mut edict_t);
    fn PMenu_Prev(ent: *mut edict_t);
    fn PMenu_Select(ent: *mut edict_t);
    ...
    fn CTFTeam_f(ent: *mut edict_t);
    fn CTFID_f(ent: *mut edict_t);
    fn CTFSay_Team(who: *mut edict_t, msg: *mut libc::c_char);
    fn CTFWhat_Tech(ent: *mut edict_t) -> *mut gitem_t;
    fn CTFOpenJoinMenu(ent: *mut edict_t);
    fn CTFVoteYes(ent: *mut edict_t);
    fn CTFVoteNo(ent: *mut edict_t);
    fn CTFReady(ent: *mut edict_t);
    fn CTFNotReady(ent: *mut edict_t);
    fn CTFGhost(ent: *mut edict_t);
    fn CTFAdmin(ent: *mut edict_t);
    fn CTFStats(ent: *mut edict_t);
    fn CTFWarp(ent: *mut edict_t);
    fn CTFBoot(ent: *mut edict_t);
    fn CTFPlayerList(ent: *mut edict_t);
    fn ChasePrev(ent: *mut edict_t);
    fn CTFObserver(ent: *mut edict_t);
}
...
pub const CTF_TEAM2: C2RustUnnamed_0 = 2;
pub const CTF_TEAM1: C2RustUnnamed_0 = 1;
pub const CTF_NOTEAM: C2RustUnnamed_0 = 0;
#[no_mangle]
...
pub unsafe extern "C" fn Cmd_Drop_f(mut ent: *mut edict_t) {
    ...
    let mut s: *mut libc::c_char = 0 as *mut libc::c_char;
    if Q_stricmp(
        (gi.args).expect("non-null function pointer")(),
        b"tech\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
        && {
            it = CTFWhat_Tech(ent);
            !it.is_null()
...
pub unsafe extern "C" fn Cmd_Inven_f(mut ent: *mut edict_t) {
    ...
    if (*ctf).value != 0. && (*cl).resp.ctf_team == CTF_NOTEAM as libc::c_int {
        CTFOpenJoinMenu(ent);
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn Cmd_LastWeap_f(mut ent: *mut edict_t) {
    let mut cl: *mut gclient_t = 0 as *mut gclient_t;
    cl = (*ent).client;
    if ((*cl).pers.weapon).is_null() || ((*cl).pers.lastweapon).is_null() {
        return;
    }
    ((*(*cl).pers.lastweapon).use_0)
        .expect("non-null function pointer")(ent, (*cl).pers.lastweapon);
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn CheckFlood(mut ent: *mut edict_t) -> qboolean {
    let mut i: libc::c_int = 0;
    let mut cl: *mut gclient_t = 0 as *mut gclient_t;
            ...
            if !((*other).client).is_null() {
                if team as u64 != 0 {
                    if OnSameTeam(ent, other) as u64 == 0 {
                        current_block_28 = 18386322304582297246;
                    } else {
                        current_block_28 = 1538046216550696469;
                    }
                } else {
                    current_block_28 = 1538046216550696469;
                }
...
pub unsafe extern "C" fn ClientCommand(mut ent: *mut edict_t) {
    ...
    {
        CTFSay_Team(ent, (gi.args).expect("non-null function pointer")());
        return;
    }
    if Q_stricmp(
        cmd,
    ...
    ) == 0 as libc::c_int
    {
        ...
        cmd,
        b"team\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
    {
        CTFTeam_f(ent);
    } else if Q_stricmp(
    ...
    ) == 0 as libc::c_int
    {
        ...
        cmd,
        b"ready\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
    {
        CTFReady(ent);
    } else if Q_stricmp(
        cmd,
        b"notready\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
    {
        CTFNotReady(ent);
    } else if Q_stricmp(
        cmd,
        b"ghost\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
    {
        CTFGhost(ent);
    } else if Q_stricmp(
        cmd,
        b"admin\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
    {
        CTFAdmin(ent);
    } else if Q_stricmp(
    ...
    ) == 0 as libc::c_int
    {
        ...
        cmd,
        b"warp\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
    {
        CTFWarp(ent);
    } else if Q_stricmp(
        cmd,
        b"boot\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
    {
        CTFBoot(ent);
    } else if Q_stricmp(
    ...
    ) == 0 as libc::c_int
    {
        ...
        cmd,
        b"observer\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0 as libc::c_int
    {
        CTFObserver(ent);
    } else {
