...
extern "C" {
    ...
    fn CTFDrop_Tech(ent: *mut edict_t, item: *mut gitem_t);
    fn CTFPickup_Tech(ent: *mut edict_t, other: *mut edict_t) -> qboolean;
    fn CTFDrop_Flag(ent: *mut edict_t, item: *mut gitem_t) -> qboolean;
    fn CTFPickup_Flag(ent: *mut edict_t, other: *mut edict_t) -> qboolean;
    static mut ctf: *mut cvar_t;
    fn G_FreeEdict(e: *mut edict_t);
    fn CTFHasRegeneration(ent: *mut edict_t) -> qboolean;
    ...
    fn CTFWeapon_Grapple(ent: *mut edict_t);
    fn CTFFlagSetup(ent: *mut edict_t);
...
pub unsafe extern "C" fn DoRespawn(mut ent: *mut edict_t) {
    if !((*ent).team).is_null() {
        ...
        if (*ctf).value != 0.
            && (*dmflags).value as libc::c_int & 0x4 as libc::c_int != 0
            && !((*master).item).is_null()
            && (*(*master).item).flags & 1 as libc::c_int != 0
        {
            ent = master;
        } else {
...
pub unsafe extern "C" fn MegaHealth_think(mut self_0: *mut edict_t) {
    if (*(*self_0).owner).health > (*(*self_0).owner).max_health
        && CTFHasRegeneration((*self_0).owner) as u64 == 0
    {
...
pub unsafe extern "C" fn Pickup_Health(
    ...
    if (*other).health >= 250 as libc::c_int && (*ent).count > 25 as libc::c_int {
        return false_0;
    }
    (*other).health += (*ent).count;
    if (*other).health > 250 as libc::c_int && (*ent).count > 25 as libc::c_int {
        (*other).health = 250 as libc::c_int;
    }
    if (*ent).style & 1 as libc::c_int == 0 {
        if (*other).health > (*other).max_health {
            (*other).health = (*other).max_health;
    ...
    if (*ent).style & 2 as libc::c_int != 0 && CTFHasRegeneration(other) as u64 == 0 {
...
pub unsafe extern "C" fn SpawnItem(mut ent: *mut edict_t, mut item: *mut gitem_t) {
    ...
    *fresh36 = Some(droptofloor as unsafe extern "C" fn(*mut edict_t) -> ());
        ...
        ) == 0 as libc::c_int
    {
        ...
        *fresh37 = Some(CTFFlagSetup as unsafe extern "C" fn(*mut edict_t) -> ());
    }
}
#[no_mangle]
pub static mut itemlist: [gitem_t; 50] = unsafe {
    [
        {
        ...
        {
            let mut init = gitem_s {
                classname: b"weapon_grapple\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup: None,
                use_0: Some(
                ...
                drop: None,
                weaponthink: Some(
                    CTFWeapon_Grapple as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
                pickup_sound: b"misc/w_pkup.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                world_model: 0 as *const libc::c_char as *mut libc::c_char,
                world_model_flags: 0 as libc::c_int,
                view_model: b"models/weapons/grapple/tris.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                icon: b"w_grapple\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup_name: b"Grapple\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                count_width: 0 as libc::c_int,
                quantity: 0 as libc::c_int,
                ammo: 0 as *const libc::c_char as *mut libc::c_char,
                flags: 1 as libc::c_int,
                weapmodel: 12 as libc::c_int,
                info: 0 as *const libc::c_void as *mut libc::c_void,
                tag: 0 as libc::c_int,
                precaches: b"weapons/grapple/grfire.wav weapons/grapple/grpull.wav weapons/grapple/grhang.wav weapons/grapple/grreset.wav weapons/grapple/grhit.wav\0"
        ...
        },
        {
            let mut init = gitem_s {
                ...
                use_0: None,
                drop: ::std::mem::transmute::<
                    Option::<
                        unsafe extern "C" fn(*mut edict_t, *mut gitem_t) -> qboolean,
                    >,
                    Option::<unsafe extern "C" fn(*mut edict_s, *mut gitem_s) -> ()>,
                >(
                    Some(
                        CTFDrop_Flag
                            as unsafe extern "C" fn(
                ...
                weaponthink: None,
                pickup_sound: b"ctf/flagtk.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                world_model: b"players/male/flag1.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                world_model_flags: 0x40000 as libc::c_int,
                view_model: 0 as *const libc::c_char as *mut libc::c_char,
                icon: b"i_ctf1\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup_name: b"Red Flag\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                count_width: 2 as libc::c_int,
                quantity: 0 as libc::c_int,
                ammo: 0 as *const libc::c_char as *mut libc::c_char,
                ...
                info: 0 as *const libc::c_void as *mut libc::c_void,
                tag: 0 as libc::c_int,
                precaches: b"ctf/flagcap.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
            };
            init
        },
        {
            let mut init = gitem_s {
                ...
                pickup_sound: b"ctf/flagtk.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                world_model: b"players/male/flag2.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                world_model_flags: 0x80000 as libc::c_int,
                view_model: 0 as *const libc::c_char as *mut libc::c_char,
                icon: b"i_ctf2\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup_name: b"Blue Flag\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                count_width: 2 as libc::c_int,
                quantity: 0 as libc::c_int,
                ammo: 0 as *const libc::c_char as *mut libc::c_char,
        ...
        {
            let mut init = gitem_s {
                classname: b"item_tech1\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup: Some(
                    CTFPickup_Tech
                        as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> qboolean,
                ...
                pickup_sound: b"items/pkup.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                world_model: b"models/ctf/resistance/tris.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                world_model_flags: 0x1 as libc::c_int,
                view_model: 0 as *const libc::c_char as *mut libc::c_char,
                icon: b"tech1\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup_name: b"Disruptor Shield\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                count_width: 2 as libc::c_int,
                quantity: 0 as libc::c_int,
                ammo: 0 as *const libc::c_char as *mut libc::c_char,
                flags: 64 as libc::c_int,
                weapmodel: 0 as libc::c_int,
                info: 0 as *const libc::c_void as *mut libc::c_void,
                tag: 0 as libc::c_int,
                precaches: b"ctf/tech1.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
            };
            init
        },
        {
            let mut init = gitem_s {
                classname: b"item_tech2\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup: Some(
                    CTFPickup_Tech
                        as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> qboolean,
                ...
                pickup_sound: b"items/pkup.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                world_model: b"models/ctf/strength/tris.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                world_model_flags: 0x1 as libc::c_int,
                view_model: 0 as *const libc::c_char as *mut libc::c_char,
                icon: b"tech2\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup_name: b"Power Amplifier\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                count_width: 2 as libc::c_int,
                quantity: 0 as libc::c_int,
                ammo: 0 as *const libc::c_char as *mut libc::c_char,
                ...
                info: 0 as *const libc::c_void as *mut libc::c_void,
                tag: 0 as libc::c_int,
                precaches: b"ctf/tech2.wav ctf/tech2x.wav\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
            };
            init
        },
        {
            let mut init = gitem_s {
                classname: b"item_tech3\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup: Some(
                    CTFPickup_Tech
                        as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> qboolean,
                ...
                pickup_sound: b"items/pkup.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                world_model: b"models/ctf/haste/tris.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                world_model_flags: 0x1 as libc::c_int,
                view_model: 0 as *const libc::c_char as *mut libc::c_char,
                icon: b"tech3\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup_name: b"Time Accel\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                count_width: 2 as libc::c_int,
                quantity: 0 as libc::c_int,
                ammo: 0 as *const libc::c_char as *mut libc::c_char,
                ...
                info: 0 as *const libc::c_void as *mut libc::c_void,
                tag: 0 as libc::c_int,
                precaches: b"ctf/tech3.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
            };
            init
        },
        {
            let mut init = gitem_s {
                classname: b"item_tech4\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup: Some(
                    CTFPickup_Tech
                        as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> qboolean,
                ...
                pickup_sound: b"items/pkup.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                world_model: b"models/ctf/regeneration/tris.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                world_model_flags: 0x1 as libc::c_int,
                view_model: 0 as *const libc::c_char as *mut libc::c_char,
                icon: b"tech4\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                pickup_name: b"AutoDoc\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                count_width: 2 as libc::c_int,
                quantity: 0 as libc::c_int,
                ammo: 0 as *const libc::c_char as *mut libc::c_char,
                ...
                info: 0 as *const libc::c_void as *mut libc::c_void,
                tag: 0 as libc::c_int,
                precaches: b"ctf/tech4.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
            };
            init
        },
...
pub unsafe extern "C" fn SP_item_health(mut self_0: *mut edict_t) {
    ...
    *fresh38 = b"models/items/healing/medium/tris.md2\0" as *const u8
        as *const libc::c_char as *mut libc::c_char;
...
pub unsafe extern "C" fn SP_item_health_small(mut self_0: *mut edict_t) {
    ...
    *fresh39 = b"models/items/healing/stimpack/tris.md2\0" as *const u8
        as *const libc::c_char as *mut libc::c_char;
...
pub unsafe extern "C" fn SP_item_health_large(mut self_0: *mut edict_t) {
    ...
    *fresh40 = b"models/items/healing/large/tris.md2\0" as *const u8
        as *const libc::c_char as *mut libc::c_char;
...
pub unsafe extern "C" fn SP_item_health_mega(mut self_0: *mut edict_t) {
    ...
    let ref mut fresh41 = (*self_0).model;
    *fresh41 = b"models/items/mega_h/tris.md2\0" as *const u8 as *const libc::c_char
        as *mut libc::c_char;
...
pub unsafe extern "C" fn InitItems() {
    game
        .num_items = (::std::mem::size_of::<[gitem_t; 50]>() as libc::c_ulong)
