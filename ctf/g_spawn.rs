...
extern "C" {
    ...
    fn CTFSpawn();
    fn SP_info_player_team1(self_0: *mut edict_t);
    fn SP_info_player_team2(self_0: *mut edict_t);
    fn SP_misc_ctf_banner(ent: *mut edict_t);
    fn SP_misc_ctf_small_banner(ent: *mut edict_t);
    static mut ctf_statusbar: *mut libc::c_char;
    fn SP_trigger_teleport(ent: *mut edict_t);
    fn SP_info_teleport_destination(ent: *mut edict_t);
...
#[no_mangle]
pub static mut spawns: [spawn_t; 86] = unsafe {
    [
        {
        ...
        {
            let mut init = spawn_t {
                name: b"info_player_team1\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                spawn: Some(
                    SP_info_player_team1 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = spawn_t {
                name: b"info_player_team2\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                spawn: Some(
                    SP_info_player_team2 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        {
            let mut init = spawn_t {
                name: b"misc_ctf_banner\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                spawn: Some(
                    SP_misc_ctf_banner as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = spawn_t {
                name: b"misc_ctf_small_banner\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                spawn: Some(
                    SP_misc_ctf_small_banner as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        {
            let mut init = spawn_t {
                name: b"trigger_teleport\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                spawn: Some(
                    SP_trigger_teleport as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = spawn_t {
                name: b"info_teleport_destination\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                spawn: Some(
...
pub unsafe extern "C" fn SpawnEntities(
    ...
    loop {
        ...
        if stricmp(
            ...
            && stricmp((*ent).model, b"*27\0" as *const u8 as *const libc::c_char) == 0
        {
...
#[no_mangle]
pub static mut dm_statusbar: *mut libc::c_char = b"yb\t-24 xv\t0 hnum xv\t50 pic 0 if 2 \txv\t100 \tanum \txv\t150 \tpic 2 endif if 4 \txv\t200 \trnum \txv\t250 \tpic 4 endif if 6 \txv\t296 \tpic 6 endif yb\t-50 if 7 \txv\t0 \tpic 7 \txv\t26 \tyb\t-42 \tstat_string 8 \tyb\t-50 endif if 9 \txv\t246 \tnum\t2\t10 \txv\t296 \tpic\t9 endif if 11 \txv\t148 \tpic\t11 endif xr\t-50 yt 2 num 3 14\0"
    as *const u8 as *const libc::c_char as *mut libc::c_char;
#[no_mangle]
pub unsafe extern "C" fn SP_worldspawn(mut ent: *mut edict_t) {
    ...
    if (*deathmatch).value != 0. {
        if (*ctf).value != 0. {
            (gi.configstring)
                .expect("non-null function pointer")(5 as libc::c_int, ctf_statusbar);
            (gi.imageindex)
                .expect(
                    "non-null function pointer",
            ...
            (gi.imageindex)
                .expect(
                    "non-null function pointer",
                )(b"i_ctf1t\0" as *const u8 as *const libc::c_char as *mut libc::c_char);
            (gi.imageindex)
                .expect(
                    "non-null function pointer",
                )(b"i_ctf2t\0" as *const u8 as *const libc::c_char as *mut libc::c_char);
            (gi.imageindex)
                .expect(
                    "non-null function pointer",
