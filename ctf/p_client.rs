...
extern "C" {
    ...
    fn CTFStartClient(ent: *mut edict_t) -> qboolean;
    fn UpdateChaseCam(ent: *mut edict_t);
    fn CTFDeadDropTech(ent: *mut edict_t);
    fn CTFDeadDropFlag(self_0: *mut edict_t);
    ...
    fn CTFAssignSkin(ent: *mut edict_t, s: *mut libc::c_char);
    fn SelectCTFSpawnPoint(ent: *mut edict_t) -> *mut edict_t;
    fn CTFApplyRegeneration(ent: *mut edict_t);
    fn CTFAssignTeam(who: *mut gclient_t);
    fn CTFMatchOn() -> qboolean;
    ...
    fn CTFGrapplePull(self_0: *mut edict_t);
...
pub const CTF_TEAM1: C2RustUnnamed_2 = 1;
pub type C2RustUnnamed_2 = libc::c_uint;
pub const CTF_TEAM2: C2RustUnnamed_2 = 2;
pub const CTF_NOTEAM: C2RustUnnamed_2 = 0;
    ...
    loop {
        ...
        if VectorLength(d.as_mut_ptr()) < 384 as libc::c_int as libc::c_float {
            if ((*self_0).targetname).is_null()
                || stricmp((*self_0).targetname, (*spot).targetname) != 0 as libc::c_int
            {
...
unsafe extern "C" fn SP_CreateCoopSpots(mut self_0: *mut edict_t) {
    ...
    if stricmp(
        ...
        b"security\0" as *const u8 as *const libc::c_char,
    ) == 0 as libc::c_int
    {
        spot = G_Spawn();
...
pub unsafe extern "C" fn SP_info_player_coop(mut self_0: *mut edict_t) {
    ...
    if stricmp(
        (level.mapname).as_mut_ptr(),
        b"jail2\0" as *const u8 as *const libc::c_char,
    ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"jail4\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"mine1\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"mine2\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
        ...
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"mine4\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"lab\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"boss1\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"fact3\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"biggun\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
        ...
        || stricmp(
            (level.mapname).as_mut_ptr(),
            b"power2\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        || stricmp(
            (level.mapname).as_mut_ptr(),
        ...
        *fresh11 = attacker;
        if !attacker.is_null() && !((*attacker).client).is_null() {
            match mod_0 {
                ...
                34 => {
                    message = b"was caught by\0" as *const u8 as *const libc::c_char
                        as *mut libc::c_char;
                    message2 = b"'s grapple\0" as *const u8 as *const libc::c_char
                        as *mut libc::c_char;
                }
                _ => {}
            }
...
pub unsafe extern "C" fn player_die(
    ...
    *fresh22 = *fresh21;
    ...
    (*self_0).s.modelindex3 = 0 as libc::c_int;
    ...
    if (*self_0).deadflag == 0 {
        ...
        if (*ctf).value != 0. && meansOfDeath == 21 as libc::c_int
            && (*(*self_0).client).resp.ctf_state < 2 as libc::c_int
            && (*(*self_0).client).resp.ctf_team == (*(*attacker).client).resp.ctf_team
        {
            let ref mut fresh23 = (*(*attacker).client).resp.score;
            *fresh23 -= 1;
            (*(*self_0).client).resp.ctf_state = 0 as libc::c_int;
        }
        CTFFragBonuses(self_0, inflictor, attacker);
        TossClientWeapon(self_0);
        CTFPlayerResetGrapple(self_0);
        CTFDeadDropFlag(self_0);
        CTFDeadDropTech(self_0);
        if (*deathmatch).value != 0. && (*(*self_0).client).showscores as u64 == 0 {
            Cmd_Help_f(self_0);
        }
    }
    ...
    memset(
        ((*(*self_0).client).pers.inventory).as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if (*self_0).health < -(40 as libc::c_int) {
        ...
        (*(*self_0).client).anim_end = 0 as libc::c_int;
...
pub unsafe extern "C" fn InitClientPersistant(mut client: *mut gclient_t) {
    ...
    let ref mut fresh24 = (*client).pers.weapon;
    *fresh24 = item;
    let ref mut fresh25 = (*client).pers.lastweapon;
    *fresh25 = item;
    item = FindItem(
...
pub unsafe extern "C" fn InitClientResp(mut client: *mut gclient_t) {
    let mut ctf_team: libc::c_int = (*client).resp.ctf_team;
    let mut id_state: qboolean = (*client).resp.id_state;
    memset(
    ...
    if (*ctf).value != 0. && (*client).resp.ctf_team < CTF_TEAM1 as libc::c_int {
    ...
    while i < game.maxclients {
        ...
        if !((*ent).inuse as u64 == 0) {
            ...
            (*(game.clients).offset(i as isize))
                .pers
                .powerArmorActive = ((*ent).flags & 0x1000 as libc::c_int) as qboolean;
            if (*coop).value != 0. {
                (*(game.clients).offset(i as isize))
                    .pers
...
pub unsafe extern "C" fn FetchClientEntData(mut ent: *mut edict_t) {
    ...
    if (*(*ent).client).pers.powerArmorActive as u64 != 0 {
...
pub unsafe extern "C" fn SelectSpawnPoint(
    ...
    *origin
    ...
    let ref mut fresh27 = *origin.offset(2 as libc::c_int as isize);
    *fresh27 += 9 as libc::c_int as libc::c_float;
    *angles
...
pub unsafe extern "C" fn InitBodyQue() {
    ...
    while i < 8 as libc::c_int {
        ent = G_Spawn();
        let ref mut fresh28 = (*ent).classname;
        *fresh28 = b"bodyque\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        i += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn body_die(
    ...
    if (*self_0).health < -(40 as libc::c_int) {
        ...
        let ref mut fresh29 = (*self_0).s.origin[2 as libc::c_int as usize];
        *fresh29 -= 48 as libc::c_int as libc::c_float;
        ThrowClientHead(self_0, damage);
        (*self_0).takedamage = DAMAGE_NO as libc::c_int;
    }
}
...
pub unsafe extern "C" fn CopyToBodyQue(mut ent: *mut edict_t) {
    ...
    let ref mut fresh30 = (*body).owner;
    *fresh30 = (*ent).owner;
    (*body).movetype = (*ent).movetype;
    let ref mut fresh31 = (*body).die;
    *fresh31 = Some(
        body_die
            as unsafe extern "C" fn(
                *mut edict_t,
...
pub unsafe extern "C" fn PutClientInServer(mut ent: *mut edict_t) {
    ...
    if (*deathmatch).value != 0. {
        ...
        while n < 256 as libc::c_int {
            if (*itemlist.as_mut_ptr().offset(n as isize)).flags & 16 as libc::c_int != 0
            {
                resp
                    .coop_respawn
                    .inventory[n as usize] = (*client).pers.inventory[n as usize];
            }
            n += 1;
        }
    ...
    let ref mut fresh32 = (*ent).groundentity;
    *fresh32 = 0 as *mut edict_t;
    let ref mut fresh33 = (*ent).client;
    *fresh33 = &mut *(game.clients).offset(index as isize) as *mut gclient_t;
    (*ent).takedamage = DAMAGE_AIM as libc::c_int;
    (*ent).movetype = MOVETYPE_WALK as libc::c_int;
    (*ent).viewheight = 22 as libc::c_int;
    (*ent).inuse = true_0;
    let ref mut fresh34 = (*ent).classname;
    *fresh34 = b"player\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    ...
    let ref mut fresh35 = (*ent).model;
    *fresh35 = b"players/male/tris.md2\0" as *const u8 as *const libc::c_char
        as *mut libc::c_char;
    let ref mut fresh36 = (*ent).pain;
    *fresh36 = Some(
        player_pain
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    *fresh37 = Some(
    ...
    let ref mut fresh38 = (*ent).velocity[2 as libc::c_int as usize];
    *fresh38 = 0 as libc::c_int as vec_t;
    let ref mut fresh39 = (*ent).velocity[1 as libc::c_int as usize];
    *fresh39 = *fresh38;
    (*ent).velocity[0 as libc::c_int as usize] = *fresh39;
    memset(
    ...
    (*client)
        ...
        * 8 as libc::c_int as libc::c_float) as libc::c_short;
    let ref mut fresh40 = (*client).ps.pmove.pm_flags;
    *fresh40 = (*fresh40 as libc::c_int & !(64 as libc::c_int)) as byte;
    if (*deathmatch).value != 0.
    ...
    let ref mut fresh41 = (*ent).s.origin[2 as libc::c_int as usize];
    *fresh41 += 1 as libc::c_int as libc::c_float;
    (*ent)
        .s
    ...
    if CTFStartClient(ent) as u64 != 0 {
        return;
    }
    KillBox(ent) as u64 == 0;
    (gi.linkentity).expect("non-null function pointer")(ent);
    let ref mut fresh42 = (*client).newweapon;
    *fresh42 = (*client).pers.weapon;
    ChangeWeapon(ent);
}
#[no_mangle]
...
pub unsafe extern "C" fn ClientBegin(mut ent: *mut edict_t) {
    let mut i: libc::c_int = 0;
    let ref mut fresh43 = (*ent).client;
    *fresh43 = (game.clients)
        .offset(
    ...
    if (*ent).inuse as libc::c_uint == true_0 as libc::c_int as libc::c_uint {
        ...
        G_InitEdict(ent);
        let ref mut fresh44 = (*ent).classname;
        *fresh44 = b"player\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        InitClientResp((*ent).client);
        PutClientInServer(ent);
    }
...
pub unsafe extern "C" fn ClientConnect(
    ...
    if *(*password).string as libc::c_int != 0
        && strcmp((*password).string, b"none\0" as *const u8 as *const libc::c_char) != 0
...
pub unsafe extern "C" fn ClientDisconnect(mut ent: *mut edict_t) {
    ...
    (*ent).solid = SOLID_NOT;
    (*ent).inuse = false_0;
    let ref mut fresh46 = (*ent).classname;
    *fresh46 = b"disconnected\0" as *const u8 as *const libc::c_char
        as *mut libc::c_char;
...
pub unsafe extern "C" fn ClientThink(mut ent: *mut edict_t, mut ucmd: *mut usercmd_t) {
    ...
    while i < 3 as libc::c_int {
        pm
            .s
            .origin[i
            as usize] = ((*ent).s.origin[i as usize] * 8 as libc::c_int as libc::c_float)
            as libc::c_short;
        pm
            .s
            .velocity[i
            as usize] = ((*ent).velocity[i as usize] * 8 as libc::c_int as libc::c_float)
            as libc::c_short;
        i += 1;
    }
    if memcmp(
    ...
    let ref mut fresh47 = (*ent).groundentity;
    *fresh47 = pm.groundentity;
    if !(pm.groundentity).is_null() {
        (*ent).groundentity_linkcount = (*pm.groundentity).linkcount;
    }
    if (*ent).deadflag != 0 {
        (*client).ps.viewangles[2 as libc::c_int as usize] = 40 as libc::c_int as vec_t;
        (*client)
            .ps
    ...
    if !((*client).ctf_grapple).is_null() {
        CTFGrapplePull((*client).ctf_grapple as *mut edict_t);
    }
    (gi.linkentity).expect("non-null function pointer")(ent);
    if (*ent).movetype != MOVETYPE_NOCLIP as libc::c_int {
        G_TouchTriggers(ent);
    ...
    {
        if (*client).weapon_thunk as u64 == 0 {
    ...
    if (*client).menudirty as libc::c_uint != 0 && (*client).menutime <= level.time {
        PMenu_Do_Update(ent);
        (gi.unicast).expect("non-null function pointer")(ent, true_0);
        (*client).menutime = level.time;
        (*client).menudirty = false_0;
    }
}
#[no_mangle]
