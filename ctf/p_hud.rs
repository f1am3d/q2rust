...
extern "C" {
    ...
    fn CTFScoreboardMessage(ent: *mut edict_t, killer: *mut edict_t);
    ...
    fn CTFCalcScores();
    fn SetCTFStats(ent: *mut edict_t);
...
pub unsafe extern "C" fn BeginIntermission(mut targ: *mut edict_t) {
    ...
    if (*deathmatch).value != 0. && (*ctf).value != 0. {
        CTFCalcScores();
    }
...
pub unsafe extern "C" fn Cmd_Help_f(mut ent: *mut edict_t) {
    ...
    (*(*ent).client).resp.helpchanged = 0 as libc::c_int;
    HelpComputer(ent);
}
#[no_mangle]
pub unsafe extern "C" fn G_SetStats(mut ent: *mut edict_t) {
    ...
    if (*(*ent).client).resp.helpchanged != 0 && level.framenum & 8 as libc::c_int != 0 {
        (*(*ent).client)
            .ps
