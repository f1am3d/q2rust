...
pub unsafe extern "C" fn UpdateChaseCam(mut ent: *mut edict_t) {
    ...
    if (*(*(*ent).client).chase_target).inuse as u64 == 0
        || (*(*(*(*ent).client).chase_target).client).resp.spectator as libc::c_uint != 0
    {
        let mut old: *mut edict_t = (*(*ent).client).chase_target;
        ChaseNext(ent);
    ...
    if (*targ).deadflag != 0 {
        ...
        (*(*ent).client)
            .ps
            .viewangles[1 as libc::c_int as usize] = (*(*targ).client).killer_yaw;
    } else {
        (*(*ent).client)
            .ps
    ...
    let ref mut fresh2 = (*(*ent).client).ps.pmove.pm_flags;
    *fresh2 = (*fresh2 as libc::c_int | 64 as libc::c_int) as byte;
...
pub unsafe extern "C" fn ChaseNext(mut ent: *mut edict_t) {
    ...
    loop {
        ...
        if !((*e).inuse as u64 == 0) {
            if (*(*e).client).resp.spectator as u64 == 0 {
                break;
            }
        }
...
pub unsafe extern "C" fn ChasePrev(mut ent: *mut edict_t) {
    ...
    let ref mut fresh4 = (*(*ent).client).chase_target;
    *fresh4 = e;
    (*(*ent).client).update_chase = true_0;
}
#[no_mangle]
pub unsafe extern "C" fn GetChaseTarget(mut ent: *mut edict_t) {
    let mut i: libc::c_int = 0;
    let mut other: *mut edict_t = 0 as *mut edict_t;
    i = 1 as libc::c_int;
    while i as libc::c_float <= (*maxclients).value {
        other = g_edicts.offset(i as isize);
        if (*other).inuse as libc::c_uint != 0
            && (*(*other).client).resp.spectator as u64 == 0
        {
            let ref mut fresh5 = (*(*ent).client).chase_target;
            *fresh5 = other;
            (*(*ent).client).update_chase = true_0;
            UpdateChaseCam(ent);
            return;
    ...
    (gi.centerprintf)
        ...
        ent,
        b"No other players to chase.\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
}
