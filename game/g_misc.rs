...
pub unsafe extern "C" fn ThrowClientHead(
    ...
    *fresh16 += 32 as libc::c_int as libc::c_float;
    ...
    if !((*self_0).client).is_null() {
        ...
        let ref mut fresh17 = (*self_0).think;
        *fresh17 = None;
...
pub unsafe extern "C" fn ThrowDebris(
    ...
    (*chunk)
        ...
        as usize] = (rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float * 600 as libc::c_int as libc::c_float;
    let ref mut fresh18 = (*chunk).think;
    *fresh18 = Some(G_FreeEdict as unsafe extern "C" fn(*mut edict_t) -> ());
    (*chunk)
    ...
    let ref mut fresh19 = (*chunk).classname;
    *fresh19 = b"debris\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    (*chunk).takedamage = DAMAGE_YES as libc::c_int;
    let ref mut fresh20 = (*chunk).die;
    *fresh20 = Some(
        debris_die
            as unsafe extern "C" fn(
                *mut edict_t,
...
pub unsafe extern "C" fn path_corner_touch(
    ...
    if !((*self_0).pathtarget).is_null() {
        ...
        *fresh21 = (*self_0).pathtarget;
        G_UseTargets(self_0, other);
        let ref mut fresh22 = (*self_0).target;
        *fresh22 = savetarget;
    }
    ...
    if !next.is_null() && (*next).spawnflags & 1 as libc::c_int != 0 {
        ...
        (*other).s.event = EV_OTHER_TELEPORT as libc::c_int;
    }
    let ref mut fresh23 = (*other).movetarget;
    *fresh23 = next;
    let ref mut fresh24 = (*other).goalentity;
    *fresh24 = *fresh23;
    if (*self_0).wait != 0. {
...
pub unsafe extern "C" fn SP_path_corner(mut self_0: *mut edict_t) {
    ...
    let ref mut fresh25 = (*self_0).touch;
    *fresh25 = Some(
        path_corner_touch
            as unsafe extern "C" fn(
                *mut edict_t,
...
pub unsafe extern "C" fn point_combat_touch(
    ...
    if !((*self_0).target).is_null() {
        let ref mut fresh26 = (*other).target;
        *fresh26 = (*self_0).target;
        let ref mut fresh27 = (*other).movetarget;
        *fresh27 = G_PickTarget((*other).target);
        let ref mut fresh28 = (*other).goalentity;
        *fresh28 = *fresh27;
        if ((*other).goalentity).is_null() {
            ...
            let ref mut fresh29 = (*other).movetarget;
            *fresh29 = self_0;
        }
        let ref mut fresh30 = (*self_0).target;
    ...
    if (*other).movetarget == self_0 {
        let ref mut fresh31 = (*other).target;
        *fresh31 = 0 as *mut libc::c_char;
        let ref mut fresh32 = (*other).movetarget;
        *fresh32 = 0 as *mut edict_t;
        let ref mut fresh33 = (*other).goalentity;
        *fresh33 = (*other).enemy;
    ...
    if !((*self_0).pathtarget).is_null() {
        ...
        *fresh34 = (*self_0).pathtarget;
        ...
        let ref mut fresh35 = (*self_0).target;
        *fresh35 = savetarget;
    }
}
#[no_mangle]
pub unsafe extern "C" fn SP_point_combat(mut self_0: *mut edict_t) {
    ...
    (*self_0).solid = SOLID_TRIGGER;
    let ref mut fresh36 = (*self_0).touch;
    *fresh36 = Some(
        point_combat_touch
            as unsafe extern "C" fn(
                *mut edict_t,
...
pub unsafe extern "C" fn SP_viewthing(mut ent: *mut edict_t) {
    ...
    let ref mut fresh37 = (*ent).think;
    *fresh37 = Some(TH_viewthing as unsafe extern "C" fn(*mut edict_t) -> ());
}
#[no_mangle]
...
pub unsafe extern "C" fn SP_func_wall(mut self_0: *mut edict_t) {
    ...
    let ref mut fresh40 = (*self_0).use_0;
    *fresh40 = Some(
        func_wall_use
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
    );
...
pub unsafe extern "C" fn func_object_release(mut self_0: *mut edict_t) {
    (*self_0).movetype = MOVETYPE_TOSS as libc::c_int;
    let ref mut fresh41 = (*self_0).touch;
    *fresh41 = Some(
        func_object_touch
            as unsafe extern "C" fn(
                *mut edict_t,
...
pub unsafe extern "C" fn func_object_use(
    ...
    (*self_0).solid = SOLID_BSP;
    (*self_0).svflags &= !(0x1 as libc::c_int);
    let ref mut fresh42 = (*self_0).use_0;
    *fresh42 = None;
    KillBox(self_0);
...
pub unsafe extern "C" fn SP_func_object(mut self_0: *mut edict_t) {
    (gi.setmodel).expect("non-null function pointer")(self_0, (*self_0).model);
    let ref mut fresh43 = (*self_0).mins[0 as libc::c_int as usize];
    *fresh43 += 1 as libc::c_int as libc::c_float;
    let ref mut fresh44 = (*self_0).mins[1 as libc::c_int as usize];
    *fresh44 += 1 as libc::c_int as libc::c_float;
    let ref mut fresh45 = (*self_0).mins[2 as libc::c_int as usize];
    *fresh45 += 1 as libc::c_int as libc::c_float;
    let ref mut fresh46 = (*self_0).maxs[0 as libc::c_int as usize];
    *fresh46 -= 1 as libc::c_int as libc::c_float;
    let ref mut fresh47 = (*self_0).maxs[1 as libc::c_int as usize];
    *fresh47 -= 1 as libc::c_int as libc::c_float;
    let ref mut fresh48 = (*self_0).maxs[2 as libc::c_int as usize];
    *fresh48 -= 1 as libc::c_int as libc::c_float;
    if (*self_0).dmg == 0 {
    ...
    if (*self_0).spawnflags == 0 as libc::c_int {
        (*self_0).solid = SOLID_BSP;
        (*self_0).movetype = MOVETYPE_PUSH as libc::c_int;
        let ref mut fresh49 = (*self_0).think;
        *fresh49 = Some(func_object_release as unsafe extern "C" fn(*mut edict_t) -> ());
        (*self_0)
        ...
        (*self_0).solid = SOLID_NOT;
        (*self_0).movetype = MOVETYPE_PUSH as libc::c_int;
        let ref mut fresh50 = (*self_0).use_0;
        *fresh50 = Some(
            func_object_use
                as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
        );
...
pub unsafe extern "C" fn SP_func_explosive(mut self_0: *mut edict_t) {
    ...
    if (*self_0).spawnflags & 1 as libc::c_int != 0 {
        ...
        *fresh54 = Some(
        ...
        (*self_0).solid = SOLID_BSP;
        if !((*self_0).targetname).is_null() {
            let ref mut fresh55 = (*self_0).use_0;
            *fresh55 = Some(
                func_explosive_use
                    as unsafe extern "C" fn(
                        *mut edict_t,
        ...
        )
    {
        ...
        let ref mut fresh56 = (*self_0).die;
        *fresh56 = Some(
            func_explosive_explode
                as unsafe extern "C" fn(
                    *mut edict_t,
...
pub unsafe extern "C" fn barrel_delay(
    ...
    (*self_0)
        .nextthink = (level.time as libc::c_double
        + 2 as libc::c_int as libc::c_double * 0.1f64) as libc::c_float;
    let ref mut fresh57 = (*self_0).think;
    *fresh57 = Some(barrel_explode as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh58 = (*self_0).activator;
    *fresh58 = attacker;
}
#[no_mangle]
pub unsafe extern "C" fn SP_misc_explobox(mut self_0: *mut edict_t) {
    ...
    let ref mut fresh59 = (*self_0).model;
    *fresh59 = b"models/objects/barrels/tris.md2\0" as *const u8 as *const libc::c_char
        as *mut libc::c_char;
    (*self_0)
        .s
        .modelindex = (gi.modelindex)
    ...
    let ref mut fresh60 = (*self_0).die;
    *fresh60 = Some(
        barrel_delay
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh61 = (*self_0).touch;
    *fresh61 = Some(
        barrel_touch
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh62 = (*self_0).think;
    *fresh62 = Some(M_droptofloor as unsafe extern "C" fn(*mut edict_t) -> ());
    (*self_0)
        .nextthink = (level.time as libc::c_double
        + 2 as libc::c_int as libc::c_double * 0.1f64) as libc::c_float;
    (gi.linkentity).expect("non-null function pointer")(self_0);
...
pub unsafe extern "C" fn misc_blackhole_think(mut self_0: *mut edict_t) {
    let ref mut fresh63 = (*self_0).s.frame;
    *fresh63 += 1;
    if *fresh63 < 19 as libc::c_int {
        (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    } else {
        (*self_0).s.frame = 0 as libc::c_int;
        (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
...
pub unsafe extern "C" fn SP_misc_blackhole(mut ent: *mut edict_t) {
    ...
    let ref mut fresh64 = (*ent).use_0;
    *fresh64 = Some(
        misc_blackhole_use
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh65 = (*ent).think;
    *fresh65 = Some(misc_blackhole_think as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent)
        .nextthink = (level.time as libc::c_double
        + 2 as libc::c_int as libc::c_double * 0.1f64) as libc::c_float;
    (gi.linkentity).expect("non-null function pointer")(ent);
...
pub unsafe extern "C" fn misc_eastertank_think(mut self_0: *mut edict_t) {
    let ref mut fresh66 = (*self_0).s.frame;
    *fresh66 += 1;
    if *fresh66 < 293 as libc::c_int {
        (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    } else {
...
pub unsafe extern "C" fn SP_misc_eastertank(mut ent: *mut edict_t) {
    ...
    let ref mut fresh67 = (*ent).think;
    *fresh67 = Some(misc_eastertank_think as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent)
        .nextthink = (level.time as libc::c_double
        + 2 as libc::c_int as libc::c_double * 0.1f64) as libc::c_float;
    (gi.linkentity).expect("non-null function pointer")(ent);
...
pub unsafe extern "C" fn misc_easterchick_think(mut self_0: *mut edict_t) {
    let ref mut fresh68 = (*self_0).s.frame;
    *fresh68 += 1;
    if *fresh68 < 247 as libc::c_int {
        (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    } else {
...
pub unsafe extern "C" fn SP_misc_easterchick(mut ent: *mut edict_t) {
    ...
    *fresh69 = Some(misc_easterchick_think as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent)
        .nextthink = (level.time as libc::c_double
        + 2 as libc::c_int as libc::c_double * 0.1f64) as libc::c_float;
    (gi.linkentity).expect("non-null function pointer")(ent);
...
pub unsafe extern "C" fn misc_easterchick2_think(mut self_0: *mut edict_t) {
    let ref mut fresh70 = (*self_0).s.frame;
    *fresh70 += 1;
    if *fresh70 < 287 as libc::c_int {
        (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    } else {
...
pub unsafe extern "C" fn SP_misc_easterchick2(mut ent: *mut edict_t) {
    ...
    let ref mut fresh71 = (*ent).think;
    *fresh71 = Some(misc_easterchick2_think as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent)
        .nextthink = (level.time as libc::c_double
        + 2 as libc::c_int as libc::c_double * 0.1f64) as libc::c_float;
    (gi.linkentity).expect("non-null function pointer")(ent);
...
pub unsafe extern "C" fn commander_body_think(mut self_0: *mut edict_t) {
    let ref mut fresh72 = (*self_0).s.frame;
    *fresh72 += 1;
    if *fresh72 < 24 as libc::c_int {
        (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    } else {
        (*self_0).nextthink = 0 as libc::c_int as libc::c_float;
    }
...
pub unsafe extern "C" fn commander_body_use(
    ...
    let ref mut fresh73 = (*self_0).think;
    *fresh73 = Some(commander_body_think as unsafe extern "C" fn(*mut edict_t) -> ());
    (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    (gi.sound)
        .expect(
            "non-null function pointer",
...
pub unsafe extern "C" fn commander_body_drop(mut self_0: *mut edict_t) {
    (*self_0).movetype = MOVETYPE_TOSS as libc::c_int;
    let ref mut fresh74 = (*self_0).s.origin[2 as libc::c_int as usize];
    *fresh74 += 2 as libc::c_int as libc::c_float;
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_commander_body(mut self_0: *mut edict_t) {
    (*self_0).movetype = MOVETYPE_NONE as libc::c_int;
    (*self_0).solid = SOLID_BBOX;
    let ref mut fresh75 = (*self_0).model;
    *fresh75 = b"models/monsters/commandr/tris.md2\0" as *const u8 as *const libc::c_char
        as *mut libc::c_char;
    (*self_0)
        .s
        .modelindex = (gi.modelindex)
    ...
    let ref mut fresh76 = (*self_0).use_0;
    *fresh76 = Some(
        commander_body_use
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
    );
    ...
    *fresh77 = Some(commander_body_drop as unsafe extern "C" fn(*mut edict_t) -> ());
    (*self_0)
        .nextthink = (level.time as libc::c_double
...
pub unsafe extern "C" fn SP_misc_banner(mut ent: *mut edict_t) {
    ...
    (gi.linkentity).expect("non-null function pointer")(ent);
    let ref mut fresh78 = (*ent).think;
    *fresh78 = Some(misc_banner_think as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
}
#[no_mangle]
...
pub unsafe extern "C" fn misc_viper_use(
    ...
    (*self_0).svflags &= !(0x1 as libc::c_int);
    let ref mut fresh80 = (*self_0).use_0;
    *fresh80 = Some(
...
pub unsafe extern "C" fn SP_misc_viper(mut ent: *mut edict_t) {
    ...
    (*ent).maxs[1 as libc::c_int as usize] = 16 as libc::c_int as vec_t;
    (*ent).maxs[2 as libc::c_int as usize] = 32 as libc::c_int as vec_t;
    let ref mut fresh81 = (*ent).think;
    *fresh81 = Some(func_train_find as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    let ref mut fresh82 = (*ent).use_0;
    *fresh82 = Some(
        misc_viper_use
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
    );
    (*ent).svflags |= 0x1 as libc::c_int;
    let ref mut fresh83 = (*ent).moveinfo.speed;
    *fresh83 = (*ent).speed;
    let ref mut fresh84 = (*ent).moveinfo.decel;
    *fresh84 = *fresh83;
    (*ent).moveinfo.accel = *fresh84;
    (gi.linkentity).expect("non-null function pointer")(ent);
}
#[no_mangle]
...
pub unsafe extern "C" fn misc_viper_bomb_prethink(mut self_0: *mut edict_t) {
    ...
    let ref mut fresh85 = (*self_0).groundentity;
    *fresh85 = 0 as *mut edict_t;
...
pub unsafe extern "C" fn misc_viper_bomb_use(
    ...
    let ref mut fresh86 = (*self_0).use_0;
    *fresh86 = None;
    (*self_0).movetype = MOVETYPE_TOSS as libc::c_int;
    let ref mut fresh87 = (*self_0).prethink;
    *fresh87 = Some(
        misc_viper_bomb_prethink as unsafe extern "C" fn(*mut edict_t) -> (),
    );
    let ref mut fresh88 = (*self_0).touch;
    *fresh88 = Some(
    ...
    let ref mut fresh89 = (*self_0).activator;
    *fresh89 = activator;
    viper = G_Find(
        0 as *mut edict_t,
...
pub unsafe extern "C" fn misc_strogg_ship_use(
    ...
    (*self_0).svflags &= !(0x1 as libc::c_int);
    let ref mut fresh91 = (*self_0).use_0;
    *fresh91 = Some(
        train_use as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
    );
    train_use(self_0, other, activator);
...
pub unsafe extern "C" fn SP_misc_strogg_ship(mut ent: *mut edict_t) {
    ...
    (*ent).maxs[1 as libc::c_int as usize] = 16 as libc::c_int as vec_t;
    (*ent).maxs[2 as libc::c_int as usize] = 32 as libc::c_int as vec_t;
    let ref mut fresh92 = (*ent).think;
    *fresh92 = Some(func_train_find as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    let ref mut fresh93 = (*ent).use_0;
    *fresh93 = Some(
        misc_strogg_ship_use
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
    );
    (*ent).svflags |= 0x1 as libc::c_int;
    let ref mut fresh94 = (*ent).moveinfo.speed;
    *fresh94 = (*ent).speed;
    let ref mut fresh95 = (*ent).moveinfo.decel;
    *fresh95 = *fresh94;
    (*ent).moveinfo.accel = *fresh95;
    (gi.linkentity).expect("non-null function pointer")(ent);
}
#[no_mangle]
pub unsafe extern "C" fn misc_satellite_dish_think(mut self_0: *mut edict_t) {
    let ref mut fresh96 = (*self_0).s.frame;
    *fresh96 += 1;
...
pub unsafe extern "C" fn SP_misc_gib_arm(mut ent: *mut edict_t) {
    ...
    *fresh99 = Some(
    ...
    (*ent)
        ...
        as usize] = (rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float * 200 as libc::c_int as libc::c_float;
    let ref mut fresh100 = (*ent).think;
    *fresh100 = Some(G_FreeEdict as unsafe extern "C" fn(*mut edict_t) -> ());
...
pub unsafe extern "C" fn SP_misc_gib_leg(mut ent: *mut edict_t) {
    ...
    *fresh101 = Some(
    ...
    (*ent)
        ...
        as usize] = (rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float * 200 as libc::c_int as libc::c_float;
    let ref mut fresh102 = (*ent).think;
    *fresh102 = Some(G_FreeEdict as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent).nextthink = level.time + 30 as libc::c_int as libc::c_float;
    (gi.linkentity).expect("non-null function pointer")(ent);
}
#[no_mangle]
pub unsafe extern "C" fn SP_misc_gib_head(mut ent: *mut edict_t) {
    ...
    *fresh103 = Some(
    ...
    (*ent)
        ...
        as usize] = (rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float * 200 as libc::c_int as libc::c_float;
    let ref mut fresh104 = (*ent).think;
    *fresh104 = Some(G_FreeEdict as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent).nextthink = level.time + 30 as libc::c_int as libc::c_float;
    (gi.linkentity).expect("non-null function pointer")(ent);
}
#[no_mangle]
...
pub unsafe extern "C" fn SP_target_string(mut self_0: *mut edict_t) {
    if ((*self_0).message).is_null() {
        let ref mut fresh105 = (*self_0).message;
        *fresh105 = b"\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    }
    let ref mut fresh106 = (*self_0).use_0;
    *fresh106 = Some(
        target_string_use
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
    );
...
unsafe extern "C" fn func_clock_reset(mut self_0: *mut edict_t) {
    let ref mut fresh107 = (*self_0).activator;
    *fresh107 = 0 as *mut edict_t;
    if (*self_0).spawnflags & 1 as libc::c_int != 0 {
...
pub unsafe extern "C" fn func_clock_think(mut self_0: *mut edict_t) {
    if ((*self_0).enemy).is_null() {
        let ref mut fresh108 = (*self_0).enemy;
        *fresh108 = G_Find(
            0 as *mut edict_t,
    ...
    if (*self_0).spawnflags & 1 as libc::c_int != 0 {
        ...
        *fresh109 += 1;
        ...
        func_clock_format_countdown(self_0);
        let ref mut fresh110 = (*self_0).health;
        *fresh110 -= 1;
    } else {
    ...
    let ref mut fresh111 = (*(*self_0).enemy).message;
    *fresh111 = (*self_0).message;
    ((*(*self_0).enemy).use_0)
            ...
            && ((*self_0).health as libc::c_float) < (*self_0).wait
    {
        if !((*self_0).pathtarget).is_null() {
            ...
            let ref mut fresh112 = (*self_0).target;
            *fresh112 = (*self_0).pathtarget;
            let ref mut fresh113 = (*self_0).message;
            *fresh113 = 0 as *mut libc::c_char;
            G_UseTargets(self_0, (*self_0).activator);
            let ref mut fresh114 = (*self_0).target;
            *fresh114 = savetarget;
            let ref mut fresh115 = (*self_0).message;
            *fresh115 = savemessage;
        }
        if (*self_0).spawnflags & 8 as libc::c_int == 0 {
            return;
        }
...
pub unsafe extern "C" fn func_clock_use(
    ...
    if (*self_0).spawnflags & 8 as libc::c_int == 0 {
        let ref mut fresh116 = (*self_0).use_0;
        *fresh116 = None;
    }
    if !((*self_0).activator).is_null() {
        return;
    }
    let ref mut fresh117 = (*self_0).activator;
    *fresh117 = activator;
...
pub unsafe extern "C" fn SP_func_clock(mut self_0: *mut edict_t) {
    ...
    func_clock_reset(self_0);
    let ref mut fresh118 = (*self_0).message;
    *fresh118 = (gi.TagMalloc)
        .expect("non-null function pointer")(16 as libc::c_int, 766 as libc::c_int)
        as *mut libc::c_char;
    let ref mut fresh119 = (*self_0).think;
    *fresh119 = Some(func_clock_think as unsafe extern "C" fn(*mut edict_t) -> ());
    if (*self_0).spawnflags & 4 as libc::c_int != 0 {
        let ref mut fresh120 = (*self_0).use_0;
        *fresh120 = Some(
            func_clock_use
                as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
        );
...
pub unsafe extern "C" fn teleporter_touch(
    ...
    let ref mut fresh121 = (*other).s.origin[2 as libc::c_int as usize];
    *fresh121 += 10 as libc::c_int as libc::c_float;
    let ref mut fresh122 = (*other).velocity[2 as libc::c_int as usize];
    *fresh122 = 0 as libc::c_int as vec_t;
    let ref mut fresh123 = (*other).velocity[1 as libc::c_int as usize];
    *fresh123 = *fresh122;
    (*other).velocity[0 as libc::c_int as usize] = *fresh123;
    (*(*other).client)
        .ps
        .pmove
        .pm_time = (160 as libc::c_int >> 3 as libc::c_int) as byte;
    let ref mut fresh124 = (*(*other).client).ps.pmove.pm_flags;
    *fresh124 = (*fresh124 as libc::c_int | 32 as libc::c_int) as byte;
    ...
    let ref mut fresh125 = (*other).s.angles[2 as libc::c_int as usize];
    *fresh125 = 0 as libc::c_int as vec_t;
    let ref mut fresh126 = (*other).s.angles[1 as libc::c_int as usize];
    *fresh126 = *fresh125;
    (*other).s.angles[0 as libc::c_int as usize] = *fresh126;
    let ref mut fresh127 = (*(*other).client).ps.viewangles[2 as libc::c_int as usize];
    *fresh127 = 0 as libc::c_int as vec_t;
    let ref mut fresh128 = (*(*other).client).ps.viewangles[1 as libc::c_int as usize];
    *fresh128 = *fresh127;
    (*(*other).client).ps.viewangles[0 as libc::c_int as usize] = *fresh128;
    let ref mut fresh129 = (*(*other).client).v_angle[2 as libc::c_int as usize];
    *fresh129 = 0 as libc::c_int as vec_t;
    let ref mut fresh130 = (*(*other).client).v_angle[1 as libc::c_int as usize];
    *fresh130 = *fresh129;
    (*(*other).client).v_angle[0 as libc::c_int as usize] = *fresh130;
    KillBox(other);
...
pub unsafe extern "C" fn SP_misc_teleporter(mut ent: *mut edict_t) {
    ...
    (gi.linkentity).expect("non-null function pointer")(ent);
    trig = G_Spawn();
    let ref mut fresh131 = (*trig).touch;
    *fresh131 = Some(
        teleporter_touch
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh132 = (*trig).target;
    *fresh132 = (*ent).target;
    let ref mut fresh133 = (*trig).owner;
    *fresh133 = ent;
    (*trig)
        .s
