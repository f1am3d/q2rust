...
static mut sound_punch: libc::c_int = 0;
static mut sound_sight: libc::c_int = 0;
static mut sound_search: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn berserk_sight(
...
#[no_mangle]
pub unsafe extern "C" fn berserk_search(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut berserk_frames_stand: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                ...
                thinkfunc: Some(
                    berserk_fidget as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut berserk_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 4 as libc::c_int,
            frame: berserk_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn berserk_stand(mut self_0: *mut edict_t) {
    let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
    *fresh0 = &mut berserk_move_stand;
}
#[no_mangle]
pub static mut berserk_frames_stand_fidget: [mframe_t; 20] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut berserk_move_stand_fidget: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 5 as libc::c_int,
            lastframe: 24 as libc::c_int,
            frame: berserk_frames_stand_fidget.as_ptr() as *mut _,
            endfunc: Some(berserk_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn berserk_fidget(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        return;
    }
    if ((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double > 0.15f64
    {
        return;
    }
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut berserk_move_stand_fidget;
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut berserk_frames_walk: [mframe_t; 12] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut berserk_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 25 as libc::c_int,
            lastframe: 35 as libc::c_int,
            frame: berserk_frames_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn berserk_walk(mut self_0: *mut edict_t) {
    let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
    *fresh2 = &mut berserk_move_walk;
}
#[no_mangle]
pub static mut berserk_frames_run1: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut berserk_move_run1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 36 as libc::c_int,
            lastframe: 41 as libc::c_int,
            frame: berserk_frames_run1.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn berserk_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut berserk_move_stand;
    } else {
        let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
        *fresh4 = &mut berserk_move_run1;
    };
}
#[no_mangle]
pub unsafe extern "C" fn berserk_attack_spike(mut self_0: *mut edict_t) {
    ...
    fire_hit(
        self_0,
        aim.as_mut_ptr(),
        15 as libc::c_int + rand() % 6 as libc::c_int,
        400 as libc::c_int,
    );
}
#[no_mangle]
pub unsafe extern "C" fn berserk_swing(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut berserk_frames_attack_spike: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    berserk_swing as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    berserk_attack_spike as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut berserk_move_attack_spike: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 76 as libc::c_int,
            lastframe: 83 as libc::c_int,
            frame: berserk_frames_attack_spike.as_ptr() as *mut _,
            endfunc: Some(berserk_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn berserk_attack_club(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut berserk_frames_attack_club: [mframe_t; 12] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    berserk_attack_club as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut berserk_move_attack_club: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 84 as libc::c_int,
            lastframe: 95 as libc::c_int,
            frame: berserk_frames_attack_club.as_ptr() as *mut _,
            endfunc: Some(berserk_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn berserk_strike(mut self_0: *mut edict_t) {}
#[no_mangle]
pub static mut berserk_frames_attack_strike: [mframe_t; 14] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    berserk_strike as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut berserk_move_attack_strike: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 96 as libc::c_int,
            lastframe: 109 as libc::c_int,
            frame: berserk_frames_attack_strike.as_ptr() as *mut _,
            endfunc: Some(berserk_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn berserk_melee(mut self_0: *mut edict_t) {
    if rand() % 2 as libc::c_int == 0 as libc::c_int {
        let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
        *fresh5 = &mut berserk_move_attack_spike;
    } else {
        let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
        *fresh6 = &mut berserk_move_attack_club;
    };
}
#[no_mangle]
pub static mut berserk_frames_pain1: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut berserk_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 199 as libc::c_int,
            lastframe: 202 as libc::c_int,
            frame: berserk_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(berserk_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut berserk_frames_pain2: [mframe_t; 20] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut berserk_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 203 as libc::c_int,
            lastframe: 222 as libc::c_int,
            frame: berserk_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(berserk_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn berserk_pain(
    mut self_0: *mut edict_t,
    mut other: *mut edict_t,
            ...
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.5f64
    {
        ...
        *fresh7 = &mut berserk_move_pain1;
    } else {
        let ref mut fresh8 = (*self_0).monsterinfo.currentmove;
        *fresh8 = &mut berserk_move_pain2;
    };
}
#[no_mangle]
pub unsafe extern "C" fn berserk_dead(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut berserk_frames_death1: [mframe_t; 13] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut berserk_move_death1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 223 as libc::c_int,
            lastframe: 235 as libc::c_int,
            frame: berserk_frames_death1.as_ptr() as *mut _,
            endfunc: Some(berserk_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut berserk_frames_death2: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut berserk_move_death2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 236 as libc::c_int,
            lastframe: 243 as libc::c_int,
            frame: berserk_frames_death2.as_ptr() as *mut _,
            endfunc: Some(berserk_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn berserk_die(
    mut self_0: *mut edict_t,
    ...
    if damage >= 50 as libc::c_int {
        ...
        *fresh9 = &mut berserk_move_death1;
    } else {
        let ref mut fresh10 = (*self_0).monsterinfo.currentmove;
        *fresh10 = &mut berserk_move_death2;
    };
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_berserk(mut self_0: *mut edict_t) {
    ...
    sound_pain = (gi.soundindex)
        ...
        b"berserk/berpain2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_die = (gi.soundindex)
        ...
        b"berserk/berdeth2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_idle = (gi.soundindex)
        ...
        b"berserk/beridle1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_punch = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"berserk/attack.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"berserk/bersrch1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_sight = (gi.soundindex)
        ...
        b"berserk/sight.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (*self_0)
        .s
        ...
        b"models/monsters/berserk/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0).mins[0 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    ...
    (*self_0).gib_health = -(60 as libc::c_int);
    ...
    *fresh13 = Some(berserk_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh14 = (*self_0).monsterinfo.walk;
    *fresh14 = Some(berserk_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh15 = (*self_0).monsterinfo.run;
    *fresh15 = Some(berserk_run as unsafe extern "C" fn(*mut edict_t) -> ());
    ...
    *fresh18 = Some(berserk_melee as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh19 = (*self_0).monsterinfo.sight;
    *fresh19 = Some(
        berserk_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh20 = (*self_0).monsterinfo.search;
    *fresh20 = Some(berserk_search as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh21 = (*self_0).monsterinfo.currentmove;
    *fresh21 = &mut berserk_move_stand;
