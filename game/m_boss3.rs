...
#[no_mangle]
pub unsafe extern "C" fn Think_Boss3Stand(mut ent: *mut edict_t) {
    if (*ent).s.frame == 473 as libc::c_int {
        (*ent).s.frame = 414 as libc::c_int;
    } else {
        let ref mut fresh0 = (*ent).s.frame;
        *fresh0 += 1;
    }
    (*ent).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_boss3_stand(mut self_0: *mut edict_t) {
    ...
    let ref mut fresh1 = (*self_0).model;
    *fresh1 = b"models/monsters/boss3/rider/tris.md2\0" as *const u8
        as *const libc::c_char as *mut libc::c_char;
    (*self_0)
        .s
        .modelindex = (gi.modelindex)
        .expect("non-null function pointer")((*self_0).model);
    (*self_0).s.frame = 414 as libc::c_int;
    (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"misc/bigtele.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    ...
    let ref mut fresh2 = (*self_0).use_0;
    *fresh2 = Some(
        Use_Boss3 as unsafe extern "C" fn(*mut edict_t, *mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh3 = (*self_0).think;
    *fresh3 = Some(Think_Boss3Stand as unsafe extern "C" fn(*mut edict_t) -> ());
