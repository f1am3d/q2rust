...
extern "C" {
    ...
    fn MakronToss(self_0: *mut edict_t);
    fn MakronPrecache();
}
...
static mut sound_search2: libc::c_int = 0;
static mut sound_search3: libc::c_int = 0;
static mut sound_attack1: libc::c_int = 0;
static mut sound_attack2: libc::c_int = 0;
static mut sound_firegun: libc::c_int = 0;
static mut sound_step_left: libc::c_int = 0;
static mut sound_step_right: libc::c_int = 0;
static mut sound_death_hit: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn jorg_search(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut jorg_frames_stand: [mframe_t; 51] = unsafe {
    [
        {
            let mut init = mframe_t {
                ...
                thinkfunc: Some(jorg_idle as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                thinkfunc: Some(
                    jorg_step_left as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                thinkfunc: Some(
                    jorg_step_right as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut jorg_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 112 as libc::c_int,
            lastframe: 162 as libc::c_int,
            frame: jorg_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn jorg_idle(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn jorg_death_hit(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn jorg_step_left(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn jorg_step_right(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn jorg_stand(mut self_0: *mut edict_t) {
    let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
    *fresh0 = &mut jorg_move_stand;
}
#[no_mangle]
pub static mut jorg_frames_run: [mframe_t; 14] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 33 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    jorg_step_right as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
...
#[no_mangle]
pub static mut jorg_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 168 as libc::c_int,
            lastframe: 181 as libc::c_int,
            frame: jorg_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut jorg_frames_start_walk: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut jorg_move_start_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 163 as libc::c_int,
            lastframe: 167 as libc::c_int,
            frame: jorg_frames_start_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut jorg_frames_walk: [mframe_t; 14] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut jorg_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 168 as libc::c_int,
            lastframe: 181 as libc::c_int,
            frame: jorg_frames_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut jorg_frames_end_walk: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut jorg_move_end_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 182 as libc::c_int,
            lastframe: 187 as libc::c_int,
            frame: jorg_frames_end_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn jorg_walk(mut self_0: *mut edict_t) {
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut jorg_move_walk;
}
#[no_mangle]
pub unsafe extern "C" fn jorg_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
        *fresh2 = &mut jorg_move_stand;
    } else {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut jorg_move_run;
    };
}
#[no_mangle]
pub static mut jorg_frames_pain3: [mframe_t; 25] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: -(28 as libc::c_int) as libc::c_float,
                thinkfunc: None,
            };
            init
        },
...
#[no_mangle]
pub static mut jorg_move_pain3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 87 as libc::c_int,
            lastframe: 111 as libc::c_int,
            frame: jorg_frames_pain3.as_ptr() as *mut _,
            endfunc: Some(jorg_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut jorg_frames_pain2: [mframe_t; 3] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut jorg_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 84 as libc::c_int,
            lastframe: 86 as libc::c_int,
            frame: jorg_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(jorg_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut jorg_frames_pain1: [mframe_t; 3] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut jorg_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 81 as libc::c_int,
            lastframe: 83 as libc::c_int,
            frame: jorg_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(jorg_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut jorg_frames_death1: [mframe_t; 50] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(MakronToss as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut jorg_move_death: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 31 as libc::c_int,
            lastframe: 80 as libc::c_int,
            frame: jorg_frames_death1.as_ptr() as *mut _,
            endfunc: Some(jorg_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut jorg_frames_attack2: [mframe_t; 13] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(jorgBFG as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut jorg_move_attack2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 18 as libc::c_int,
            lastframe: 30 as libc::c_int,
            frame: jorg_frames_attack2.as_ptr() as *mut _,
            endfunc: Some(jorg_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut jorg_frames_start_attack1: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut jorg_move_start_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 7 as libc::c_int,
            frame: jorg_frames_start_attack1.as_ptr() as *mut _,
            endfunc: Some(jorg_attack1 as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut jorg_frames_attack1: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    jorg_firebullet as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut jorg_move_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 8 as libc::c_int,
            lastframe: 13 as libc::c_int,
            frame: jorg_frames_attack1.as_ptr() as *mut _,
            endfunc: Some(jorg_reattack1 as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut jorg_frames_end_attack1: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut jorg_move_end_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 14 as libc::c_int,
            lastframe: 17 as libc::c_int,
            frame: jorg_frames_end_attack1.as_ptr() as *mut _,
            endfunc: Some(jorg_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn jorg_reattack1(mut self_0: *mut edict_t) {
    if visible(self_0, (*self_0).enemy) as u64 != 0 {
            ...
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.9f64
        {
            ...
            *fresh4 = &mut jorg_move_attack1;
        } else {
            (*self_0).s.sound = 0 as libc::c_int;
            let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
            *fresh5 = &mut jorg_move_end_attack1;
        }
    } else {
        (*self_0).s.sound = 0 as libc::c_int;
        let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
        *fresh6 = &mut jorg_move_end_attack1;
    };
}
#[no_mangle]
pub unsafe extern "C" fn jorg_attack1(mut self_0: *mut edict_t) {
    let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
    *fresh7 = &mut jorg_move_attack1;
}
#[no_mangle]
pub unsafe extern "C" fn jorg_pain(
    ...
    if (*self_0).s.frame >= 0 as libc::c_int && (*self_0).s.frame <= 7 as libc::c_int {
        if ((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.005f64
        {
            return;
        }
    }
    if (*self_0).s.frame >= 8 as libc::c_int && (*self_0).s.frame <= 13 as libc::c_int {
        if ((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.00005f64
        {
            return;
        }
    }
    if (*self_0).s.frame >= 18 as libc::c_int && (*self_0).s.frame <= 25 as libc::c_int {
        if ((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.005f64
        {
            return;
    ...
    if damage <= 50 as libc::c_int {
        ...
        *fresh8 = &mut jorg_move_pain1;
    } else if damage <= 100 as libc::c_int {
        (gi.sound)
            .expect(
                "non-null function pointer",
            )(
        ...
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.3f64
    {
        ...
        *fresh10 = &mut jorg_move_pain3;
    }
}
#[no_mangle]
pub unsafe extern "C" fn jorgBFG(mut self_0: *mut edict_t) {
    ...
    G_ProjectSource(
        ...
        (*monster_flash_offset.as_mut_ptr().offset(132 as libc::c_int as isize))
            .as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
        start.as_mut_ptr(),
...
#[no_mangle]
pub unsafe extern "C" fn jorg_firebullet_right(mut self_0: *mut edict_t) {
    let mut forward: vec3_t = [0.; 3];
    let mut right: vec3_t = [0.; 3];
    ...
    G_ProjectSource(
        ((*self_0).s.origin).as_mut_ptr(),
        (*monster_flash_offset.as_mut_ptr().offset(126 as libc::c_int as isize))
            .as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
        start.as_mut_ptr(),
...
#[no_mangle]
pub unsafe extern "C" fn jorg_firebullet_left(mut self_0: *mut edict_t) {
    let mut forward: vec3_t = [0.; 3];
    let mut right: vec3_t = [0.; 3];
    let mut target: vec3_t = [0.; 3];
    let mut start: vec3_t = [0.; 3];
    ...
    G_ProjectSource(
        ((*self_0).s.origin).as_mut_ptr(),
        (*monster_flash_offset.as_mut_ptr().offset(120 as libc::c_int as isize))
            .as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
        start.as_mut_ptr(),
...
#[no_mangle]
pub unsafe extern "C" fn jorg_firebullet(mut self_0: *mut edict_t) {
    jorg_firebullet_left(self_0);
    jorg_firebullet_right(self_0);
}
#[no_mangle]
pub unsafe extern "C" fn jorg_attack(mut self_0: *mut edict_t) {
    let mut vec: vec3_t = [0.; 3];
        ...
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.75f64
    {
        ...
        (*self_0)
            ...
            b"boss3/w_loop.wav\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        );
        let ref mut fresh11 = (*self_0).monsterinfo.currentmove;
        *fresh11 = &mut jorg_move_start_attack1;
    } else {
        (gi.sound)
            .expect(
                "non-null function pointer",
        ...
        *fresh12 = &mut jorg_move_attack2;
    };
}
#[no_mangle]
pub unsafe extern "C" fn jorg_dead(mut self_0: *mut edict_t) {}
#[no_mangle]
pub unsafe extern "C" fn jorg_die(
    mut self_0: *mut edict_t,
    ...
    *fresh13 = &mut jorg_move_death;
}
#[no_mangle]
pub unsafe extern "C" fn Jorg_CheckAttack(mut self_0: *mut edict_t) -> qboolean {
...
#[no_mangle]
pub unsafe extern "C" fn SP_monster_jorg(mut self_0: *mut edict_t) {
    ...
    sound_pain1 = (gi.soundindex)
        ...
        b"boss3/bs3pain1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3pain2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain3 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3pain3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_death = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3deth1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_attack1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3atck1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_attack2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3atck2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3srch1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3srch2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search3 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3srch3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_idle = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"boss3/bs3idle1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_step_left = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(b"boss3/step1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char);
    sound_step_right = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(b"boss3/step2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char);
    sound_firegun = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(b"boss3/xfire.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char);
    sound_death_hit = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(b"boss3/d_hit.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char);
    MakronPrecache();
    ...
    (*self_0)
        .s
        .modelindex2 = (gi.modelindex)
        .expect(
            "non-null function pointer",
        )(
        b"models/monsters/boss3/jorg/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0).mins[0 as libc::c_int as usize] = -(80 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(80 as libc::c_int) as vec_t;
    (*self_0).mins[2 as libc::c_int as usize] = 0 as libc::c_int as vec_t;
    (*self_0).maxs[0 as libc::c_int as usize] = 80 as libc::c_int as vec_t;
    (*self_0).maxs[1 as libc::c_int as usize] = 80 as libc::c_int as vec_t;
    (*self_0).maxs[2 as libc::c_int as usize] = 140 as libc::c_int as vec_t;
    (*self_0).health = 3000 as libc::c_int;
    (*self_0).gib_health = -(2000 as libc::c_int);
    (*self_0).mass = 1000 as libc::c_int;
    let ref mut fresh14 = (*self_0).pain;
    *fresh14 = Some(
        jorg_pain
    ...
    let ref mut fresh15 = (*self_0).die;
    *fresh15 = Some(
        jorg_die
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh16 = (*self_0).monsterinfo.stand;
    *fresh16 = Some(jorg_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh17 = (*self_0).monsterinfo.walk;
    *fresh17 = Some(jorg_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh18 = (*self_0).monsterinfo.run;
    *fresh18 = Some(jorg_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh19 = (*self_0).monsterinfo.dodge;
    *fresh19 = None;
    let ref mut fresh20 = (*self_0).monsterinfo.attack;
    *fresh20 = Some(jorg_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh21 = (*self_0).monsterinfo.search;
    *fresh21 = Some(jorg_search as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh22 = (*self_0).monsterinfo.melee;
    *fresh22 = None;
    let ref mut fresh23 = (*self_0).monsterinfo.sight;
    *fresh23 = None;
    let ref mut fresh24 = (*self_0).monsterinfo.checkattack;
    *fresh24 = Some(Jorg_CheckAttack as unsafe extern "C" fn(*mut edict_t) -> qboolean);
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh25 = (*self_0).monsterinfo.currentmove;
    *fresh25 = &mut jorg_move_stand;
