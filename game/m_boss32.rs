...
static mut sound_pain4: libc::c_int = 0;
static mut sound_pain5: libc::c_int = 0;
static mut sound_pain6: libc::c_int = 0;
static mut sound_death: libc::c_int = 0;
static mut sound_step_left: libc::c_int = 0;
static mut sound_step_right: libc::c_int = 0;
static mut sound_attack_bfg: libc::c_int = 0;
static mut sound_brainsplorch: libc::c_int = 0;
static mut sound_prerailgun: libc::c_int = 0;
static mut sound_popup: libc::c_int = 0;
static mut sound_taunt1: libc::c_int = 0;
static mut sound_taunt2: libc::c_int = 0;
static mut sound_taunt3: libc::c_int = 0;
static mut sound_hit: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn makron_taunt(mut self_0: *mut edict_t) {
    let mut r: libc::c_float = 0.;
    r = (rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float;
    if r as libc::c_double <= 0.3f64 {
        (gi.sound)
            .expect(
    ...
    } else if r as libc::c_double <= 0.6f64 {
        (gi.sound)
            .expect(
                "non-null function pointer",
            )(
...
#[no_mangle]
pub static mut makron_frames_stand: [mframe_t; 60] = unsafe {
    [
        {
...
#[no_mangle]
pub static mut makron_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 414 as libc::c_int,
            lastframe: 473 as libc::c_int,
            frame: makron_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn makron_stand(mut self_0: *mut edict_t) {
    let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
    *fresh0 = &mut makron_move_stand;
}
#[no_mangle]
pub static mut makron_frames_run: [mframe_t; 10] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                thinkfunc: Some(
                    makron_step_left as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 8 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    makron_step_right as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut makron_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 477 as libc::c_int,
            lastframe: 486 as libc::c_int,
            frame: makron_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn makron_hit(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn makron_popup(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn makron_step_left(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn makron_step_right(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn makron_brainsplorch(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn makron_prerailgun(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut makron_frames_walk: [mframe_t; 10] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut makron_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 477 as libc::c_int,
            lastframe: 486 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn makron_walk(mut self_0: *mut edict_t) {
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut makron_move_walk;
}
#[no_mangle]
pub unsafe extern "C" fn makron_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
        *fresh2 = &mut makron_move_stand;
    } else {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut makron_move_run;
    };
}
#[no_mangle]
pub static mut makron_frames_pain6: [mframe_t; 27] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(makron_popup as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(makron_taunt as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut makron_move_pain6: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 387 as libc::c_int,
            lastframe: 413 as libc::c_int,
            frame: makron_frames_pain6.as_ptr() as *mut _,
            endfunc: Some(makron_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut makron_frames_pain5: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut makron_move_pain5: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 383 as libc::c_int,
            lastframe: 386 as libc::c_int,
            frame: makron_frames_pain5.as_ptr() as *mut _,
            endfunc: Some(makron_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut makron_frames_pain4: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut makron_move_pain4: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 379 as libc::c_int,
            lastframe: 382 as libc::c_int,
            frame: makron_frames_pain4.as_ptr() as *mut _,
            endfunc: Some(makron_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut makron_frames_death2: [mframe_t; 95] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 27 as libc::c_int as libc::c_float,
                thinkfunc: Some(makron_hit as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: 26 as libc::c_int as libc::c_float,
                thinkfunc: None,
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    makron_brainsplorch as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut makron_move_death2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 251 as libc::c_int,
            lastframe: 345 as libc::c_int,
            frame: makron_frames_death2.as_ptr() as *mut _,
            endfunc: Some(makron_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut makron_frames_death3: [mframe_t; 20] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut makron_move_death3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 346 as libc::c_int,
            lastframe: 365 as libc::c_int,
            frame: makron_frames_death3.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut makron_frames_sight: [mframe_t; 13] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut makron_move_sight: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 188 as libc::c_int,
            lastframe: 200 as libc::c_int,
            frame: makron_frames_sight.as_ptr() as *mut _,
            endfunc: Some(makron_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn makronBFG(mut self_0: *mut edict_t) {
    ...
    G_ProjectSource(
        ...
        (*monster_flash_offset.as_mut_ptr().offset(101 as libc::c_int as isize))
            .as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
        start.as_mut_ptr(),
...
#[no_mangle]
pub static mut makron_frames_attack3: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(makronBFG as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut makron_move_attack3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 201 as libc::c_int,
            lastframe: 208 as libc::c_int,
            frame: makron_frames_attack3.as_ptr() as *mut _,
            endfunc: Some(makron_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut makron_frames_attack4: [mframe_t; 26] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    MakronHyperblaster as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut makron_move_attack4: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 209 as libc::c_int,
            lastframe: 234 as libc::c_int,
            frame: makron_frames_attack4.as_ptr() as *mut _,
            endfunc: Some(makron_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut makron_frames_attack5: [mframe_t; 16] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    makron_prerailgun as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    MakronSaveloc as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    MakronRailgun as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut makron_move_attack5: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 235 as libc::c_int,
            lastframe: 250 as libc::c_int,
            frame: makron_frames_attack5.as_ptr() as *mut _,
            endfunc: Some(makron_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn MakronSaveloc(mut self_0: *mut edict_t) {
    (*self_0)
    ...
    (*self_0)
        ...
        as usize] = (*(*self_0).enemy).s.origin[2 as libc::c_int as usize];
    let ref mut fresh4 = (*self_0).pos1[2 as libc::c_int as usize];
    *fresh4 += (*(*self_0).enemy).viewheight as libc::c_float;
}
#[no_mangle]
pub unsafe extern "C" fn MakronRailgun(mut self_0: *mut edict_t) {
    let mut start: vec3_t = [0.; 3];
    let mut dir: vec3_t = [0.; 3];
    let mut forward: vec3_t = [0.; 3];
    let mut right: vec3_t = [0.; 3];
    ...
    G_ProjectSource(
        ((*self_0).s.origin).as_mut_ptr(),
        (*monster_flash_offset.as_mut_ptr().offset(119 as libc::c_int as isize))
            .as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
        start.as_mut_ptr(),
...
#[no_mangle]
pub unsafe extern "C" fn MakronHyperblaster(mut self_0: *mut edict_t) {
    let mut dir: vec3_t = [0.; 3];
    let mut vec: vec3_t = [0.; 3];
    let mut start: vec3_t = [0.; 3];
    let mut forward: vec3_t = [0.; 3];
    ...
    flash_number = 102 as libc::c_int + ((*self_0).s.frame - 213 as libc::c_int);
    AngleVectors(
        ((*self_0).s.angles).as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
    ...
    if (*self_0).s.frame <= 221 as libc::c_int {
        dir[1 as libc::c_int
            as usize] = (*self_0).s.angles[1 as libc::c_int as usize]
            - (10 as libc::c_int * ((*self_0).s.frame - 221 as libc::c_int))
                as libc::c_float;
    } else {
        dir[1 as libc::c_int
            as usize] = (*self_0).s.angles[1 as libc::c_int as usize]
            + (10 as libc::c_int * ((*self_0).s.frame - 229 as libc::c_int))
                as libc::c_float;
    }
...
#[no_mangle]
pub unsafe extern "C" fn makron_pain(
    ...
    if damage <= 40 as libc::c_int {
        ...
        *fresh5 = &mut makron_move_pain4;
    } else if damage <= 110 as libc::c_int {
        (gi.sound)
            .expect(
                "non-null function pointer",
            )(
        ...
        *fresh6 = &mut makron_move_pain5;
    } else if damage <= 150 as libc::c_int {
        if ((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.45f64
        {
            (gi.sound)
                .expect(
                    "non-null function pointer",
            ...
            *fresh7 = &mut makron_move_pain6;
        } else if ((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.35f64
        {
            (gi.sound)
                .expect(
                    "non-null function pointer",
            ...
            *fresh8 = &mut makron_move_pain6;
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn makron_sight(
    mut self_0: *mut edict_t,
    mut other: *mut edict_t,
) {
    let ref mut fresh9 = (*self_0).monsterinfo.currentmove;
    *fresh9 = &mut makron_move_sight;
}
#[no_mangle]
pub unsafe extern "C" fn makron_attack(mut self_0: *mut edict_t) {
    let mut vec: vec3_t = [0.; 3];
    ...
    if r as libc::c_double <= 0.3f64 {
        ...
        *fresh10 = &mut makron_move_attack3;
    } else if r as libc::c_double <= 0.6f64 {
        let ref mut fresh11 = (*self_0).monsterinfo.currentmove;
        *fresh11 = &mut makron_move_attack4;
    } else {
        let ref mut fresh12 = (*self_0).monsterinfo.currentmove;
        *fresh12 = &mut makron_move_attack5;
    };
}
#[no_mangle]
pub unsafe extern "C" fn makron_torso_think(mut self_0: *mut edict_t) {
    let ref mut fresh13 = (*self_0).s.frame;
    *fresh13 += 1;
    if *fresh13 < 365 as libc::c_int {
        (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    } else {
        (*self_0).s.frame = 346 as libc::c_int;
        (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    };
}
#[no_mangle]
pub unsafe extern "C" fn makron_torso(mut ent: *mut edict_t) {
    (*ent).movetype = MOVETYPE_NONE as libc::c_int;
    (*ent).solid = SOLID_NOT;
    (*ent).mins[0 as libc::c_int as usize] = -(8 as libc::c_int) as vec_t;
    (*ent).mins[1 as libc::c_int as usize] = -(8 as libc::c_int) as vec_t;
    (*ent).mins[2 as libc::c_int as usize] = 0 as libc::c_int as vec_t;
    (*ent).maxs[0 as libc::c_int as usize] = 8 as libc::c_int as vec_t;
    (*ent).maxs[1 as libc::c_int as usize] = 8 as libc::c_int as vec_t;
    (*ent).maxs[2 as libc::c_int as usize] = 8 as libc::c_int as vec_t;
    (*ent).s.frame = 346 as libc::c_int;
    (*ent)
        .s
        ...
        b"models/monsters/boss3/rider/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    let ref mut fresh14 = (*ent).think;
    *fresh14 = Some(makron_torso_think as unsafe extern "C" fn(*mut edict_t) -> ());
    (*ent)
    ...
    (*ent)
        ...
        b"makron/spine.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (gi.linkentity).expect("non-null function pointer")(ent);
}
#[no_mangle]
pub unsafe extern "C" fn makron_dead(mut self_0: *mut edict_t) {
    (*self_0).mins[0 as libc::c_int as usize] = -(60 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(60 as libc::c_int) as vec_t;
    (*self_0).mins[2 as libc::c_int as usize] = 0 as libc::c_int as vec_t;
    (*self_0).maxs[0 as libc::c_int as usize] = 60 as libc::c_int as vec_t;
    (*self_0).maxs[1 as libc::c_int as usize] = 60 as libc::c_int as vec_t;
...
#[no_mangle]
pub unsafe extern "C" fn makron_die(
    mut self_0: *mut edict_t,
    ...
    let mut tempent: *mut edict_t = 0 as *mut edict_t;
    ...
    let ref mut fresh15 = (*tempent).s.origin[1 as libc::c_int as usize];
    *fresh15 -= 84 as libc::c_int as libc::c_float;
    makron_torso(tempent);
    let ref mut fresh16 = (*self_0).monsterinfo.currentmove;
    *fresh16 = &mut makron_move_death2;
}
#[no_mangle]
pub unsafe extern "C" fn Makron_CheckAttack(mut self_0: *mut edict_t) -> qboolean {
...
#[no_mangle]
pub unsafe extern "C" fn MakronPrecache() {
    sound_pain4 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/pain3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain5 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/pain2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain6 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/pain1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_death = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/death.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_step_left = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/step1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_step_right = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/step2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_attack_bfg = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/bfg_fire.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_brainsplorch = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/brain1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_prerailgun = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/rail_up.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_popup = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/popup.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_taunt1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/voice4.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_taunt2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/voice3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_taunt3 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"makron/voice.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_hit = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(b"makron/bhit.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char);
    (gi.modelindex)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn SP_monster_makron(mut self_0: *mut edict_t) {
    ...
    (*self_0).mins[0 as libc::c_int as usize] = -(30 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(30 as libc::c_int) as vec_t;
    (*self_0).mins[2 as libc::c_int as usize] = 0 as libc::c_int as vec_t;
    (*self_0).maxs[0 as libc::c_int as usize] = 30 as libc::c_int as vec_t;
    (*self_0).maxs[1 as libc::c_int as usize] = 30 as libc::c_int as vec_t;
    (*self_0).maxs[2 as libc::c_int as usize] = 90 as libc::c_int as vec_t;
    (*self_0).health = 3000 as libc::c_int;
    (*self_0).gib_health = -(2000 as libc::c_int);
    ...
    *fresh19 = Some(makron_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh20 = (*self_0).monsterinfo.walk;
    *fresh20 = Some(makron_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh21 = (*self_0).monsterinfo.run;
    *fresh21 = Some(makron_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh22 = (*self_0).monsterinfo.dodge;
    *fresh22 = None;
    let ref mut fresh23 = (*self_0).monsterinfo.attack;
    *fresh23 = Some(makron_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh24 = (*self_0).monsterinfo.melee;
    *fresh24 = None;
    let ref mut fresh25 = (*self_0).monsterinfo.sight;
    *fresh25 = Some(
        makron_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh26 = (*self_0).monsterinfo.checkattack;
    *fresh26 = Some(
        Makron_CheckAttack as unsafe extern "C" fn(*mut edict_t) -> qboolean,
    );
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh27 = (*self_0).monsterinfo.currentmove;
    *fresh27 = &mut makron_move_sight;
    (*self_0).monsterinfo.scale = 1.000000f64 as libc::c_float;
    walkmonster_start(self_0);
}
#[no_mangle]
pub unsafe extern "C" fn MakronSpawn(mut self_0: *mut edict_t) {
    let mut vec: vec3_t = [0.; 3];
    let mut player: *mut edict_t = 0 as *mut edict_t;
    SP_monster_makron(self_0);
    player = level.sight_client;
    if player.is_null() {
        return;
    }
    vec[0 as libc::c_int
        as usize] = (*player).s.origin[0 as libc::c_int as usize]
        - (*self_0).s.origin[0 as libc::c_int as usize];
    vec[1 as libc::c_int
        as usize] = (*player).s.origin[1 as libc::c_int as usize]
        - (*self_0).s.origin[1 as libc::c_int as usize];
    vec[2 as libc::c_int
        as usize] = (*player).s.origin[2 as libc::c_int as usize]
        - (*self_0).s.origin[2 as libc::c_int as usize];
    (*self_0).s.angles[1 as libc::c_int as usize] = vectoyaw(vec.as_mut_ptr());
    ...
    (*self_0).velocity[2 as libc::c_int as usize] = 200 as libc::c_int as vec_t;
    let ref mut fresh28 = (*self_0).groundentity;
    *fresh28 = 0 as *mut edict_t;
}
#[no_mangle]
pub unsafe extern "C" fn MakronToss(mut self_0: *mut edict_t) {
    let mut ent: *mut edict_t = 0 as *mut edict_t;
    ent = G_Spawn();
    (*ent).nextthink = (level.time as libc::c_double + 0.8f64) as libc::c_float;
    let ref mut fresh29 = (*ent).think;
    *fresh29 = Some(MakronSpawn as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh30 = (*ent).target;
    *fresh30 = (*self_0).target;
    (*ent)
        .s
        .origin[0 as libc::c_int
        as usize] = (*self_0).s.origin[0 as libc::c_int as usize];
