...
static mut sound_missile_prelaunch: libc::c_int = 0;
static mut sound_missile_launch: libc::c_int = 0;
static mut sound_melee_swing: libc::c_int = 0;
static mut sound_melee_hit: libc::c_int = 0;
static mut sound_missile_reload: libc::c_int = 0;
static mut sound_death1: libc::c_int = 0;
static mut sound_death2: libc::c_int = 0;
static mut sound_fall_down: libc::c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ChickMoan(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut chick_frames_fidget: [mframe_t; 30] = unsafe {
    [
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(ChickMoan as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut chick_move_fidget: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 151 as libc::c_int,
            lastframe: 180 as libc::c_int,
            frame: chick_frames_fidget.as_ptr() as *mut _,
            endfunc: Some(chick_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn chick_fidget(mut self_0: *mut edict_t) {
        ...
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.3f64
    {
        ...
        *fresh0 = &mut chick_move_fidget;
    }
}
#[no_mangle]
pub static mut chick_frames_stand: [mframe_t; 30] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(chick_fidget as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
    ]
...
#[no_mangle]
pub static mut chick_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 121 as libc::c_int,
            lastframe: 150 as libc::c_int,
            frame: chick_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn chick_stand(mut self_0: *mut edict_t) {
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut chick_move_stand;
}
#[no_mangle]
pub static mut chick_frames_start_run: [mframe_t; 10] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_start_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 181 as libc::c_int,
            lastframe: 190 as libc::c_int,
            frame: chick_frames_start_run.as_ptr() as *mut _,
            endfunc: Some(chick_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut chick_frames_run: [mframe_t; 10] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 191 as libc::c_int,
            lastframe: 200 as libc::c_int,
            frame: chick_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut chick_frames_walk: [mframe_t; 10] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 191 as libc::c_int,
            lastframe: 200 as libc::c_int,
            frame: chick_frames_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn chick_walk(mut self_0: *mut edict_t) {
    let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
    *fresh2 = &mut chick_move_walk;
}
#[no_mangle]
pub unsafe extern "C" fn chick_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut chick_move_stand;
        return;
    }
    if (*self_0).monsterinfo.currentmove == &mut chick_move_walk as *mut mmove_t
        || (*self_0).monsterinfo.currentmove == &mut chick_move_start_run as *mut mmove_t
    {
        let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
        *fresh4 = &mut chick_move_run;
    } else {
        let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
        *fresh5 = &mut chick_move_start_run;
    };
}
#[no_mangle]
pub static mut chick_frames_pain1: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 90 as libc::c_int,
            lastframe: 94 as libc::c_int,
            frame: chick_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(chick_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut chick_frames_pain2: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 95 as libc::c_int,
            lastframe: 99 as libc::c_int,
            frame: chick_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(chick_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut chick_frames_pain3: [mframe_t; 21] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_pain3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 100 as libc::c_int,
            lastframe: 120 as libc::c_int,
            frame: chick_frames_pain3.as_ptr() as *mut _,
            endfunc: Some(chick_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn chick_pain(
    ...
    if damage <= 10 as libc::c_int {
        ...
        *fresh6 = &mut chick_move_pain1;
    } else if damage <= 25 as libc::c_int {
        let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
        *fresh7 = &mut chick_move_pain2;
    } else {
        let ref mut fresh8 = (*self_0).monsterinfo.currentmove;
        *fresh8 = &mut chick_move_pain3;
    };
}
#[no_mangle]
pub unsafe extern "C" fn chick_dead(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut chick_frames_death2: [mframe_t; 23] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_death2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 60 as libc::c_int,
            lastframe: 82 as libc::c_int,
            frame: chick_frames_death2.as_ptr() as *mut _,
            endfunc: Some(chick_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut chick_frames_death1: [mframe_t; 12] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_death1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 48 as libc::c_int,
            lastframe: 59 as libc::c_int,
            frame: chick_frames_death1.as_ptr() as *mut _,
            endfunc: Some(chick_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn chick_die(
    mut self_0: *mut edict_t,
...
#[no_mangle]
pub unsafe extern "C" fn chick_duck_down(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub unsafe extern "C" fn chick_duck_hold(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub unsafe extern "C" fn chick_duck_up(mut self_0: *mut edict_t) {
    (*self_0).monsterinfo.aiflags &= !(0x800 as libc::c_int);
...
#[no_mangle]
pub static mut chick_frames_duck: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    chick_duck_down as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 4 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    chick_duck_hold as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: -(5 as libc::c_int) as libc::c_float,
                thinkfunc: Some(
                    chick_duck_up as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut chick_move_duck: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 83 as libc::c_int,
            lastframe: 89 as libc::c_int,
            frame: chick_frames_duck.as_ptr() as *mut _,
            endfunc: Some(chick_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn chick_dodge(
    mut self_0: *mut edict_t,
    mut attacker: *mut edict_t,
    ...
    *fresh14 = &mut chick_move_duck;
}
#[no_mangle]
pub unsafe extern "C" fn ChickSlash(mut self_0: *mut edict_t) {
    ...
    aim[2 as libc::c_int as usize] = 10 as libc::c_int as vec_t;
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
    ...
    fire_hit(
        self_0,
        aim.as_mut_ptr(),
        10 as libc::c_int + rand() % 6 as libc::c_int,
        100 as libc::c_int,
    );
}
#[no_mangle]
pub unsafe extern "C" fn ChickRocket(mut self_0: *mut edict_t) {
    ...
    G_ProjectSource(
        ...
        (*monster_flash_offset.as_mut_ptr().offset(57 as libc::c_int as isize))
            .as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
        start.as_mut_ptr(),
...
#[no_mangle]
pub unsafe extern "C" fn Chick_PreAttack1(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn ChickReload(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut chick_frames_start_attack1: [mframe_t; 13] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    Chick_PreAttack1 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    chick_attack1 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut chick_move_start_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 12 as libc::c_int,
            frame: chick_frames_start_attack1.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut chick_frames_attack1: [mframe_t; 14] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 19 as libc::c_int as libc::c_float,
                thinkfunc: Some(ChickRocket as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 10 as libc::c_int as libc::c_float,
                thinkfunc: Some(ChickReload as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 3 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    chick_rerocket as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut chick_move_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 13 as libc::c_int,
            lastframe: 26 as libc::c_int,
            frame: chick_frames_attack1.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut chick_frames_end_attack1: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_end_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 27 as libc::c_int,
            lastframe: 31 as libc::c_int,
            frame: chick_frames_end_attack1.as_ptr() as *mut _,
            endfunc: Some(chick_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn chick_rerocket(mut self_0: *mut edict_t) {
        ...
        if range(self_0, (*self_0).enemy) > 0 as libc::c_int {
            if visible(self_0, (*self_0).enemy) as u64 != 0 {
                    ...
                    / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.6f64
                {
                    ...
                    *fresh15 = &mut chick_move_attack1;
                    return;
                }
            }
        }
    ...
    *fresh16 = &mut chick_move_end_attack1;
}
#[no_mangle]
pub unsafe extern "C" fn chick_attack1(mut self_0: *mut edict_t) {
    let ref mut fresh17 = (*self_0).monsterinfo.currentmove;
    *fresh17 = &mut chick_move_attack1;
}
#[no_mangle]
pub static mut chick_frames_slash: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 7 as libc::c_int as libc::c_float,
                thinkfunc: Some(ChickSlash as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: -(2 as libc::c_int) as libc::c_float,
                thinkfunc: Some(
                    chick_reslash as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut chick_move_slash: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 35 as libc::c_int,
            lastframe: 43 as libc::c_int,
            frame: chick_frames_slash.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut chick_frames_end_slash: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_end_slash: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 44 as libc::c_int,
            lastframe: 47 as libc::c_int,
            frame: chick_frames_end_slash.as_ptr() as *mut _,
            endfunc: Some(chick_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn chick_reslash(mut self_0: *mut edict_t) {
    if (*(*self_0).enemy).health > 0 as libc::c_int {
        if range(self_0, (*self_0).enemy) == 0 as libc::c_int {
            if ((rand() & 0x7fff as libc::c_int) as libc::c_float
                / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.9f64
            {
                let ref mut fresh18 = (*self_0).monsterinfo.currentmove;
                *fresh18 = &mut chick_move_slash;
                return;
            } else {
                let ref mut fresh19 = (*self_0).monsterinfo.currentmove;
                *fresh19 = &mut chick_move_end_slash;
                return;
            }
        }
    }
    let ref mut fresh20 = (*self_0).monsterinfo.currentmove;
    *fresh20 = &mut chick_move_end_slash;
}
#[no_mangle]
pub unsafe extern "C" fn chick_slash(mut self_0: *mut edict_t) {
    let ref mut fresh21 = (*self_0).monsterinfo.currentmove;
    *fresh21 = &mut chick_move_slash;
}
#[no_mangle]
pub static mut chick_frames_start_slash: [mframe_t; 3] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut chick_move_start_slash: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 32 as libc::c_int,
            lastframe: 34 as libc::c_int,
            frame: chick_frames_start_slash.as_ptr() as *mut _,
            endfunc: Some(chick_slash as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn chick_melee(mut self_0: *mut edict_t) {
    let ref mut fresh22 = (*self_0).monsterinfo.currentmove;
    *fresh22 = &mut chick_move_start_slash;
}
#[no_mangle]
pub unsafe extern "C" fn chick_attack(mut self_0: *mut edict_t) {
    let ref mut fresh23 = (*self_0).monsterinfo.currentmove;
    *fresh23 = &mut chick_move_start_attack1;
}
#[no_mangle]
pub unsafe extern "C" fn chick_sight(mut self_0: *mut edict_t, mut other: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn SP_monster_chick(mut self_0: *mut edict_t) {
    if (*deathmatch).value != 0. {
        G_FreeEdict(self_0);
        return;
    }
    sound_missile_prelaunch = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkatck1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_missile_launch = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkatck2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_melee_swing = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkatck3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_melee_hit = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkatck4.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_missile_reload = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkatck5.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_death1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkdeth1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_death2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkdeth2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_fall_down = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkfall1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_idle1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkidle1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_idle2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkidle2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkpain1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkpain2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain3 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chkpain3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_sight = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chksght1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"chick/chksrch1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    ...
    (*self_0).maxs[0 as libc::c_int as usize] = 16 as libc::c_int as vec_t;
    (*self_0).maxs[1 as libc::c_int as usize] = 16 as libc::c_int as vec_t;
    (*self_0).maxs[2 as libc::c_int as usize] = 56 as libc::c_int as vec_t;
    (*self_0).health = 175 as libc::c_int;
    (*self_0).gib_health = -(70 as libc::c_int);
    (*self_0).mass = 200 as libc::c_int;
    let ref mut fresh24 = (*self_0).pain;
    *fresh24 = Some(
        chick_pain
    ...
    let ref mut fresh25 = (*self_0).die;
    *fresh25 = Some(
        chick_die
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh26 = (*self_0).monsterinfo.stand;
    *fresh26 = Some(chick_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh27 = (*self_0).monsterinfo.walk;
    *fresh27 = Some(chick_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh28 = (*self_0).monsterinfo.run;
    *fresh28 = Some(chick_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh29 = (*self_0).monsterinfo.dodge;
    *fresh29 = Some(
        chick_dodge
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, libc::c_float) -> (),
    );
    let ref mut fresh30 = (*self_0).monsterinfo.attack;
    *fresh30 = Some(chick_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh31 = (*self_0).monsterinfo.melee;
    *fresh31 = Some(chick_melee as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh32 = (*self_0).monsterinfo.sight;
    *fresh32 = Some(
        chick_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh33 = (*self_0).monsterinfo.currentmove;
    *fresh33 = &mut chick_move_stand;
