...
extern "C" {
    ...
    fn swimmonster_start(self_0: *mut edict_t);
    fn ThrowHead(
        self_0: *mut edict_t,
...
static mut sound_chomp: libc::c_int = 0;
static mut sound_attack: libc::c_int = 0;
...
#[no_mangle]
pub static mut flipper_frames_stand: [mframe_t; 1] = unsafe {
    [
        {
...
#[no_mangle]
pub static mut flipper_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 41 as libc::c_int,
            lastframe: 41 as libc::c_int,
            frame: flipper_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flipper_stand(mut self_0: *mut edict_t) {
    let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
    *fresh0 = &mut flipper_move_stand;
}
#[no_mangle]
pub static mut flipper_frames_run: [mframe_t; 24] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flipper_move_run_loop: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 70 as libc::c_int,
            lastframe: 93 as libc::c_int,
            frame: flipper_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flipper_run_loop(mut self_0: *mut edict_t) {
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut flipper_move_run_loop;
}
#[no_mangle]
pub static mut flipper_frames_run_start: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flipper_move_run_start: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 65 as libc::c_int,
            lastframe: 70 as libc::c_int,
            frame: flipper_frames_run_start.as_ptr() as *mut _,
            endfunc: Some(flipper_run_loop as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn flipper_run(mut self_0: *mut edict_t) {
    let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
    *fresh2 = &mut flipper_move_run_start;
}
#[no_mangle]
pub static mut flipper_frames_walk: [mframe_t; 24] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flipper_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 41 as libc::c_int,
            lastframe: 64 as libc::c_int,
            frame: flipper_frames_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flipper_walk(mut self_0: *mut edict_t) {
    let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
    *fresh3 = &mut flipper_move_walk;
}
#[no_mangle]
pub static mut flipper_frames_start_run: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 8 as libc::c_int as libc::c_float,
                thinkfunc: Some(flipper_run as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
    ]
...
#[no_mangle]
pub static mut flipper_move_start_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 41 as libc::c_int,
            lastframe: 45 as libc::c_int,
            frame: flipper_frames_start_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flipper_start_run(mut self_0: *mut edict_t) {
    let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
    *fresh4 = &mut flipper_move_start_run;
}
#[no_mangle]
pub static mut flipper_frames_pain2: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flipper_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 94 as libc::c_int,
            lastframe: 98 as libc::c_int,
            frame: flipper_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(flipper_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut flipper_frames_pain1: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flipper_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 99 as libc::c_int,
            lastframe: 103 as libc::c_int,
            frame: flipper_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(flipper_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flipper_bite(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub unsafe extern "C" fn flipper_preattack(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
...
#[no_mangle]
pub static mut flipper_frames_attack: [mframe_t; 20] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    flipper_preattack as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(flipper_bite as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut flipper_move_attack: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 19 as libc::c_int,
            frame: flipper_frames_attack.as_ptr() as *mut _,
            endfunc: Some(flipper_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flipper_melee(mut self_0: *mut edict_t) {
    let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
    *fresh5 = &mut flipper_move_attack;
}
#[no_mangle]
pub unsafe extern "C" fn flipper_pain(
    ...
    n = (rand() + 1 as libc::c_int) % 2 as libc::c_int;
    if n == 0 as libc::c_int {
        ...
        *fresh7 = &mut flipper_move_pain2;
    };
}
#[no_mangle]
pub unsafe extern "C" fn flipper_dead(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut flipper_frames_death: [mframe_t; 56] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flipper_move_death: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 104 as libc::c_int,
            lastframe: 159 as libc::c_int,
            frame: flipper_frames_death.as_ptr() as *mut _,
            endfunc: Some(flipper_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn flipper_sight(
    mut self_0: *mut edict_t,
    mut other: *mut edict_t,
) {
    (gi.sound)
...
#[no_mangle]
pub unsafe extern "C" fn flipper_die(
    mut self_0: *mut edict_t,
    ...
    *fresh8 = &mut flipper_move_death;
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_flipper(mut self_0: *mut edict_t) {
    ...
    sound_pain1 = (gi.soundindex)
        ...
        b"flipper/flppain1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        ...
        b"flipper/flppain2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_death = (gi.soundindex)
        ...
        b"flipper/flpdeth1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_chomp = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flipper/flpatck1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_attack = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flipper/flpatck2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_idle = (gi.soundindex)
        ...
        b"flipper/flpidle1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_search = (gi.soundindex)
        ...
        b"flipper/flpsrch1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_sight = (gi.soundindex)
        ...
        b"flipper/flpsght1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    ...
    (*self_0)
        ...
        b"models/monsters/flipper/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0).mins[0 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    ...
    let ref mut fresh9 = (*self_0).pain;
    *fresh9 = Some(
        flipper_pain
    ...
    let ref mut fresh10 = (*self_0).die;
    *fresh10 = Some(
        flipper_die
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh11 = (*self_0).monsterinfo.stand;
    *fresh11 = Some(flipper_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh12 = (*self_0).monsterinfo.walk;
    *fresh12 = Some(flipper_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh13 = (*self_0).monsterinfo.run;
    *fresh13 = Some(flipper_start_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh14 = (*self_0).monsterinfo.melee;
    *fresh14 = Some(flipper_melee as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh15 = (*self_0).monsterinfo.sight;
    *fresh15 = Some(
        flipper_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh16 = (*self_0).monsterinfo.currentmove;
    *fresh16 = &mut flipper_move_stand;
    (*self_0).monsterinfo.scale = 1.000000f64 as libc::c_float;
    swimmonster_start(self_0);
}
