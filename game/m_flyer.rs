...
static mut nextmove: libc::c_int = 0;
...
static mut sound_slash: libc::c_int = 0;
static mut sound_sproing: libc::c_int = 0;
static mut sound_die: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn flyer_sight(mut self_0: *mut edict_t, mut other: *mut edict_t) {
    (gi.sound)
        .expect(
...
#[no_mangle]
pub unsafe extern "C" fn flyer_idle(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn flyer_pop_blades(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut flyer_frames_stand: [mframe_t; 45] = unsafe {
    [
        {
...
#[no_mangle]
pub static mut flyer_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 13 as libc::c_int,
            lastframe: 57 as libc::c_int,
            frame: flyer_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_walk: [mframe_t; 45] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 13 as libc::c_int,
            lastframe: 57 as libc::c_int,
            frame: flyer_frames_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_run: [mframe_t; 45] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 13 as libc::c_int,
            lastframe: 57 as libc::c_int,
            frame: flyer_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flyer_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
        *fresh0 = &mut flyer_move_stand;
    } else {
        let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
        *fresh1 = &mut flyer_move_run;
    };
}
#[no_mangle]
pub unsafe extern "C" fn flyer_walk(mut self_0: *mut edict_t) {
    let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
    *fresh2 = &mut flyer_move_walk;
}
#[no_mangle]
pub unsafe extern "C" fn flyer_stand(mut self_0: *mut edict_t) {
    let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
    *fresh3 = &mut flyer_move_stand;
}
#[no_mangle]
pub static mut flyer_frames_start: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    flyer_nextmove as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut flyer_move_start: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 5 as libc::c_int,
            frame: flyer_frames_start.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_stop: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_stop: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 6 as libc::c_int,
            lastframe: 12 as libc::c_int,
            frame: flyer_frames_stop.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flyer_stop(mut self_0: *mut edict_t) {
    let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
    *fresh4 = &mut flyer_move_stop;
}
#[no_mangle]
pub unsafe extern "C" fn flyer_start(mut self_0: *mut edict_t) {
    let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
    *fresh5 = &mut flyer_move_start;
}
#[no_mangle]
pub static mut flyer_frames_rollright: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_rollright: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 119 as libc::c_int,
            lastframe: 127 as libc::c_int,
            frame: flyer_frames_rollright.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_rollleft: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_rollleft: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 110 as libc::c_int,
            lastframe: 118 as libc::c_int,
            frame: flyer_frames_rollleft.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_pain3: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_pain3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 147 as libc::c_int,
            lastframe: 150 as libc::c_int,
            frame: flyer_frames_pain3.as_ptr() as *mut _,
            endfunc: Some(flyer_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut flyer_frames_pain2: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 143 as libc::c_int,
            lastframe: 146 as libc::c_int,
            frame: flyer_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(flyer_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_pain1: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 134 as libc::c_int,
            lastframe: 142 as libc::c_int,
            frame: flyer_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(flyer_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_defense: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_defense: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 128 as libc::c_int,
            lastframe: 133 as libc::c_int,
            frame: flyer_frames_defense.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_bankright: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_bankright: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 103 as libc::c_int,
            lastframe: 109 as libc::c_int,
            frame: flyer_frames_bankright.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_bankleft: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_bankleft: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 96 as libc::c_int,
            lastframe: 102 as libc::c_int,
            frame: flyer_frames_bankleft.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flyer_fire(
    ...
    if (*self_0).s.frame == 82 as libc::c_int || (*self_0).s.frame == 85 as libc::c_int
        || (*self_0).s.frame == 88 as libc::c_int
    {
...
#[no_mangle]
pub unsafe extern "C" fn flyer_fireleft(mut self_0: *mut edict_t) {
    flyer_fire(self_0, 58 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn flyer_fireright(mut self_0: *mut edict_t) {
    flyer_fire(self_0, 59 as libc::c_int);
}
#[no_mangle]
pub static mut flyer_frames_attack2: [mframe_t; 17] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: -(10 as libc::c_int) as libc::c_float,
                thinkfunc: Some(
                    flyer_fireleft as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: -(10 as libc::c_int) as libc::c_float,
                thinkfunc: Some(
                    flyer_fireright as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut flyer_move_attack2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 79 as libc::c_int,
            lastframe: 95 as libc::c_int,
            frame: flyer_frames_attack2.as_ptr() as *mut _,
            endfunc: Some(flyer_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn flyer_slash_left(mut self_0: *mut edict_t) {
    ...
    fire_hit(self_0, aim.as_mut_ptr(), 5 as libc::c_int, 0 as libc::c_int);
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn flyer_slash_right(mut self_0: *mut edict_t) {
    let mut aim: vec3_t = [0.; 3];
    aim[0 as libc::c_int as usize] = 80 as libc::c_int as vec_t;
...
#[no_mangle]
pub static mut flyer_frames_start_melee: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    flyer_pop_blades as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut flyer_move_start_melee: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 58 as libc::c_int,
            lastframe: 63 as libc::c_int,
            frame: flyer_frames_start_melee.as_ptr() as *mut _,
            endfunc: Some(flyer_loop_melee as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut flyer_frames_end_melee: [mframe_t; 3] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut flyer_move_end_melee: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 76 as libc::c_int,
            lastframe: 78 as libc::c_int,
            frame: flyer_frames_end_melee.as_ptr() as *mut _,
            endfunc: Some(flyer_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut flyer_frames_loop_melee: [mframe_t; 12] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    flyer_slash_left as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    flyer_slash_right as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut flyer_move_loop_melee: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 64 as libc::c_int,
            lastframe: 75 as libc::c_int,
            frame: flyer_frames_loop_melee.as_ptr() as *mut _,
            endfunc: Some(flyer_check_melee as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn flyer_loop_melee(mut self_0: *mut edict_t) {
    let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
    *fresh6 = &mut flyer_move_loop_melee;
}
#[no_mangle]
pub unsafe extern "C" fn flyer_attack(mut self_0: *mut edict_t) {
    let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
    *fresh7 = &mut flyer_move_attack2;
}
#[no_mangle]
pub unsafe extern "C" fn flyer_setstart(mut self_0: *mut edict_t) {
    nextmove = 3 as libc::c_int;
    let ref mut fresh8 = (*self_0).monsterinfo.currentmove;
    *fresh8 = &mut flyer_move_start;
}
#[no_mangle]
pub unsafe extern "C" fn flyer_nextmove(mut self_0: *mut edict_t) {
    if nextmove == 1 as libc::c_int {
        let ref mut fresh9 = (*self_0).monsterinfo.currentmove;
        *fresh9 = &mut flyer_move_start_melee;
    } else if nextmove == 2 as libc::c_int {
        let ref mut fresh10 = (*self_0).monsterinfo.currentmove;
        *fresh10 = &mut flyer_move_attack2;
    } else if nextmove == 3 as libc::c_int {
        let ref mut fresh11 = (*self_0).monsterinfo.currentmove;
        *fresh11 = &mut flyer_move_run;
    }
}
#[no_mangle]
pub unsafe extern "C" fn flyer_melee(mut self_0: *mut edict_t) {
    let ref mut fresh12 = (*self_0).monsterinfo.currentmove;
    *fresh12 = &mut flyer_move_start_melee;
}
#[no_mangle]
pub unsafe extern "C" fn flyer_check_melee(mut self_0: *mut edict_t) {
    if range(self_0, (*self_0).enemy) == 0 as libc::c_int {
            ...
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.8f64
        {
            ...
            *fresh13 = &mut flyer_move_loop_melee;
        } else {
            let ref mut fresh14 = (*self_0).monsterinfo.currentmove;
            *fresh14 = &mut flyer_move_end_melee;
        }
    } else {
        let ref mut fresh15 = (*self_0).monsterinfo.currentmove;
        *fresh15 = &mut flyer_move_end_melee;
    };
}
#[no_mangle]
pub unsafe extern "C" fn flyer_pain(
    mut self_0: *mut edict_t,
    ...
    if n == 0 as libc::c_int {
        ...
        *fresh18 = &mut flyer_move_pain3;
    };
}
#[no_mangle]
pub unsafe extern "C" fn flyer_die(
    mut self_0: *mut edict_t,
...
#[no_mangle]
pub unsafe extern "C" fn SP_monster_flyer(mut self_0: *mut edict_t) {
    ...
    if Q_stricmp(
        ...
        b"jail5\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ) == 0
        && (*self_0).s.origin[2 as libc::c_int as usize]
            == -(104 as libc::c_int) as libc::c_float
    {
        let ref mut fresh19 = (*self_0).targetname;
    ...
    sound_sight = (gi.soundindex)
        ...
        b"flyer/flysght1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_idle = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flyer/flysrch1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flyer/flypain1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flyer/flypain2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_slash = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flyer/flyatck2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_sproing = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flyer/flyatck1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_die = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flyer/flydeth1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"flyer/flyatck3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (*self_0)
        .s
        ...
        b"models/monsters/flyer/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    ...
    (*self_0)
        ...
        b"flyer/flyidle1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (*self_0).health = 50 as libc::c_int;
    (*self_0).mass = 50 as libc::c_int;
    let ref mut fresh21 = (*self_0).pain;
    *fresh21 = Some(
        flyer_pain
    ...
    let ref mut fresh22 = (*self_0).die;
    *fresh22 = Some(
        flyer_die
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh23 = (*self_0).monsterinfo.stand;
    *fresh23 = Some(flyer_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh24 = (*self_0).monsterinfo.walk;
    *fresh24 = Some(flyer_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh25 = (*self_0).monsterinfo.run;
    *fresh25 = Some(flyer_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh26 = (*self_0).monsterinfo.attack;
    *fresh26 = Some(flyer_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh27 = (*self_0).monsterinfo.melee;
    *fresh27 = Some(flyer_melee as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh28 = (*self_0).monsterinfo.sight;
    *fresh28 = Some(
        flyer_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh29 = (*self_0).monsterinfo.idle;
    *fresh29 = Some(flyer_idle as unsafe extern "C" fn(*mut edict_t) -> ());
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh30 = (*self_0).monsterinfo.currentmove;
    *fresh30 = &mut flyer_move_stand;
