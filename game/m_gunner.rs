...
static mut sound_open: libc::c_int = 0;
static mut sound_search: libc::c_int = 0;
static mut sound_sight: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn gunner_idlesound(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
...
#[no_mangle]
pub unsafe extern "C" fn gunner_sight(
...
#[no_mangle]
pub unsafe extern "C" fn gunner_search(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut gunner_frames_fidget: [mframe_t; 49] = unsafe {
    [
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    gunner_idlesound as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut gunner_move_fidget: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 30 as libc::c_int,
            lastframe: 69 as libc::c_int,
            frame: gunner_frames_fidget.as_ptr() as *mut _,
            endfunc: Some(gunner_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn gunner_fidget(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        return;
    }
    if ((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.05f64
    {
        let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
        *fresh0 = &mut gunner_move_fidget;
    }
}
#[no_mangle]
pub static mut gunner_frames_stand: [mframe_t; 30] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    gunner_fidget as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut gunner_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 29 as libc::c_int,
            frame: gunner_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn gunner_stand(mut self_0: *mut edict_t) {
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut gunner_move_stand;
}
#[no_mangle]
pub static mut gunner_frames_walk: [mframe_t; 13] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut gunner_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 76 as libc::c_int,
            lastframe: 88 as libc::c_int,
            frame: gunner_frames_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn gunner_walk(mut self_0: *mut edict_t) {
    let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
    *fresh2 = &mut gunner_move_walk;
}
#[no_mangle]
pub static mut gunner_frames_run: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut gunner_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 94 as libc::c_int,
            lastframe: 101 as libc::c_int,
            frame: gunner_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn gunner_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut gunner_move_stand;
    } else {
        let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
        *fresh4 = &mut gunner_move_run;
    };
}
#[no_mangle]
pub static mut gunner_frames_runandshoot: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut gunner_move_runandshoot: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 102 as libc::c_int,
            lastframe: 107 as libc::c_int,
            frame: gunner_frames_runandshoot.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn gunner_runandshoot(mut self_0: *mut edict_t) {
    let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
    *fresh5 = &mut gunner_move_runandshoot;
}
#[no_mangle]
pub static mut gunner_frames_pain3: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut gunner_move_pain3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 185 as libc::c_int,
            lastframe: 189 as libc::c_int,
            frame: gunner_frames_pain3.as_ptr() as *mut _,
            endfunc: Some(gunner_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut gunner_frames_pain2: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut gunner_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 177 as libc::c_int,
            lastframe: 184 as libc::c_int,
            frame: gunner_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(gunner_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut gunner_frames_pain1: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut gunner_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 159 as libc::c_int,
            lastframe: 176 as libc::c_int,
            frame: gunner_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(gunner_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn gunner_pain(
    mut self_0: *mut edict_t,
    mut other: *mut edict_t,
    ...
    if damage <= 10 as libc::c_int {
        ...
        *fresh6 = &mut gunner_move_pain3;
    } else if damage <= 25 as libc::c_int {
        let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
        *fresh7 = &mut gunner_move_pain2;
    } else {
        let ref mut fresh8 = (*self_0).monsterinfo.currentmove;
        *fresh8 = &mut gunner_move_pain1;
    };
}
#[no_mangle]
pub unsafe extern "C" fn gunner_dead(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut gunner_frames_death: [mframe_t; 11] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut gunner_move_death: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 190 as libc::c_int,
            lastframe: 200 as libc::c_int,
            frame: gunner_frames_death.as_ptr() as *mut _,
            endfunc: Some(gunner_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn gunner_die(
    mut self_0: *mut edict_t,
    ...
    *fresh9 = &mut gunner_move_death;
}
#[no_mangle]
pub unsafe extern "C" fn gunner_duck_down(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub unsafe extern "C" fn gunner_duck_hold(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub unsafe extern "C" fn gunner_duck_up(mut self_0: *mut edict_t) {
    (*self_0).monsterinfo.aiflags &= !(0x800 as libc::c_int);
...
#[no_mangle]
pub static mut gunner_frames_duck: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 1 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    gunner_duck_down as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 1 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    gunner_duck_hold as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    gunner_duck_up as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut gunner_move_duck: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 201 as libc::c_int,
            lastframe: 208 as libc::c_int,
            frame: gunner_frames_duck.as_ptr() as *mut _,
            endfunc: Some(gunner_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn gunner_dodge(
    mut self_0: *mut edict_t,
    mut attacker: *mut edict_t,
    ...
    *fresh13 = &mut gunner_move_duck;
}
#[no_mangle]
pub unsafe extern "C" fn gunner_opengun(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn GunnerFire(mut self_0: *mut edict_t) {
    ...
    flash_number = 45 as libc::c_int + ((*self_0).s.frame - 144 as libc::c_int);
    AngleVectors(
...
#[no_mangle]
pub unsafe extern "C" fn GunnerGrenade(mut self_0: *mut edict_t) {
    let mut start: vec3_t = [0.; 3];
    let mut forward: vec3_t = [0.; 3];
    let mut right: vec3_t = [0.; 3];
    let mut aim: vec3_t = [0.; 3];
    let mut flash_number: libc::c_int = 0;
    if (*self_0).s.frame == 112 as libc::c_int {
        flash_number = 53 as libc::c_int;
    } else if (*self_0).s.frame == 115 as libc::c_int {
        flash_number = 54 as libc::c_int;
    } else if (*self_0).s.frame == 118 as libc::c_int {
        flash_number = 55 as libc::c_int;
    } else {
        flash_number = 56 as libc::c_int;
    }
    AngleVectors(
        ((*self_0).s.angles).as_mut_ptr(),
        forward.as_mut_ptr(),
...
#[no_mangle]
pub static mut gunner_frames_attack_chain: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    gunner_opengun as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut gunner_move_attack_chain: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 137 as libc::c_int,
            lastframe: 143 as libc::c_int,
            frame: gunner_frames_attack_chain.as_ptr() as *mut _,
            endfunc: Some(gunner_fire_chain as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut gunner_frames_fire_chain: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(GunnerFire as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut gunner_move_fire_chain: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 144 as libc::c_int,
            lastframe: 151 as libc::c_int,
            frame: gunner_frames_fire_chain.as_ptr() as *mut _,
            endfunc: Some(
                gunner_refire_chain as unsafe extern "C" fn(*mut edict_t) -> (),
            ),
        };
        init
    }
...
#[no_mangle]
pub static mut gunner_frames_endfire_chain: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut gunner_move_endfire_chain: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 152 as libc::c_int,
            lastframe: 158 as libc::c_int,
            frame: gunner_frames_endfire_chain.as_ptr() as *mut _,
            endfunc: Some(gunner_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut gunner_frames_attack_grenade: [mframe_t; 21] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    GunnerGrenade as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut gunner_move_attack_grenade: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 108 as libc::c_int,
            lastframe: 128 as libc::c_int,
            frame: gunner_frames_attack_grenade.as_ptr() as *mut _,
            endfunc: Some(gunner_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn gunner_attack(mut self_0: *mut edict_t) {
    if range(self_0, (*self_0).enemy) == 0 as libc::c_int {
        let ref mut fresh14 = (*self_0).monsterinfo.currentmove;
        *fresh14 = &mut gunner_move_attack_chain;
    } else if ((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.5f64
    {
        let ref mut fresh15 = (*self_0).monsterinfo.currentmove;
        *fresh15 = &mut gunner_move_attack_grenade;
    } else {
        let ref mut fresh16 = (*self_0).monsterinfo.currentmove;
        *fresh16 = &mut gunner_move_attack_chain;
    };
}
#[no_mangle]
pub unsafe extern "C" fn gunner_fire_chain(mut self_0: *mut edict_t) {
    let ref mut fresh17 = (*self_0).monsterinfo.currentmove;
    *fresh17 = &mut gunner_move_fire_chain;
}
#[no_mangle]
pub unsafe extern "C" fn gunner_refire_chain(mut self_0: *mut edict_t) {
    if (*(*self_0).enemy).health > 0 as libc::c_int {
        if visible(self_0, (*self_0).enemy) as u64 != 0 {
                ...
                / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.5f64
            {
                ...
                *fresh18 = &mut gunner_move_fire_chain;
                return;
            }
        }
    }
    let ref mut fresh19 = (*self_0).monsterinfo.currentmove;
    *fresh19 = &mut gunner_move_endfire_chain;
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_gunner(mut self_0: *mut edict_t) {
    ...
    sound_death = (gi.soundindex)
        ...
        b"gunner/death1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"gunner/gunpain2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"gunner/gunpain1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_idle = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"gunner/gunidle1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_open = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"gunner/gunatck1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"gunner/gunsrch1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_sight = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"gunner/sight1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"gunner/gunatck2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"gunner/gunatck3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    ...
    (*self_0)
        ...
        b"models/monsters/gunner/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0).mins[0 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    ...
    let ref mut fresh20 = (*self_0).pain;
    *fresh20 = Some(
        gunner_pain
    ...
    *fresh22 = Some(gunner_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh23 = (*self_0).monsterinfo.walk;
    *fresh23 = Some(gunner_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh24 = (*self_0).monsterinfo.run;
    *fresh24 = Some(gunner_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh25 = (*self_0).monsterinfo.dodge;
    *fresh25 = Some(
        gunner_dodge
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, libc::c_float) -> (),
    );
    let ref mut fresh26 = (*self_0).monsterinfo.attack;
    *fresh26 = Some(gunner_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh27 = (*self_0).monsterinfo.melee;
    *fresh27 = None;
    let ref mut fresh28 = (*self_0).monsterinfo.sight;
    *fresh28 = Some(
        gunner_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh29 = (*self_0).monsterinfo.search;
    *fresh29 = Some(gunner_search as unsafe extern "C" fn(*mut edict_t) -> ());
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh30 = (*self_0).monsterinfo.currentmove;
    *fresh30 = &mut gunner_move_stand;
    (*self_0).monsterinfo.scale = 1.150000f64 as libc::c_float;
