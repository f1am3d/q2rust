...
#[no_mangle]
pub unsafe extern "C" fn hover_sight(mut self_0: *mut edict_t, mut other: *mut edict_t) {
    (gi.sound)
        .expect(
...
#[no_mangle]
pub unsafe extern "C" fn hover_search(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut hover_frames_stand: [mframe_t; 30] = unsafe {
    [
        {
...
#[no_mangle]
pub static mut hover_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 29 as libc::c_int,
            frame: hover_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_stop1: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_stop1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 65 as libc::c_int,
            lastframe: 73 as libc::c_int,
            frame: hover_frames_stop1.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_stop2: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_stop2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 74 as libc::c_int,
            lastframe: 81 as libc::c_int,
            frame: hover_frames_stop2.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_takeoff: [mframe_t; 30] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_takeoff: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 82 as libc::c_int,
            lastframe: 111 as libc::c_int,
            frame: hover_frames_takeoff.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_pain3: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_pain3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 153 as libc::c_int,
            lastframe: 161 as libc::c_int,
            frame: hover_frames_pain3.as_ptr() as *mut _,
            endfunc: Some(hover_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut hover_frames_pain2: [mframe_t; 12] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 141 as libc::c_int,
            lastframe: 152 as libc::c_int,
            frame: hover_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(hover_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_pain1: [mframe_t; 28] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 113 as libc::c_int,
            lastframe: 140 as libc::c_int,
            frame: hover_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(hover_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_land: [mframe_t; 1] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_land: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 112 as libc::c_int,
            lastframe: 112 as libc::c_int,
            frame: hover_frames_land.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_forward: [mframe_t; 35] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_forward: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 30 as libc::c_int,
            lastframe: 64 as libc::c_int,
            frame: hover_frames_forward.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_walk: [mframe_t; 35] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 30 as libc::c_int,
            lastframe: 64 as libc::c_int,
            frame: hover_frames_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_run: [mframe_t; 35] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 30 as libc::c_int,
            lastframe: 64 as libc::c_int,
            frame: hover_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_death1: [mframe_t; 11] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_death1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 162 as libc::c_int,
            lastframe: 172 as libc::c_int,
            frame: hover_frames_death1.as_ptr() as *mut _,
            endfunc: Some(hover_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut hover_frames_backward: [mframe_t; 24] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_backward: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 173 as libc::c_int,
            lastframe: 196 as libc::c_int,
            frame: hover_frames_backward.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_start_attack: [mframe_t; 3] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_start_attack: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 197 as libc::c_int,
            lastframe: 199 as libc::c_int,
            frame: hover_frames_start_attack.as_ptr() as *mut _,
            endfunc: Some(hover_attack as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut hover_frames_attack1: [mframe_t; 3] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: -(10 as libc::c_int) as libc::c_float,
                thinkfunc: Some(
                    hover_fire_blaster as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    hover_reattack as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut hover_move_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 200 as libc::c_int,
            lastframe: 202 as libc::c_int,
            frame: hover_frames_attack1.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut hover_frames_end_attack: [mframe_t; 2] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut hover_move_end_attack: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 203 as libc::c_int,
            lastframe: 204 as libc::c_int,
            frame: hover_frames_end_attack.as_ptr() as *mut _,
            endfunc: Some(hover_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn hover_reattack(mut self_0: *mut edict_t) {
    if (*(*self_0).enemy).health > 0 as libc::c_int {
        if visible(self_0, (*self_0).enemy) as u64 != 0 {
                ...
                / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.6f64
            {
                ...
                *fresh0 = &mut hover_move_attack1;
                return;
            }
        }
    }
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut hover_move_end_attack;
}
#[no_mangle]
pub unsafe extern "C" fn hover_fire_blaster(mut self_0: *mut edict_t) {
    ...
    if (*self_0).s.frame == 200 as libc::c_int {
    ...
    G_ProjectSource(
        ...
        (*monster_flash_offset.as_mut_ptr().offset(62 as libc::c_int as isize))
            .as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
        start.as_mut_ptr(),
...
#[no_mangle]
pub unsafe extern "C" fn hover_stand(mut self_0: *mut edict_t) {
    let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
    *fresh2 = &mut hover_move_stand;
}
#[no_mangle]
pub unsafe extern "C" fn hover_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut hover_move_stand;
    } else {
        let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
        *fresh4 = &mut hover_move_run;
    };
}
#[no_mangle]
pub unsafe extern "C" fn hover_walk(mut self_0: *mut edict_t) {
    let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
    *fresh5 = &mut hover_move_walk;
}
#[no_mangle]
pub unsafe extern "C" fn hover_start_attack(mut self_0: *mut edict_t) {
    let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
    *fresh6 = &mut hover_move_start_attack;
}
#[no_mangle]
pub unsafe extern "C" fn hover_attack(mut self_0: *mut edict_t) {
    let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
    *fresh7 = &mut hover_move_attack1;
}
#[no_mangle]
pub unsafe extern "C" fn hover_pain(
    ...
    if damage <= 25 as libc::c_int {
        ...
        *fresh10 = &mut hover_move_pain1;
    };
}
#[no_mangle]
pub unsafe extern "C" fn hover_deadthink(mut self_0: *mut edict_t) {
    if ((*self_0).groundentity).is_null() && level.time < (*self_0).timestamp {
...
#[no_mangle]
pub unsafe extern "C" fn hover_dead(mut self_0: *mut edict_t) {
    ...
    let ref mut fresh11 = (*self_0).think;
    *fresh11 = Some(hover_deadthink as unsafe extern "C" fn(*mut edict_t) -> ());
    (*self_0).nextthink = (level.time as libc::c_double + 0.1f64) as libc::c_float;
    (*self_0).timestamp = level.time + 15 as libc::c_int as libc::c_float;
    (gi.linkentity).expect("non-null function pointer")(self_0);
}
#[no_mangle]
pub unsafe extern "C" fn hover_die(
    mut self_0: *mut edict_t,
    ...
    *fresh12 = &mut hover_move_death1;
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_hover(mut self_0: *mut edict_t) {
    ...
    sound_pain1 = (gi.soundindex)
        ...
        b"hover/hovpain1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"hover/hovpain2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_death1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"hover/hovdeth1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_death2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"hover/hovdeth2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_sight = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"hover/hovsght1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"hover/hovsrch1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"hover/hovsrch2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"hover/hovatck1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (*self_0)
        .s
        .sound = (gi.soundindex)
        ...
        b"hover/hovidle1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    ...
    (*self_0)
        ...
        b"models/monsters/hover/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    ...
    (*self_0).health = 240 as libc::c_int;
    (*self_0).gib_health = -(100 as libc::c_int);
    (*self_0).mass = 150 as libc::c_int;
    let ref mut fresh13 = (*self_0).pain;
    *fresh13 = Some(
        hover_pain
    ...
    let ref mut fresh14 = (*self_0).die;
    *fresh14 = Some(
        hover_die
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh15 = (*self_0).monsterinfo.stand;
    *fresh15 = Some(hover_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh16 = (*self_0).monsterinfo.walk;
    *fresh16 = Some(hover_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh17 = (*self_0).monsterinfo.run;
    *fresh17 = Some(hover_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh18 = (*self_0).monsterinfo.attack;
    *fresh18 = Some(hover_start_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh19 = (*self_0).monsterinfo.sight;
    *fresh19 = Some(
        hover_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh20 = (*self_0).monsterinfo.search;
    *fresh20 = Some(hover_search as unsafe extern "C" fn(*mut edict_t) -> ());
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh21 = (*self_0).monsterinfo.currentmove;
    *fresh21 = &mut hover_move_stand;
