...
static mut sound_fist: libc::c_int = 0;
static mut sound_shake: libc::c_int = 0;
static mut sound_moan: libc::c_int = 0;
static mut sound_scream: [libc::c_int; 8] = [0; 8];
#[no_mangle]
pub unsafe extern "C" fn insane_fist(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
...
#[no_mangle]
pub unsafe extern "C" fn insane_shake(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn insane_moan(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn insane_scream(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
        self_0,
        2 as libc::c_int,
        sound_scream[(rand() % 8 as libc::c_int) as usize],
        1 as libc::c_int as libc::c_float,
        2 as libc::c_int as libc::c_float,
        0 as libc::c_int as libc::c_float,
    );
...
#[no_mangle]
pub static mut insane_frames_stand_normal: [mframe_t; 6] = unsafe {
    [
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    insane_checkdown as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut insane_move_stand_normal: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 59 as libc::c_int,
            lastframe: 64 as libc::c_int,
            frame: insane_frames_stand_normal.as_ptr() as *mut _,
            endfunc: Some(insane_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut insane_frames_stand_insane: [mframe_t; 30] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(insane_shake as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut insane_move_stand_insane: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 64 as libc::c_int,
            lastframe: 93 as libc::c_int,
            frame: insane_frames_stand_insane.as_ptr() as *mut _,
            endfunc: Some(insane_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut insane_frames_uptodown: [mframe_t; 40] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(insane_moan as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(insane_fist as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut insane_move_uptodown: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 39 as libc::c_int,
            frame: insane_frames_uptodown.as_ptr() as *mut _,
            endfunc: Some(insane_onground as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut insane_frames_downtoup: [mframe_t; 19] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_downtoup: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 40 as libc::c_int,
            lastframe: 58 as libc::c_int,
            frame: insane_frames_downtoup.as_ptr() as *mut _,
            endfunc: Some(insane_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut insane_frames_jumpdown: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_jumpdown: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 95 as libc::c_int,
            lastframe: 99 as libc::c_int,
            frame: insane_frames_jumpdown.as_ptr() as *mut _,
            endfunc: Some(insane_onground as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut insane_frames_down: [mframe_t; 61] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: -0.2f64 as libc::c_float,
                thinkfunc: Some(
                    insane_scream as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    insane_checkup as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut insane_move_down: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 99 as libc::c_int,
            lastframe: 159 as libc::c_int,
            frame: insane_frames_down.as_ptr() as *mut _,
            endfunc: Some(insane_onground as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut insane_frames_walk_normal: [mframe_t; 13] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_walk_normal: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 160 as libc::c_int,
            lastframe: 172 as libc::c_int,
            frame: insane_frames_walk_normal.as_ptr() as *mut _,
            endfunc: Some(insane_walk as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut insane_move_run_normal: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 160 as libc::c_int,
            lastframe: 172 as libc::c_int,
            frame: insane_frames_walk_normal.as_ptr() as *mut _,
            endfunc: Some(insane_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut insane_frames_walk_insane: [mframe_t; 26] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_walk_insane: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 173 as libc::c_int,
            lastframe: 198 as libc::c_int,
            frame: insane_frames_walk_insane.as_ptr() as *mut _,
            endfunc: Some(insane_walk as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut insane_move_run_insane: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 173 as libc::c_int,
            lastframe: 198 as libc::c_int,
...
#[no_mangle]
pub static mut insane_frames_stand_pain: [mframe_t; 11] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_stand_pain: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 199 as libc::c_int,
            lastframe: 209 as libc::c_int,
            frame: insane_frames_stand_pain.as_ptr() as *mut _,
            endfunc: Some(insane_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut insane_frames_stand_death: [mframe_t; 17] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_stand_death: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 210 as libc::c_int,
            lastframe: 226 as libc::c_int,
            frame: insane_frames_stand_death.as_ptr() as *mut _,
            endfunc: Some(insane_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut insane_frames_crawl: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_crawl: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 227 as libc::c_int,
            lastframe: 235 as libc::c_int,
            frame: insane_frames_crawl.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut insane_move_runcrawl: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 227 as libc::c_int,
            lastframe: 235 as libc::c_int,
...
#[no_mangle]
pub static mut insane_frames_crawl_pain: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_crawl_pain: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 236 as libc::c_int,
            lastframe: 244 as libc::c_int,
            frame: insane_frames_crawl_pain.as_ptr() as *mut _,
            endfunc: Some(insane_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut insane_frames_crawl_death: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_crawl_death: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 245 as libc::c_int,
            lastframe: 251 as libc::c_int,
            frame: insane_frames_crawl_death.as_ptr() as *mut _,
            endfunc: Some(insane_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut insane_frames_cross: [mframe_t; 15] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_cross: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 252 as libc::c_int,
            lastframe: 266 as libc::c_int,
            frame: insane_frames_cross.as_ptr() as *mut _,
            endfunc: Some(insane_cross as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut insane_frames_struggle_cross: [mframe_t; 15] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut insane_move_struggle_cross: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 267 as libc::c_int,
            lastframe: 281 as libc::c_int,
            frame: insane_frames_struggle_cross.as_ptr() as *mut _,
            endfunc: Some(insane_cross as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn insane_cross(mut self_0: *mut edict_t) {
...
pub unsafe extern "C" fn insane_walk(mut self_0: *mut edict_t) {
        ...
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.5f64
    {
        ...
        *fresh4 = &mut insane_move_walk_normal;
    } else {
        let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
        *fresh5 = &mut insane_move_walk_insane;
    };
}
#[no_mangle]
pub unsafe extern "C" fn insane_run(mut self_0: *mut edict_t) {
    if (*self_0).spawnflags & 16 as libc::c_int != 0 {
        if (*self_0).s.frame == 244 as libc::c_int {
            let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
            *fresh6 = &mut insane_move_down;
            return;
        }
    }
    if (*self_0).spawnflags & 4 as libc::c_int != 0 {
        let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
        *fresh7 = &mut insane_move_runcrawl;
    } else if ((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.5f64
    {
        let ref mut fresh8 = (*self_0).monsterinfo.currentmove;
        *fresh8 = &mut insane_move_run_normal;
    } else {
        let ref mut fresh9 = (*self_0).monsterinfo.currentmove;
        *fresh9 = &mut insane_move_run_insane;
    };
}
#[no_mangle]
pub unsafe extern "C" fn insane_pain(
    ...
    if (*self_0).health < 25 as libc::c_int {
        l = 25 as libc::c_int;
    } else if (*self_0).health < 50 as libc::c_int {
        l = 50 as libc::c_int;
    } else if (*self_0).health < 75 as libc::c_int {
        l = 75 as libc::c_int;
    } else {
        l = 100 as libc::c_int;
    }
    (gi.sound)
        ...
        (gi.soundindex)
            ...
            va(
                b"player/male/pain%i_%i.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                l,
                r,
            ),
    ...
    if (*self_0).spawnflags & 8 as libc::c_int != 0 {
        ...
        *fresh10 = &mut insane_move_struggle_cross;
        return;
    }
    if (*self_0).s.frame >= 227 as libc::c_int && (*self_0).s.frame <= 235 as libc::c_int
        || (*self_0).s.frame >= 98 as libc::c_int
            && (*self_0).s.frame <= 159 as libc::c_int
    {
        let ref mut fresh11 = (*self_0).monsterinfo.currentmove;
        *fresh11 = &mut insane_move_crawl_pain;
    } else {
        let ref mut fresh12 = (*self_0).monsterinfo.currentmove;
        *fresh12 = &mut insane_move_stand_pain;
    };
}
#[no_mangle]
pub unsafe extern "C" fn insane_onground(mut self_0: *mut edict_t) {
    let ref mut fresh13 = (*self_0).monsterinfo.currentmove;
    *fresh13 = &mut insane_move_down;
}
#[no_mangle]
pub unsafe extern "C" fn insane_checkdown(mut self_0: *mut edict_t) {
        ...
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.3f64
    {
            ...
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.5f64
        {
            ...
            *fresh14 = &mut insane_move_uptodown;
        } else {
            let ref mut fresh15 = (*self_0).monsterinfo.currentmove;
            *fresh15 = &mut insane_move_jumpdown;
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn insane_checkup(mut self_0: *mut edict_t) {
    if (*self_0).spawnflags & 4 as libc::c_int != 0
        && (*self_0).spawnflags & 16 as libc::c_int != 0
    {
        return;
    }
    if (((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.5f64
    {
        ...
        *fresh16 = &mut insane_move_downtoup;
    }
}
#[no_mangle]
pub unsafe extern "C" fn insane_stand(mut self_0: *mut edict_t) {
    if (*self_0).spawnflags & 8 as libc::c_int != 0 {
        let ref mut fresh17 = (*self_0).monsterinfo.currentmove;
        *fresh17 = &mut insane_move_cross;
        (*self_0).monsterinfo.aiflags |= 0x1 as libc::c_int;
    } else if (*self_0).spawnflags & 4 as libc::c_int != 0
        && (*self_0).spawnflags & 16 as libc::c_int != 0
    {
        let ref mut fresh18 = (*self_0).monsterinfo.currentmove;
        *fresh18 = &mut insane_move_down;
    } else if (((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.5f64
    {
        let ref mut fresh19 = (*self_0).monsterinfo.currentmove;
        *fresh19 = &mut insane_move_stand_normal;
    } else {
        let ref mut fresh20 = (*self_0).monsterinfo.currentmove;
        *fresh20 = &mut insane_move_stand_insane;
    };
}
#[no_mangle]
pub unsafe extern "C" fn insane_dead(mut self_0: *mut edict_t) {
    if (*self_0).spawnflags & 8 as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn insane_die(
    mut self_0: *mut edict_t,
    ...
    (gi.sound)
        ...
        (gi.soundindex)
            ...
            va(
                b"player/male/death%i.wav\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
    ...
    if (*self_0).spawnflags & 8 as libc::c_int != 0 {
        insane_dead(self_0);
    } else if (*self_0).s.frame >= 227 as libc::c_int
        && (*self_0).s.frame <= 235 as libc::c_int
        || (*self_0).s.frame >= 98 as libc::c_int
            && (*self_0).s.frame <= 159 as libc::c_int
    {
        let ref mut fresh21 = (*self_0).monsterinfo.currentmove;
        *fresh21 = &mut insane_move_crawl_death;
    } else {
        let ref mut fresh22 = (*self_0).monsterinfo.currentmove;
        *fresh22 = &mut insane_move_stand_death;
    };
}
#[no_mangle]
pub unsafe extern "C" fn SP_misc_insane(mut self_0: *mut edict_t) {
    if (*deathmatch).value != 0. {
        G_FreeEdict(self_0);
        return;
    }
    sound_fist = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane11.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_shake = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane5.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_moan = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane7.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_scream[0 as libc::c_int
        as usize] = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_scream[1 as libc::c_int
        as usize] = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_scream[2 as libc::c_int
        as usize] = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_scream[3 as libc::c_int
        as usize] = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane4.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_scream[4 as libc::c_int
        as usize] = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane6.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_scream[5 as libc::c_int
        as usize] = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane8.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_scream[6 as libc::c_int
        as usize] = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane9.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_scream[7 as libc::c_int
        as usize] = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"insane/insane10.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    ...
    (*self_0)
        ...
        b"models/monsters/insane/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0).mins[0 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    ...
    (*self_0).gib_health = -(50 as libc::c_int);
    ...
    *fresh25 = Some(insane_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh26 = (*self_0).monsterinfo.walk;
    *fresh26 = Some(insane_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh27 = (*self_0).monsterinfo.run;
    *fresh27 = Some(insane_run as unsafe extern "C" fn(*mut edict_t) -> ());
    ...
    *fresh31 = None;
    ...
    let ref mut fresh32 = (*self_0).monsterinfo.currentmove;
    *fresh32 = &mut insane_move_stand_normal;
    (*self_0).monsterinfo.scale = 1.000000f64 as libc::c_float;
    if (*self_0).spawnflags & 8 as libc::c_int != 0 {
        (*self_0).mins[0 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
        (*self_0).mins[1 as libc::c_int as usize] = 0 as libc::c_int as vec_t;
        ...
        (*self_0).s.skinnum = rand() % 3 as libc::c_int;
    };
}
