...
static mut sound_swing: libc::c_int = 0;
static mut sound_hit: libc::c_int = 0;
static mut sound_hit2: libc::c_int = 0;
...
static mut sound_step1: libc::c_int = 0;
static mut sound_step2: libc::c_int = 0;
static mut sound_step3: libc::c_int = 0;
static mut sound_thud: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn mutant_step(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub unsafe extern "C" fn mutant_sight(
...
#[no_mangle]
pub unsafe extern "C" fn mutant_search(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn mutant_swing(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut mutant_frames_stand: [mframe_t; 51] = unsafe {
    [
        {
...
#[no_mangle]
pub static mut mutant_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 62 as libc::c_int,
            lastframe: 112 as libc::c_int,
            frame: mutant_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn mutant_stand(mut self_0: *mut edict_t) {
    let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
    *fresh0 = &mut mutant_move_stand;
}
#[no_mangle]
pub unsafe extern "C" fn mutant_idle_loop(mut self_0: *mut edict_t) {
    if (((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.75f64
    {
        (*self_0).monsterinfo.nextframe = 116 as libc::c_int;
    }
}
#[no_mangle]
pub static mut mutant_frames_idle: [mframe_t; 13] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    mutant_idle_loop as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut mutant_move_idle: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 113 as libc::c_int,
            lastframe: 125 as libc::c_int,
            frame: mutant_frames_idle.as_ptr() as *mut _,
            endfunc: Some(mutant_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn mutant_idle(mut self_0: *mut edict_t) {
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut mutant_move_idle;
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut mutant_frames_walk: [mframe_t; 12] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut mutant_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 130 as libc::c_int,
            lastframe: 141 as libc::c_int,
            frame: mutant_frames_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn mutant_walk_loop(mut self_0: *mut edict_t) {
    let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
    *fresh2 = &mut mutant_move_walk;
}
#[no_mangle]
pub static mut mutant_frames_start_walk: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut mutant_move_start_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 126 as libc::c_int,
            lastframe: 129 as libc::c_int,
            frame: mutant_frames_start_walk.as_ptr() as *mut _,
            endfunc: Some(mutant_walk_loop as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn mutant_walk(mut self_0: *mut edict_t) {
    let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
    *fresh3 = &mut mutant_move_start_walk;
}
#[no_mangle]
pub static mut mutant_frames_run: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 40 as libc::c_int as libc::c_float,
                thinkfunc: None,
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: 40 as libc::c_int as libc::c_float,
                thinkfunc: Some(mutant_step as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut mutant_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 56 as libc::c_int,
            lastframe: 61 as libc::c_int,
            frame: mutant_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn mutant_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
        *fresh4 = &mut mutant_move_stand;
    } else {
        let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
        *fresh5 = &mut mutant_move_run;
    };
}
#[no_mangle]
pub unsafe extern "C" fn mutant_hit_left(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub unsafe extern "C" fn mutant_hit_right(mut self_0: *mut edict_t) {
    let mut aim: vec3_t = [0.; 3];
    aim[0 as libc::c_int as usize] = 80 as libc::c_int as vec_t;
...
#[no_mangle]
pub unsafe extern "C" fn mutant_check_refire(mut self_0: *mut edict_t) {
    ...
    {
        (*self_0).monsterinfo.nextframe = 8 as libc::c_int;
    }
}
#[no_mangle]
pub static mut mutant_frames_attack: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    mutant_hit_left as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    mutant_hit_right as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    mutant_check_refire as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut mutant_move_attack: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 8 as libc::c_int,
            lastframe: 14 as libc::c_int,
            frame: mutant_frames_attack.as_ptr() as *mut _,
            endfunc: Some(mutant_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn mutant_melee(mut self_0: *mut edict_t) {
    let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
    *fresh6 = &mut mutant_move_attack;
}
#[no_mangle]
pub unsafe extern "C" fn mutant_jump_touch(
    mut self_0: *mut edict_t,
    mut other: *mut edict_t,
    ...
    if (*self_0).health <= 0 as libc::c_int {
        let ref mut fresh7 = (*self_0).touch;
        *fresh7 = None;
        return;
    }
    if (*other).takedamage != 0 {
        if VectorLength(((*self_0).velocity).as_mut_ptr())
    ...
    if M_CheckBottom(self_0) as u64 == 0 {
        if !((*self_0).groundentity).is_null() {
            (*self_0).monsterinfo.nextframe = 1 as libc::c_int;
            let ref mut fresh8 = (*self_0).touch;
            *fresh8 = None;
        }
        return;
    }
    let ref mut fresh9 = (*self_0).touch;
    *fresh9 = None;
}
#[no_mangle]
pub unsafe extern "C" fn mutant_jump_takeoff(mut self_0: *mut edict_t) {
    ...
    let ref mut fresh10 = (*self_0).s.origin[2 as libc::c_int as usize];
    *fresh10 += 1 as libc::c_int as libc::c_float;
    VectorScale(
        forward.as_mut_ptr(),
        600 as libc::c_int as vec_t,
        ((*self_0).velocity).as_mut_ptr(),
    );
    (*self_0).velocity[2 as libc::c_int as usize] = 250 as libc::c_int as vec_t;
    let ref mut fresh11 = (*self_0).groundentity;
    *fresh11 = 0 as *mut edict_t;
    (*self_0).monsterinfo.aiflags |= 0x800 as libc::c_int;
    (*self_0)
        .monsterinfo
        .attack_finished = level.time + 3 as libc::c_int as libc::c_float;
    let ref mut fresh12 = (*self_0).touch;
    *fresh12 = Some(
        mutant_jump_touch
...
#[no_mangle]
pub unsafe extern "C" fn mutant_check_landing(mut self_0: *mut edict_t) {
    if !((*self_0).groundentity).is_null() {
        (gi.sound)
            .expect(
                "non-null function pointer",
        ...
        (*self_0).monsterinfo.attack_finished = 0 as libc::c_int as libc::c_float;
        (*self_0).monsterinfo.aiflags &= !(0x800 as libc::c_int);
        return;
    }
    if level.time > (*self_0).monsterinfo.attack_finished {
        ...
        (*self_0).monsterinfo.nextframe = 4 as libc::c_int;
    };
}
#[no_mangle]
pub static mut mutant_frames_jump: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 15 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    mutant_jump_takeoff as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 15 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    mutant_check_landing as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut mutant_move_jump: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 7 as libc::c_int,
            frame: mutant_frames_jump.as_ptr() as *mut _,
            endfunc: Some(mutant_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn mutant_jump(mut self_0: *mut edict_t) {
    let ref mut fresh13 = (*self_0).monsterinfo.currentmove;
    *fresh13 = &mut mutant_move_jump;
}
#[no_mangle]
pub unsafe extern "C" fn mutant_check_melee(mut self_0: *mut edict_t) -> qboolean {
...
#[no_mangle]
pub unsafe extern "C" fn mutant_check_jump(mut self_0: *mut edict_t) -> qboolean {
    let mut v: vec3_t = [0.; 3];
    let mut distance: libc::c_float = 0.;
    if (*self_0).absmin[2 as libc::c_int as usize] as libc::c_double
        > (*(*self_0).enemy).absmin[2 as libc::c_int as usize] as libc::c_double
            + 0.75f64
                * (*(*self_0).enemy).size[2 as libc::c_int as usize] as libc::c_double
    {
        return false_0;
    }
    if ((*self_0).absmax[2 as libc::c_int as usize] as libc::c_double)
        < (*(*self_0).enemy).absmin[2 as libc::c_int as usize] as libc::c_double
            + 0.25f64
                * (*(*self_0).enemy).size[2 as libc::c_int as usize] as libc::c_double
    {
    ...
    distance = VectorLength(v.as_mut_ptr());
    if distance < 100 as libc::c_int as libc::c_float {
        return false_0;
    }
    if distance > 100 as libc::c_int as libc::c_float {
        if (((rand() & 0x7fff as libc::c_int) as libc::c_float
...
#[no_mangle]
pub unsafe extern "C" fn mutant_checkattack(mut self_0: *mut edict_t) -> qboolean {
    if ((*self_0).enemy).is_null() || (*(*self_0).enemy).health <= 0 as libc::c_int {
        return false_0;
    }
    if mutant_check_melee(self_0) as u64 != 0 {
        (*self_0).monsterinfo.attack_state = 3 as libc::c_int;
        return true_0;
    }
    if mutant_check_jump(self_0) as u64 != 0 {
...
#[no_mangle]
pub static mut mutant_frames_pain1: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut mutant_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 34 as libc::c_int,
            lastframe: 38 as libc::c_int,
            frame: mutant_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(mutant_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut mutant_frames_pain2: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut mutant_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 39 as libc::c_int,
            lastframe: 44 as libc::c_int,
            frame: mutant_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(mutant_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut mutant_frames_pain3: [mframe_t; 11] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: -(22 as libc::c_int) as libc::c_float,
                thinkfunc: None,
            };
            init
        },
...
#[no_mangle]
pub static mut mutant_move_pain3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 45 as libc::c_int,
            lastframe: 55 as libc::c_int,
            frame: mutant_frames_pain3.as_ptr() as *mut _,
            endfunc: Some(mutant_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn mutant_pain(
    mut self_0: *mut edict_t,
    mut other: *mut edict_t,
    ...
    if (r as libc::c_double) < 0.33f64 {
        ...
        *fresh16 = &mut mutant_move_pain3;
    };
}
#[no_mangle]
pub unsafe extern "C" fn mutant_dead(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut mutant_frames_death1: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut mutant_move_death1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 15 as libc::c_int,
            lastframe: 23 as libc::c_int,
            frame: mutant_frames_death1.as_ptr() as *mut _,
            endfunc: Some(mutant_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut mutant_frames_death2: [mframe_t; 10] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut mutant_move_death2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 24 as libc::c_int,
            lastframe: 33 as libc::c_int,
            frame: mutant_frames_death2.as_ptr() as *mut _,
            endfunc: Some(mutant_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn mutant_die(
    mut self_0: *mut edict_t,
        ...
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.5f64
    {
        ...
        *fresh17 = &mut mutant_move_death1;
    } else {
        let ref mut fresh18 = (*self_0).monsterinfo.currentmove;
        *fresh18 = &mut mutant_move_death2;
    };
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_mutant(mut self_0: *mut edict_t) {
    if (*deathmatch).value != 0. {
        G_FreeEdict(self_0);
        return;
    }
    sound_swing = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutatck1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_hit = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutatck2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_hit2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutatck3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_death = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutdeth1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_idle = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutidle1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutpain1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutpain2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_sight = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutsght1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_search = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/mutsrch1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_step1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/step1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_step2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/step2.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_step3 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/step3.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    sound_thud = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"mutant/thud1.wav\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    ...
    (*self_0)
        ...
        b"models/monsters/mutant/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    ...
    (*self_0).gib_health = -(120 as libc::c_int);
    (*self_0).mass = 300 as libc::c_int;
    let ref mut fresh19 = (*self_0).pain;
    *fresh19 = Some(
        mutant_pain
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh20 = (*self_0).die;
    *fresh20 = Some(
        mutant_die
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh21 = (*self_0).monsterinfo.stand;
    *fresh21 = Some(mutant_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh22 = (*self_0).monsterinfo.walk;
    *fresh22 = Some(mutant_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh23 = (*self_0).monsterinfo.run;
    *fresh23 = Some(mutant_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh24 = (*self_0).monsterinfo.dodge;
    *fresh24 = None;
    let ref mut fresh25 = (*self_0).monsterinfo.attack;
    *fresh25 = Some(mutant_jump as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh26 = (*self_0).monsterinfo.melee;
    *fresh26 = Some(mutant_melee as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh27 = (*self_0).monsterinfo.sight;
    *fresh27 = Some(
        mutant_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh28 = (*self_0).monsterinfo.search;
    *fresh28 = Some(mutant_search as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh29 = (*self_0).monsterinfo.idle;
    *fresh29 = Some(mutant_idle as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh30 = (*self_0).monsterinfo.checkattack;
    *fresh30 = Some(
        mutant_checkattack as unsafe extern "C" fn(*mut edict_t) -> qboolean,
    );
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh31 = (*self_0).monsterinfo.currentmove;
    *fresh31 = &mut mutant_move_stand;
