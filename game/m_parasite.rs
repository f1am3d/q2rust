...
static mut sound_launch: libc::c_int = 0;
static mut sound_impact: libc::c_int = 0;
static mut sound_suck: libc::c_int = 0;
static mut sound_reelin: libc::c_int = 0;
static mut sound_sight: libc::c_int = 0;
static mut sound_tap: libc::c_int = 0;
static mut sound_scratch: libc::c_int = 0;
static mut sound_search: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn parasite_launch(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
...
#[no_mangle]
pub unsafe extern "C" fn parasite_reel_in(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn parasite_sight(
...
#[no_mangle]
pub unsafe extern "C" fn parasite_tap(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn parasite_scratch(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub unsafe extern "C" fn parasite_search(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
            "non-null function pointer",
        )(
...
#[no_mangle]
pub static mut parasite_frames_start_fidget: [mframe_t; 4] = unsafe {
    [
        {
...
#[no_mangle]
pub static mut parasite_move_start_fidget: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 100 as libc::c_int,
            lastframe: 103 as libc::c_int,
            frame: parasite_frames_start_fidget.as_ptr() as *mut _,
            endfunc: Some(parasite_do_fidget as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut parasite_frames_fidget: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    parasite_scratch as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut parasite_move_fidget: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 104 as libc::c_int,
            lastframe: 109 as libc::c_int,
            frame: parasite_frames_fidget.as_ptr() as *mut _,
            endfunc: Some(parasite_refidget as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut parasite_frames_end_fidget: [mframe_t; 8] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut parasite_move_end_fidget: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 110 as libc::c_int,
            lastframe: 117 as libc::c_int,
            frame: parasite_frames_end_fidget.as_ptr() as *mut _,
            endfunc: Some(parasite_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn parasite_end_fidget(mut self_0: *mut edict_t) {
    let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
    *fresh0 = &mut parasite_move_end_fidget;
}
#[no_mangle]
pub unsafe extern "C" fn parasite_do_fidget(mut self_0: *mut edict_t) {
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut parasite_move_fidget;
}
#[no_mangle]
pub unsafe extern "C" fn parasite_refidget(mut self_0: *mut edict_t) {
        ...
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double <= 0.8f64
    {
        ...
        *fresh2 = &mut parasite_move_fidget;
    } else {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut parasite_move_end_fidget;
    };
}
#[no_mangle]
pub unsafe extern "C" fn parasite_idle(mut self_0: *mut edict_t) {
    let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
    *fresh4 = &mut parasite_move_start_fidget;
}
#[no_mangle]
pub static mut parasite_frames_stand: [mframe_t; 17] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(parasite_tap as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut parasite_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 83 as libc::c_int,
            lastframe: 99 as libc::c_int,
            frame: parasite_frames_stand.as_ptr() as *mut _,
            endfunc: Some(parasite_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn parasite_stand(mut self_0: *mut edict_t) {
    let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
    *fresh5 = &mut parasite_move_stand;
}
#[no_mangle]
pub static mut parasite_frames_run: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 25 as libc::c_int as libc::c_float,
                thinkfunc: None,
            };
            init
        },
...
#[no_mangle]
pub static mut parasite_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 70 as libc::c_int,
            lastframe: 76 as libc::c_int,
            frame: parasite_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut parasite_frames_start_run: [mframe_t; 2] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut parasite_move_start_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 68 as libc::c_int,
            lastframe: 69 as libc::c_int,
            frame: parasite_frames_start_run.as_ptr() as *mut _,
            endfunc: Some(parasite_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut parasite_frames_stop_run: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut parasite_move_stop_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 77 as libc::c_int,
            lastframe: 82 as libc::c_int,
            frame: parasite_frames_stop_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn parasite_start_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
        *fresh6 = &mut parasite_move_stand;
    } else {
        let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
        *fresh7 = &mut parasite_move_start_run;
    };
}
#[no_mangle]
pub unsafe extern "C" fn parasite_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh8 = (*self_0).monsterinfo.currentmove;
        *fresh8 = &mut parasite_move_stand;
    } else {
        let ref mut fresh9 = (*self_0).monsterinfo.currentmove;
        *fresh9 = &mut parasite_move_run;
    };
}
#[no_mangle]
pub static mut parasite_frames_walk: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut parasite_move_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 70 as libc::c_int,
            lastframe: 76 as libc::c_int,
            frame: parasite_frames_walk.as_ptr() as *mut _,
            endfunc: Some(parasite_walk as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut parasite_frames_start_walk: [mframe_t; 2] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 30 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    parasite_walk as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut parasite_move_start_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 68 as libc::c_int,
            lastframe: 69 as libc::c_int,
            frame: parasite_frames_start_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut parasite_frames_stop_walk: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut parasite_move_stop_walk: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 77 as libc::c_int,
            lastframe: 82 as libc::c_int,
            frame: parasite_frames_stop_walk.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn parasite_start_walk(mut self_0: *mut edict_t) {
    let ref mut fresh10 = (*self_0).monsterinfo.currentmove;
    *fresh10 = &mut parasite_move_start_walk;
}
#[no_mangle]
pub unsafe extern "C" fn parasite_walk(mut self_0: *mut edict_t) {
    let ref mut fresh11 = (*self_0).monsterinfo.currentmove;
    *fresh11 = &mut parasite_move_walk;
}
#[no_mangle]
pub static mut parasite_frames_pain1: [mframe_t; 11] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut parasite_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 57 as libc::c_int,
            lastframe: 67 as libc::c_int,
            frame: parasite_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(parasite_start_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn parasite_pain(
    mut self_0: *mut edict_t,
    mut other: *mut edict_t,
    ...
    *fresh12 = &mut parasite_move_pain1;
}
unsafe extern "C" fn parasite_drain_attack_ok(
    mut start: *mut vec_t,
    mut end: *mut vec_t,
) -> qboolean {
    ...
    if VectorLength(dir.as_mut_ptr()) > 256 as libc::c_int as libc::c_float {
        return false_0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn parasite_drain_attack(mut self_0: *mut edict_t) {
    ...
    offset[2 as libc::c_int as usize] = 6 as libc::c_int as vec_t;
    G_ProjectSource(
    ...
    if parasite_drain_attack_ok(start.as_mut_ptr(), end.as_mut_ptr()) as u64 == 0 {
        end[2 as libc::c_int
            as usize] = (*(*self_0).enemy).s.origin[2 as libc::c_int as usize]
            + (*(*self_0).enemy).maxs[2 as libc::c_int as usize]
    ...
    if (*self_0).s.frame == 41 as libc::c_int {
        ...
        if (*self_0).s.frame == 42 as libc::c_int {
            (gi.sound)
                .expect(
                    "non-null function pointer",
                )(
    ...
    (gi.WriteByte)
        .expect("non-null function pointer")(TE_PARASITE_ATTACK as libc::c_int);
    (gi.WriteShort)
        .expect(
            "non-null function pointer",
    ...
    dir[0 as libc::c_int
        as usize] = start[0 as libc::c_int as usize] - end[0 as libc::c_int as usize];
    dir[1 as libc::c_int
        as usize] = start[1 as libc::c_int as usize] - end[1 as libc::c_int as usize];
    dir[2 as libc::c_int
        as usize] = start[2 as libc::c_int as usize] - end[2 as libc::c_int as usize];
    T_Damage(
        (*self_0).enemy,
        self_0,
        self_0,
...
#[no_mangle]
pub static mut parasite_frames_drain: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    parasite_launch as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                thinkfunc: Some(
                    parasite_drain_attack as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    parasite_reel_in as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut parasite_move_drain: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 39 as libc::c_int,
            lastframe: 56 as libc::c_int,
            frame: parasite_frames_drain.as_ptr() as *mut _,
            endfunc: Some(parasite_start_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut parasite_frames_break: [mframe_t; 32] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut parasite_move_break: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 31 as libc::c_int,
            frame: parasite_frames_break.as_ptr() as *mut _,
            endfunc: Some(parasite_start_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn parasite_attack(mut self_0: *mut edict_t) {
    let ref mut fresh13 = (*self_0).monsterinfo.currentmove;
    *fresh13 = &mut parasite_move_drain;
}
#[no_mangle]
pub unsafe extern "C" fn parasite_dead(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut parasite_frames_death: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut parasite_move_death: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 32 as libc::c_int,
            lastframe: 38 as libc::c_int,
            frame: parasite_frames_death.as_ptr() as *mut _,
            endfunc: Some(parasite_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn parasite_die(
    mut self_0: *mut edict_t,
    ...
    *fresh14 = &mut parasite_move_death;
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_parasite(mut self_0: *mut edict_t) {
    ...
    sound_pain1 = (gi.soundindex)
        ...
        b"parasite/parpain1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        ...
        b"parasite/parpain2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_die = (gi.soundindex)
        ...
        b"parasite/pardeth1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_launch = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"parasite/paratck1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_impact = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"parasite/paratck2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_suck = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"parasite/paratck3.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_reelin = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"parasite/paratck4.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_sight = (gi.soundindex)
        ...
        b"parasite/parsght1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_tap = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"parasite/paridle1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_scratch = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"parasite/paridle2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_search = (gi.soundindex)
        ...
        b"parasite/parsrch1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0)
        .s
        ...
        b"models/monsters/parasite/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0).mins[0 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    ...
    (*self_0).maxs[0 as libc::c_int as usize] = 16 as libc::c_int as vec_t;
    (*self_0).maxs[1 as libc::c_int as usize] = 16 as libc::c_int as vec_t;
    (*self_0).maxs[2 as libc::c_int as usize] = 24 as libc::c_int as vec_t;
    ...
    *fresh17 = Some(parasite_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh18 = (*self_0).monsterinfo.walk;
    *fresh18 = Some(parasite_start_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh19 = (*self_0).monsterinfo.run;
    *fresh19 = Some(parasite_start_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh20 = (*self_0).monsterinfo.attack;
    *fresh20 = Some(parasite_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh21 = (*self_0).monsterinfo.sight;
    *fresh21 = Some(
        parasite_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    let ref mut fresh22 = (*self_0).monsterinfo.idle;
    *fresh22 = Some(parasite_idle as unsafe extern "C" fn(*mut edict_t) -> ());
    (gi.linkentity).expect("non-null function pointer")(self_0);
    let ref mut fresh23 = (*self_0).monsterinfo.currentmove;
    *fresh23 = &mut parasite_move_stand;
