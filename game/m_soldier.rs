...
static mut sound_sight1: libc::c_int = 0;
static mut sound_sight2: libc::c_int = 0;
static mut sound_pain_light: libc::c_int = 0;
static mut sound_pain: libc::c_int = 0;
static mut sound_pain_ss: libc::c_int = 0;
static mut sound_death_light: libc::c_int = 0;
static mut sound_death: libc::c_int = 0;
static mut sound_death_ss: libc::c_int = 0;
static mut sound_cock: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn soldier_idle(mut self_0: *mut edict_t) {
    if ((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double > 0.8f64
    {
        (gi.sound)
            .expect(
...
#[no_mangle]
pub unsafe extern "C" fn soldier_cock(mut self_0: *mut edict_t) {
    if (*self_0).s.frame == 197 as libc::c_int {
        (gi.sound)
            .expect(
                "non-null function pointer",
            )(
...
#[no_mangle]
pub static mut soldier_frames_stand1: [mframe_t; 30] = unsafe {
    [
        {
            let mut init = mframe_t {
                ...
                thinkfunc: Some(soldier_idle as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut soldier_move_stand1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 146 as libc::c_int,
            lastframe: 175 as libc::c_int,
            frame: soldier_frames_stand1.as_ptr() as *mut _,
            endfunc: Some(soldier_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut soldier_frames_stand3: [mframe_t; 39] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(soldier_cock as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut soldier_move_stand3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 176 as libc::c_int,
            lastframe: 214 as libc::c_int,
            frame: soldier_frames_stand3.as_ptr() as *mut _,
            endfunc: Some(soldier_stand as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_stand(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.currentmove == &mut soldier_move_stand3 as *mut mmove_t
        || (((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.8f64
    {
        let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
        *fresh0 = &mut soldier_move_stand1;
    } else {
        let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
        *fresh1 = &mut soldier_move_stand3;
    };
}
#[no_mangle]
pub unsafe extern "C" fn soldier_walk1_random(mut self_0: *mut edict_t) {
    if ((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double > 0.1f64
    {
        (*self_0).monsterinfo.nextframe = 215 as libc::c_int;
    }
}
#[no_mangle]
pub static mut soldier_frames_walk1: [mframe_t; 33] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: -(1 as libc::c_int) as libc::c_float,
                thinkfunc: Some(
                    soldier_walk1_random as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_walk1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 215 as libc::c_int,
            lastframe: 247 as libc::c_int,
            frame: soldier_frames_walk1.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut soldier_frames_walk2: [mframe_t; 10] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_walk2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 256 as libc::c_int,
            lastframe: 265 as libc::c_int,
            frame: soldier_frames_walk2.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_walk(mut self_0: *mut edict_t) {
    if (((rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.5f64
    {
        let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
        *fresh2 = &mut soldier_move_walk1;
    } else {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut soldier_move_walk2;
    };
}
#[no_mangle]
pub static mut soldier_frames_start_run: [mframe_t; 2] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_start_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 97 as libc::c_int,
            lastframe: 98 as libc::c_int,
            frame: soldier_frames_start_run.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut soldier_frames_run: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 16 as libc::c_int as libc::c_float,
                thinkfunc: None,
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 99 as libc::c_int,
            lastframe: 104 as libc::c_int,
            frame: soldier_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
        *fresh4 = &mut soldier_move_stand1;
        return;
    }
    if (*self_0).monsterinfo.currentmove == &mut soldier_move_walk1 as *mut mmove_t
        || (*self_0).monsterinfo.currentmove == &mut soldier_move_walk2 as *mut mmove_t
        || (*self_0).monsterinfo.currentmove
            == &mut soldier_move_start_run as *mut mmove_t
    {
        let ref mut fresh5 = (*self_0).monsterinfo.currentmove;
        *fresh5 = &mut soldier_move_run;
    } else {
        let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
        *fresh6 = &mut soldier_move_start_run;
    };
}
#[no_mangle]
pub static mut soldier_frames_pain1: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 50 as libc::c_int,
            lastframe: 54 as libc::c_int,
            frame: soldier_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut soldier_frames_pain2: [mframe_t; 7] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 55 as libc::c_int,
            lastframe: 61 as libc::c_int,
            frame: soldier_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut soldier_frames_pain3: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_pain3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 62 as libc::c_int,
            lastframe: 79 as libc::c_int,
            frame: soldier_frames_pain3.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut soldier_frames_pain4: [mframe_t; 17] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_pain4: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 80 as libc::c_int,
            lastframe: 96 as libc::c_int,
            frame: soldier_frames_pain4.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_pain(
    ...
    if level.time < (*self_0).pain_debounce_time {
        if (*self_0).velocity[2 as libc::c_int as usize]
            ...
            && ((*self_0).monsterinfo.currentmove
                == &mut soldier_move_pain1 as *mut mmove_t
                || (*self_0).monsterinfo.currentmove
                    == &mut soldier_move_pain2 as *mut mmove_t
                || (*self_0).monsterinfo.currentmove
                    == &mut soldier_move_pain3 as *mut mmove_t)
        {
            let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
            *fresh7 = &mut soldier_move_pain4;
        }
        return;
    }
    (*self_0).pain_debounce_time = level.time + 3 as libc::c_int as libc::c_float;
    n = (*self_0).s.skinnum | 1 as libc::c_int;
...
static mut shotgun_flash: [libc::c_int; 8] = [
    41 as libc::c_int,
    42 as libc::c_int,
    84 as libc::c_int,
    87 as libc::c_int,
...
static mut machinegun_flash: [libc::c_int; 8] = [
    43 as libc::c_int,
    44 as libc::c_int,
    85 as libc::c_int,
    88 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn soldier_fire(
    mut self_0: *mut edict_t,
    mut flash_number: libc::c_int,
) {
    ...
    let mut flash_index: libc::c_int = 0;
    if (*self_0).s.skinnum < 2 as libc::c_int {
        flash_index = blaster_flash[flash_number as usize];
    } else if (*self_0).s.skinnum < 4 as libc::c_int {
        flash_index = shotgun_flash[flash_number as usize];
    } else {
        flash_index = machinegun_flash[flash_number as usize];
    }
    AngleVectors(
    ...
    G_ProjectSource(
        ...
        (*monster_flash_offset.as_mut_ptr().offset(flash_index as isize)).as_mut_ptr(),
        forward.as_mut_ptr(),
        right.as_mut_ptr(),
        start.as_mut_ptr(),
    );
    if flash_number == 5 as libc::c_int || flash_number == 6 as libc::c_int {
        aim[0 as libc::c_int as usize] = forward[0 as libc::c_int as usize];
        aim[1 as libc::c_int as usize] = forward[1 as libc::c_int as usize];
        aim[2 as libc::c_int as usize] = forward[2 as libc::c_int as usize];
    } else {
        end[0 as libc::c_int
        ...
        vectoangles(aim.as_mut_ptr(), dir.as_mut_ptr());
        AngleVectors(
            dir.as_mut_ptr(),
            forward.as_mut_ptr(),
            right.as_mut_ptr(),
        ...
        aim[2 as libc::c_int
            as usize] = end[2 as libc::c_int as usize]
            - start[2 as libc::c_int as usize];
        VectorNormalize(aim.as_mut_ptr());
    }
    if (*self_0).s.skinnum <= 1 as libc::c_int {
    ...
    } else if (*self_0).s.skinnum <= 3 as libc::c_int {
        ...
        if (*self_0).monsterinfo.aiflags & 0x80 as libc::c_int == 0 {
            (*self_0)
                .monsterinfo
                .pausetime = (level.time as libc::c_double
                + (3 as libc::c_int + rand() % 8 as libc::c_int) as libc::c_double
...
#[no_mangle]
pub unsafe extern "C" fn soldier_fire1(mut self_0: *mut edict_t) {
    soldier_fire(self_0, 0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn soldier_attack1_refire1(mut self_0: *mut edict_t) {
    if (*self_0).s.skinnum > 1 as libc::c_int {
        return;
    }
    ...
    if (*skill).value == 3 as libc::c_int as libc::c_float
        && (((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.5f64
        || range(self_0, (*self_0).enemy) == 0 as libc::c_int
    {
        (*self_0).monsterinfo.nextframe = 1 as libc::c_int;
    } else {
        (*self_0).monsterinfo.nextframe = 9 as libc::c_int;
    };
}
#[no_mangle]
pub unsafe extern "C" fn soldier_attack1_refire2(mut self_0: *mut edict_t) {
    if (*self_0).s.skinnum < 2 as libc::c_int {
        return;
    }
    if (*(*self_0).enemy).health <= 0 as libc::c_int {
...
#[no_mangle]
pub static mut soldier_frames_attack1: [mframe_t; 12] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_fire1 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_attack1_refire1 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_attack1_refire2 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 11 as libc::c_int,
            frame: soldier_frames_attack1.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_fire2(mut self_0: *mut edict_t) {
    soldier_fire(self_0, 1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn soldier_attack2_refire1(mut self_0: *mut edict_t) {
    if (*self_0).s.skinnum > 1 as libc::c_int {
        return;
    }
    if (*(*self_0).enemy).health <= 0 as libc::c_int {
    ...
    if (*skill).value == 3 as libc::c_int as libc::c_float
        ...
        || range(self_0, (*self_0).enemy) == 0 as libc::c_int
    {
        (*self_0).monsterinfo.nextframe = 15 as libc::c_int;
    } else {
        (*self_0).monsterinfo.nextframe = 27 as libc::c_int;
    };
}
#[no_mangle]
pub unsafe extern "C" fn soldier_attack2_refire2(mut self_0: *mut edict_t) {
    if (*self_0).s.skinnum < 2 as libc::c_int {
        return;
    }
    if (*(*self_0).enemy).health <= 0 as libc::c_int {
...
#[no_mangle]
pub static mut soldier_frames_attack2: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_fire2 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_attack2_refire1 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_attack2_refire2 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_attack2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 12 as libc::c_int,
            lastframe: 29 as libc::c_int,
            frame: soldier_frames_attack2.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_duck_down(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x800 as libc::c_int != 0 {
        return;
    }
    (*self_0).monsterinfo.aiflags |= 0x800 as libc::c_int;
    let ref mut fresh12 = (*self_0).maxs[2 as libc::c_int as usize];
    *fresh12 -= 32 as libc::c_int as libc::c_float;
...
#[no_mangle]
pub unsafe extern "C" fn soldier_duck_up(mut self_0: *mut edict_t) {
    (*self_0).monsterinfo.aiflags &= !(0x800 as libc::c_int);
    let ref mut fresh13 = (*self_0).maxs[2 as libc::c_int as usize];
    *fresh13 += 32 as libc::c_int as libc::c_float;
    (*self_0).takedamage = DAMAGE_AIM as libc::c_int;
    (gi.linkentity).expect("non-null function pointer")(self_0);
}
#[no_mangle]
pub unsafe extern "C" fn soldier_fire3(mut self_0: *mut edict_t) {
    soldier_duck_down(self_0);
    soldier_fire(self_0, 2 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn soldier_attack3_refire(mut self_0: *mut edict_t) {
    if level.time as libc::c_double + 0.4f64
        < (*self_0).monsterinfo.pausetime as libc::c_double
    {
        (*self_0).monsterinfo.nextframe = 32 as libc::c_int;
    }
}
#[no_mangle]
pub static mut soldier_frames_attack3: [mframe_t; 9] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_fire3 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_attack3_refire as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_duck_up as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_attack3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 30 as libc::c_int,
            lastframe: 38 as libc::c_int,
            frame: soldier_frames_attack3.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_fire4(mut self_0: *mut edict_t) {
    soldier_fire(self_0, 3 as libc::c_int);
}
#[no_mangle]
pub static mut soldier_frames_attack4: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_fire4 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_attack4: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 39 as libc::c_int,
            lastframe: 44 as libc::c_int,
            frame: soldier_frames_attack4.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_fire8(mut self_0: *mut edict_t) {
    soldier_fire(self_0, 7 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn soldier_attack6_refire(mut self_0: *mut edict_t) {
    if (*(*self_0).enemy).health <= 0 as libc::c_int {
        return;
    }
    if range(self_0, (*self_0).enemy) < 2 as libc::c_int {
        return;
    }
    if (*skill).value == 3 as libc::c_int as libc::c_float {
        (*self_0).monsterinfo.nextframe = 111 as libc::c_int;
    }
}
#[no_mangle]
pub static mut soldier_frames_attack6: [mframe_t; 14] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 11 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_fire8 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                thinkfunc: Some(
                    soldier_attack6_refire as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_attack6: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 109 as libc::c_int,
            lastframe: 122 as libc::c_int,
            frame: soldier_frames_attack6.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_attack(mut self_0: *mut edict_t) {
    if (*self_0).s.skinnum < 4 as libc::c_int {
        if (((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.5f64
        {
            let ref mut fresh14 = (*self_0).monsterinfo.currentmove;
            *fresh14 = &mut soldier_move_attack1;
        } else {
            let ref mut fresh15 = (*self_0).monsterinfo.currentmove;
            *fresh15 = &mut soldier_move_attack2;
        }
    } else {
        let ref mut fresh16 = (*self_0).monsterinfo.currentmove;
        *fresh16 = &mut soldier_move_attack4;
    };
}
#[no_mangle]
pub unsafe extern "C" fn soldier_sight(
    mut self_0: *mut edict_t,
    mut other: *mut edict_t,
) {
    if (((rand() & 0x7fff as libc::c_int) as libc::c_float
    ...
    if (*skill).value > 0 as libc::c_int as libc::c_float
        && range(self_0, (*self_0).enemy) >= 2 as libc::c_int
    {
        if ((rand() & 0x7fff as libc::c_int) as libc::c_float
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double > 0.5f64
        {
            let ref mut fresh17 = (*self_0).monsterinfo.currentmove;
            *fresh17 = &mut soldier_move_attack6;
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn soldier_duck_hold(mut self_0: *mut edict_t) {
    if level.time >= (*self_0).monsterinfo.pausetime {
        (*self_0).monsterinfo.aiflags &= !(0x80 as libc::c_int);
    } else {
        (*self_0).monsterinfo.aiflags |= 0x80 as libc::c_int;
...
#[no_mangle]
pub static mut soldier_frames_duck: [mframe_t; 5] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 5 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_duck_down as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        {
            let mut init = mframe_t {
                ...
                dist: -(1 as libc::c_int) as libc::c_float,
                thinkfunc: Some(
                    soldier_duck_hold as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_duck: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 45 as libc::c_int,
            lastframe: 49 as libc::c_int,
            frame: soldier_frames_duck.as_ptr() as *mut _,
            endfunc: Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_dodge(
    mut self_0: *mut edict_t,
    ...
    if (*skill).value == 0 as libc::c_int as libc::c_float {
        ...
        *fresh19 = &mut soldier_move_duck;
        return;
    }
    (*self_0)
        .monsterinfo
        .pausetime = ((level.time + eta) as libc::c_double + 0.3f64) as libc::c_float;
    r = (rand() & 0x7fff as libc::c_int) as libc::c_float
        / 0x7fff as libc::c_int as libc::c_float;
    if (*skill).value == 1 as libc::c_int as libc::c_float {
        if r as libc::c_double > 0.33f64 {
            let ref mut fresh20 = (*self_0).monsterinfo.currentmove;
            *fresh20 = &mut soldier_move_duck;
        } else {
            let ref mut fresh21 = (*self_0).monsterinfo.currentmove;
            *fresh21 = &mut soldier_move_attack3;
        }
        return;
    }
    if (*skill).value >= 2 as libc::c_int as libc::c_float {
        if r as libc::c_double > 0.66f64 {
            let ref mut fresh22 = (*self_0).monsterinfo.currentmove;
            *fresh22 = &mut soldier_move_duck;
        } else {
            let ref mut fresh23 = (*self_0).monsterinfo.currentmove;
            *fresh23 = &mut soldier_move_attack3;
        }
        return;
    }
    let ref mut fresh24 = (*self_0).monsterinfo.currentmove;
    *fresh24 = &mut soldier_move_attack3;
}
#[no_mangle]
pub unsafe extern "C" fn soldier_fire6(mut self_0: *mut edict_t) {
    soldier_fire(self_0, 5 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn soldier_fire7(mut self_0: *mut edict_t) {
    soldier_fire(self_0, 6 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn soldier_dead(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut soldier_frames_death1: [mframe_t; 36] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_fire6 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    soldier_fire7 as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut soldier_move_death1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 272 as libc::c_int,
            lastframe: 307 as libc::c_int,
            frame: soldier_frames_death1.as_ptr() as *mut _,
            endfunc: Some(soldier_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut soldier_frames_death2: [mframe_t; 35] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_death2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 308 as libc::c_int,
            lastframe: 342 as libc::c_int,
            frame: soldier_frames_death2.as_ptr() as *mut _,
            endfunc: Some(soldier_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut soldier_frames_death3: [mframe_t; 45] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_death3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 343 as libc::c_int,
            lastframe: 387 as libc::c_int,
            frame: soldier_frames_death3.as_ptr() as *mut _,
            endfunc: Some(soldier_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut soldier_frames_death4: [mframe_t; 53] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_death4: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 388 as libc::c_int,
            lastframe: 440 as libc::c_int,
            frame: soldier_frames_death4.as_ptr() as *mut _,
            endfunc: Some(soldier_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut soldier_frames_death5: [mframe_t; 24] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_death5: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 441 as libc::c_int,
            lastframe: 464 as libc::c_int,
            frame: soldier_frames_death5.as_ptr() as *mut _,
            endfunc: Some(soldier_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut soldier_frames_death6: [mframe_t; 10] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut soldier_move_death6: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 465 as libc::c_int,
            lastframe: 474 as libc::c_int,
            frame: soldier_frames_death6.as_ptr() as *mut _,
            endfunc: Some(soldier_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn soldier_die(
    mut self_0: *mut edict_t,
    ...
    if fabs(
        ((*self_0).s.origin[2 as libc::c_int as usize]
            + (*self_0).viewheight as libc::c_float
            - *point.offset(2 as libc::c_int as isize)) as libc::c_double,
    ) <= 4 as libc::c_int as libc::c_double
    {
        let ref mut fresh25 = (*self_0).monsterinfo.currentmove;
        *fresh25 = &mut soldier_move_death3;
        return;
    }
    n = rand() % 5 as libc::c_int;
    if n == 0 as libc::c_int {
        let ref mut fresh26 = (*self_0).monsterinfo.currentmove;
        *fresh26 = &mut soldier_move_death1;
    } else if n == 1 as libc::c_int {
        let ref mut fresh27 = (*self_0).monsterinfo.currentmove;
        *fresh27 = &mut soldier_move_death2;
    } else if n == 2 as libc::c_int {
        let ref mut fresh28 = (*self_0).monsterinfo.currentmove;
        *fresh28 = &mut soldier_move_death4;
    } else if n == 3 as libc::c_int {
        let ref mut fresh29 = (*self_0).monsterinfo.currentmove;
        *fresh29 = &mut soldier_move_death5;
    } else {
        let ref mut fresh30 = (*self_0).monsterinfo.currentmove;
        *fresh30 = &mut soldier_move_death6;
    };
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_soldier_x(mut self_0: *mut edict_t) {
    (*self_0)
        .s
        ...
        b"models/monsters/soldier/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0).monsterinfo.scale = 1.200000f64 as libc::c_float;
    (*self_0).mins[0 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(16 as libc::c_int) as vec_t;
    (*self_0).mins[2 as libc::c_int as usize] = -(24 as libc::c_int) as vec_t;
    (*self_0).maxs[0 as libc::c_int as usize] = 16 as libc::c_int as vec_t;
    ...
    sound_idle = (gi.soundindex)
        ...
        b"soldier/solidle1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_sight1 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"soldier/solsght1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_sight2 = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"soldier/solsrch1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_cock = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
    ...
    (*self_0).mass = 100 as libc::c_int;
    let ref mut fresh31 = (*self_0).pain;
    *fresh31 = Some(
        soldier_pain
    ...
    let ref mut fresh32 = (*self_0).die;
    *fresh32 = Some(
        soldier_die
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh33 = (*self_0).monsterinfo.stand;
    *fresh33 = Some(soldier_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh34 = (*self_0).monsterinfo.walk;
    *fresh34 = Some(soldier_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh35 = (*self_0).monsterinfo.run;
    *fresh35 = Some(soldier_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh36 = (*self_0).monsterinfo.dodge;
    *fresh36 = Some(
        soldier_dodge
            as unsafe extern "C" fn(*mut edict_t, *mut edict_t, libc::c_float) -> (),
    );
    let ref mut fresh37 = (*self_0).monsterinfo.attack;
    *fresh37 = Some(soldier_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh38 = (*self_0).monsterinfo.melee;
    *fresh38 = None;
    let ref mut fresh39 = (*self_0).monsterinfo.sight;
    *fresh39 = Some(
        soldier_sight as unsafe extern "C" fn(*mut edict_t, *mut edict_t) -> (),
    );
    (gi.linkentity).expect("non-null function pointer")(self_0);
...
#[no_mangle]
pub unsafe extern "C" fn SP_monster_soldier_light(mut self_0: *mut edict_t) {
    if (*deathmatch).value != 0. {
        G_FreeEdict(self_0);
        return;
    }
    SP_monster_soldier_x(self_0);
    sound_pain_light = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"soldier/solpain2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_death_light = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"soldier/soldeth2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (gi.modelindex)
        .expect(
    ...
    (*self_0).health = 20 as libc::c_int;
    (*self_0).gib_health = -(30 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_soldier(mut self_0: *mut edict_t) {
    if (*deathmatch).value != 0. {
        G_FreeEdict(self_0);
        return;
    }
    ...
    sound_pain = (gi.soundindex)
        ...
        b"soldier/solpain1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_death = (gi.soundindex)
        ...
        b"soldier/soldeth1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (gi.soundindex)
        .expect(
    ...
    (*self_0).health = 30 as libc::c_int;
    (*self_0).gib_health = -(30 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_soldier_ss(mut self_0: *mut edict_t) {
    if (*deathmatch).value != 0. {
        G_FreeEdict(self_0);
        return;
    }
    SP_monster_soldier_x(self_0);
    sound_pain_ss = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"soldier/solpain3.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_death_ss = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"soldier/soldeth3.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (gi.soundindex)
        .expect(
    ...
    (*self_0).s.skinnum = 4 as libc::c_int;
    (*self_0).health = 40 as libc::c_int;
    (*self_0).gib_health = -(30 as libc::c_int);
}
