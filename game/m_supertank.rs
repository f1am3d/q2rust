...
static mut tread_sound: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn TreadSound(mut self_0: *mut edict_t) {
    (gi.sound)
        .expect(
...
#[no_mangle]
pub unsafe extern "C" fn supertank_search(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub static mut supertank_frames_stand: [mframe_t; 60] = unsafe {
    [
        {
...
#[no_mangle]
pub static mut supertank_move_stand: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 194 as libc::c_int,
            lastframe: 253 as libc::c_int,
            frame: supertank_frames_stand.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn supertank_stand(mut self_0: *mut edict_t) {
    let ref mut fresh0 = (*self_0).monsterinfo.currentmove;
    *fresh0 = &mut supertank_move_stand;
}
#[no_mangle]
pub static mut supertank_frames_run: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                thinkfunc: Some(TreadSound as unsafe extern "C" fn(*mut edict_t) -> ()),
            };
            init
        },
        {
...
#[no_mangle]
pub static mut supertank_move_run: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 128 as libc::c_int,
            lastframe: 145 as libc::c_int,
            frame: supertank_frames_run.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_forward: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_forward: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 128 as libc::c_int,
            lastframe: 145 as libc::c_int,
            frame: supertank_frames_forward.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn supertank_forward(mut self_0: *mut edict_t) {
    let ref mut fresh1 = (*self_0).monsterinfo.currentmove;
    *fresh1 = &mut supertank_move_forward;
}
#[no_mangle]
pub unsafe extern "C" fn supertank_walk(mut self_0: *mut edict_t) {
    let ref mut fresh2 = (*self_0).monsterinfo.currentmove;
    *fresh2 = &mut supertank_move_forward;
}
#[no_mangle]
pub unsafe extern "C" fn supertank_run(mut self_0: *mut edict_t) {
    if (*self_0).monsterinfo.aiflags & 0x1 as libc::c_int != 0 {
        let ref mut fresh3 = (*self_0).monsterinfo.currentmove;
        *fresh3 = &mut supertank_move_stand;
    } else {
        let ref mut fresh4 = (*self_0).monsterinfo.currentmove;
        *fresh4 = &mut supertank_move_run;
    };
}
#[no_mangle]
pub static mut supertank_frames_turn_right: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_turn_right: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 176 as libc::c_int,
            lastframe: 193 as libc::c_int,
            frame: supertank_frames_turn_right.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut supertank_frames_turn_left: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_turn_left: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 146 as libc::c_int,
            lastframe: 163 as libc::c_int,
            frame: supertank_frames_turn_left.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_pain3: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_pain3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 172 as libc::c_int,
            lastframe: 175 as libc::c_int,
            frame: supertank_frames_pain3.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_pain2: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_pain2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 168 as libc::c_int,
            lastframe: 171 as libc::c_int,
            frame: supertank_frames_pain2.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_pain1: [mframe_t; 4] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_pain1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 164 as libc::c_int,
            lastframe: 167 as libc::c_int,
            frame: supertank_frames_pain1.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_death1: [mframe_t; 24] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_death: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 98 as libc::c_int,
            lastframe: 121 as libc::c_int,
            frame: supertank_frames_death1.as_ptr() as *mut _,
            endfunc: Some(supertank_dead as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut supertank_frames_backward: [mframe_t; 18] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_backward: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 80 as libc::c_int,
            lastframe: 97 as libc::c_int,
            frame: supertank_frames_backward.as_ptr() as *mut _,
            endfunc: None,
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_attack4: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_attack4: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 74 as libc::c_int,
            lastframe: 79 as libc::c_int,
            frame: supertank_frames_attack4.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_attack3: [mframe_t; 27] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_attack3: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 47 as libc::c_int,
            lastframe: 73 as libc::c_int,
            frame: supertank_frames_attack3.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_attack2: [mframe_t; 27] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
        ...
        },
        {
            let mut init = mframe_t {
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    supertankRocket as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut supertank_move_attack2: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 20 as libc::c_int,
            lastframe: 46 as libc::c_int,
            frame: supertank_frames_attack2.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_attack1: [mframe_t; 6] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
                ...
                dist: 0 as libc::c_int as libc::c_float,
                thinkfunc: Some(
                    supertankMachineGun as unsafe extern "C" fn(*mut edict_t) -> (),
                ),
            };
            init
        },
...
#[no_mangle]
pub static mut supertank_move_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 0 as libc::c_int,
            lastframe: 5 as libc::c_int,
            frame: supertank_frames_attack1.as_ptr() as *mut _,
            endfunc: Some(
                supertank_reattack1 as unsafe extern "C" fn(*mut edict_t) -> (),
            ),
        };
        init
    }
...
#[no_mangle]
pub static mut supertank_frames_end_attack1: [mframe_t; 14] = unsafe {
    [
        {
            let mut init = mframe_t {
                aifunc: Some(
...
#[no_mangle]
pub static mut supertank_move_end_attack1: mmove_t = unsafe {
    {
        let mut init = mmove_t {
            firstframe: 6 as libc::c_int,
            lastframe: 19 as libc::c_int,
            frame: supertank_frames_end_attack1.as_ptr() as *mut _,
            endfunc: Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ()),
        };
        init
    }
...
#[no_mangle]
pub unsafe extern "C" fn supertank_reattack1(mut self_0: *mut edict_t) {
    if visible(self_0, (*self_0).enemy) as u64 != 0 {
            ...
            / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.9f64
        {
            ...
            *fresh5 = &mut supertank_move_attack1;
        } else {
            let ref mut fresh6 = (*self_0).monsterinfo.currentmove;
            *fresh6 = &mut supertank_move_end_attack1;
        }
    } else {
        let ref mut fresh7 = (*self_0).monsterinfo.currentmove;
        *fresh7 = &mut supertank_move_end_attack1;
    };
}
#[no_mangle]
pub unsafe extern "C" fn supertank_pain(
    ...
    if (*skill).value >= 2 as libc::c_int as libc::c_float {
        if (*self_0).s.frame >= 20 as libc::c_int
            && (*self_0).s.frame <= 33 as libc::c_int
        {
            return;
        }
    }
    ...
    if damage <= 10 as libc::c_int {
        ...
        *fresh8 = &mut supertank_move_pain1;
        ...
        *fresh9 = &mut supertank_move_pain2;
    } else {
        (gi.sound)
            .expect(
                "non-null function pointer",
        ...
        *fresh10 = &mut supertank_move_pain3;
    };
}
#[no_mangle]
pub unsafe extern "C" fn supertankRocket(mut self_0: *mut edict_t) {
    ...
    if (*self_0).s.frame == 27 as libc::c_int {
        flash_number = 70 as libc::c_int;
    } else if (*self_0).s.frame == 30 as libc::c_int {
        flash_number = 71 as libc::c_int;
    } else {
        flash_number = 72 as libc::c_int;
    }
    AngleVectors(
...
#[no_mangle]
pub unsafe extern "C" fn supertankMachineGun(mut self_0: *mut edict_t) {
    let mut dir: vec3_t = [0.; 3];
    let mut vec: vec3_t = [0.; 3];
    let mut start: vec3_t = [0.; 3];
    let mut forward: vec3_t = [0.; 3];
    let mut right: vec3_t = [0.; 3];
    let mut flash_number: libc::c_int = 0;
    flash_number = 64 as libc::c_int + ((*self_0).s.frame - 0 as libc::c_int);
    dir[0 as libc::c_int as usize] = 0 as libc::c_int as vec_t;
    dir[1 as libc::c_int as usize] = (*self_0).s.angles[1 as libc::c_int as usize];
...
#[no_mangle]
pub unsafe extern "C" fn supertank_attack(mut self_0: *mut edict_t) {
    let mut vec: vec3_t = [0.; 3];
    ...
    if range <= 160 as libc::c_int as libc::c_float {
        let ref mut fresh11 = (*self_0).monsterinfo.currentmove;
        *fresh11 = &mut supertank_move_attack1;
        ...
        / 0x7fff as libc::c_int as libc::c_float) as libc::c_double) < 0.3f64
    {
        ...
        *fresh12 = &mut supertank_move_attack1;
    } else {
        let ref mut fresh13 = (*self_0).monsterinfo.currentmove;
        *fresh13 = &mut supertank_move_attack2;
    };
}
#[no_mangle]
pub unsafe extern "C" fn supertank_dead(mut self_0: *mut edict_t) {
...
#[no_mangle]
pub unsafe extern "C" fn BossExplode(mut self_0: *mut edict_t) {
    let mut org: vec3_t = [0.; 3];
    let mut n: libc::c_int = 0;
    let ref mut fresh14 = (*self_0).think;
    *fresh14 = Some(BossExplode as unsafe extern "C" fn(*mut edict_t) -> ());
    org[0 as libc::c_int as usize] = (*self_0).s.origin[0 as libc::c_int as usize];
    org[1 as libc::c_int as usize] = (*self_0).s.origin[1 as libc::c_int as usize];
    org[2 as libc::c_int as usize] = (*self_0).s.origin[2 as libc::c_int as usize];
    org[2 as libc::c_int as usize]
        += (24 as libc::c_int + (rand() & 15 as libc::c_int)) as libc::c_float;
    let ref mut fresh15 = (*self_0).count;
    let fresh16 = *fresh15;
    *fresh15 = *fresh15 + 1;
    match fresh16 {
        0 => {
            org[0 as libc::c_int as usize] -= 24 as libc::c_int as libc::c_float;
            org[1 as libc::c_int as usize] -= 24 as libc::c_int as libc::c_float;
        }
        1 => {
            org[0 as libc::c_int as usize] += 24 as libc::c_int as libc::c_float;
            org[1 as libc::c_int as usize] += 24 as libc::c_int as libc::c_float;
        ...
        4 => {
            org[0 as libc::c_int as usize] -= 48 as libc::c_int as libc::c_float;
            org[1 as libc::c_int as usize] -= 48 as libc::c_int as libc::c_float;
        }
        5 => {
            org[0 as libc::c_int as usize] += 48 as libc::c_int as libc::c_float;
            org[1 as libc::c_int as usize] += 48 as libc::c_int as libc::c_float;
        ...
        8 => {
            ...
            ThrowGib(
                self_0,
                b"models/objects/gibs/chest/tris.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                500 as libc::c_int,
                0 as libc::c_int,
            );
            ThrowHead(
                self_0,
                b"models/objects/gibs/gear/tris.md2\0" as *const u8
                    as *const libc::c_char as *mut libc::c_char,
                500 as libc::c_int,
                1 as libc::c_int,
            );
    ...
    (gi.WritePosition).expect("non-null function pointer")(org.as_mut_ptr());
    (gi.multicast)
        .expect(
            "non-null function pointer",
...
#[no_mangle]
pub unsafe extern "C" fn supertank_die(
    mut self_0: *mut edict_t,
    ...
    *fresh17 = &mut supertank_move_death;
}
#[no_mangle]
pub unsafe extern "C" fn SP_monster_supertank(mut self_0: *mut edict_t) {
    ...
    sound_pain1 = (gi.soundindex)
        ...
        b"bosstank/btkpain1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_pain2 = (gi.soundindex)
        ...
        b"bosstank/btkpain2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_pain3 = (gi.soundindex)
        ...
        b"bosstank/btkpain3.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_death = (gi.soundindex)
        ...
        b"bosstank/btkdeth1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_search1 = (gi.soundindex)
        ...
        b"bosstank/btkunqv1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    sound_search2 = (gi.soundindex)
        ...
        b"bosstank/btkunqv2.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    tread_sound = (gi.soundindex)
        .expect(
            "non-null function pointer",
        )(
        b"bosstank/btkengn1.wav\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    ...
    (*self_0)
        ...
        b"models/monsters/boss1/tris.md2\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
    );
    (*self_0).mins[0 as libc::c_int as usize] = -(64 as libc::c_int) as vec_t;
    (*self_0).mins[1 as libc::c_int as usize] = -(64 as libc::c_int) as vec_t;
    (*self_0).mins[2 as libc::c_int as usize] = 0 as libc::c_int as vec_t;
    (*self_0).maxs[0 as libc::c_int as usize] = 64 as libc::c_int as vec_t;
    (*self_0).maxs[1 as libc::c_int as usize] = 64 as libc::c_int as vec_t;
    (*self_0).maxs[2 as libc::c_int as usize] = 112 as libc::c_int as vec_t;
    (*self_0).health = 1500 as libc::c_int;
    (*self_0).gib_health = -(500 as libc::c_int);
    (*self_0).mass = 800 as libc::c_int;
    let ref mut fresh18 = (*self_0).pain;
    *fresh18 = Some(
        supertank_pain
    ...
    let ref mut fresh19 = (*self_0).die;
    *fresh19 = Some(
        supertank_die
            as unsafe extern "C" fn(
                *mut edict_t,
    ...
    let ref mut fresh20 = (*self_0).monsterinfo.stand;
    *fresh20 = Some(supertank_stand as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh21 = (*self_0).monsterinfo.walk;
    *fresh21 = Some(supertank_walk as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh22 = (*self_0).monsterinfo.run;
    *fresh22 = Some(supertank_run as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh23 = (*self_0).monsterinfo.dodge;
    *fresh23 = None;
    let ref mut fresh24 = (*self_0).monsterinfo.attack;
    *fresh24 = Some(supertank_attack as unsafe extern "C" fn(*mut edict_t) -> ());
    let ref mut fresh25 = (*self_0).monsterinfo.search;
    *fresh25 = Some(supertank_search as unsafe extern "C" fn(*mut edict_t) -> ());
    ...
    *fresh28 = &mut supertank_move_stand;
