...
extern "C" {
    ...
    fn G_SetSpectatorStats(ent: *mut edict_t);
    fn G_SetStats(ent: *mut edict_t);
    fn G_CheckChaseStats(ent: *mut edict_t);
...
pub unsafe extern "C" fn G_SetClientSound(mut ent: *mut edict_t) {
    ...
    if (*(*ent).client).pers.game_helpchanged != game.helpchanged {
        ...
        (*(*ent).client).pers.helpchanged = 1 as libc::c_int;
    }
    if (*(*ent).client).pers.helpchanged != 0
        && (*(*ent).client).pers.helpchanged <= 3 as libc::c_int
        && level.framenum & 63 as libc::c_int == 0
    {
        let ref mut fresh17 = (*(*ent).client).pers.helpchanged;
        *fresh17 += 1;
        (gi.sound)
            .expect(
                "non-null function pointer",
...
pub unsafe extern "C" fn ClientEndServerFrame(mut ent: *mut edict_t) {
    ...
    *fresh20 += bobmove;
    ...
    SV_CalcBlend(ent);
    if (*(*ent).client).resp.spectator as u64 != 0 {
