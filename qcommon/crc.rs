...
static mut crctable: [libc::c_ushort; 256] = [
...
pub unsafe extern "C" fn CRC_ProcessByte(
    ...
    *crcvalue = ((*crcvalue as libc::c_int) << 8 as libc::c_int
        ^ crctable[(*crcvalue as libc::c_int >> 8 as libc::c_int ^ data as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn CRC_Block(
    mut start: *mut byte,
    ...
    loop {
        ...
        crc = ((crc as libc::c_int) << 8 as libc::c_int
            ^ crctable[(crc as libc::c_int >> 8 as libc::c_int ^ *fresh1 as libc::c_int)
                as usize] as libc::c_int) as libc::c_ushort;
    }
    return crc;
}
