...
#[no_mangle]
pub static mut loadname: [libc::c_char; 32] = [0; 32];
#[no_mangle]
pub static mut mod_novis: [byte; 8192] = [0; 8192];
#[no_mangle]
pub static mut mod_known: [model_t; 256] = [model_t {
    name: [0; 64],
...
#[no_mangle]
pub static mut mod_inline: [model_t; 256] = [model_t {
    name: [0; 64],
    registration_sequence: 0,
    type_0: mod_bad,
    numframes: 0,
...
pub unsafe extern "C" fn Mod_ForName(
    ...
    if i == mod_numknown {
        if mod_numknown == 256 as libc::c_int {
            (ri.Sys_Error)
                .expect(
                    "non-null function pointer",
                )(
    ...
    match LittleLong(*buf as libc::c_int) {
        844121161 => {
            let ref mut fresh0 = (*loadmodel).extradata;
            *fresh0 = Hunk_Begin(0x200000 as libc::c_int);
            Mod_LoadAliasModel(mod_0, buf as *mut libc::c_void);
        }
        844317769 => {
            let ref mut fresh1 = (*loadmodel).extradata;
            *fresh1 = Hunk_Begin(0x10000 as libc::c_int);
            Mod_LoadSpriteModel(mod_0, buf as *mut libc::c_void);
        }
        1347633737 => {
            let ref mut fresh2 = (*loadmodel).extradata;
            *fresh2 = Hunk_Begin(0x1000000 as libc::c_int);
...
pub unsafe extern "C" fn Mod_DecompressVis(
    ...
    if in_0.is_null() {
        while row != 0 {
            let fresh3 = out;
            out = out.offset(1);
            *fresh3 = 0xff as libc::c_int as byte;
            row -= 1;
        }
        ...
        if *in_0 != 0 {
            ...
            *fresh5 = *fresh4;
            ...
            while c != 0 {
                let fresh6 = out;
                out = out.offset(1);
                *fresh6 = 0 as libc::c_int as byte;
                c -= 1;
            }
        }
...
pub unsafe extern "C" fn Mod_LoadLighting(mut l: *mut lump_t) {
    ...
    size = (*l).filelen / 3 as libc::c_int;
    let ref mut fresh8 = (*loadmodel).lightdata;
    *fresh8 = Hunk_Alloc(size) as *mut byte;
    in_0 = mod_base.offset((*l).fileofs as isize) as *mut libc::c_void as *mut byte;
    i = 0 as libc::c_int;
    while i < size {
        ...
        {
            *((*loadmodel).lightdata)
                .offset(i as isize) = *in_0.offset(0 as libc::c_int as isize);
        ...
        {
            *((*loadmodel).lightdata)
                .offset(i as isize) = *in_0.offset(1 as libc::c_int as isize);
        } else {
            *((*loadmodel).lightdata)
                .offset(i as isize) = *in_0.offset(2 as libc::c_int as isize);
        }
        i += 1;
...
#[no_mangle]
pub static mut r_leaftovis: [libc::c_int; 65536] = [0; 65536];
#[no_mangle]
pub static mut r_vistoleaf: [libc::c_int; 65536] = [0; 65536];
#[no_mangle]
pub static mut r_numvisleafs: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn R_NumberLeafs(mut node: *mut mnode_t) {
    let mut leaf: *mut mleaf_t = 0 as *mut mleaf_t;
    let mut leafnum: libc::c_int = 0;
    if (*node).contents != -(1 as libc::c_int) {
        leaf = node as *mut mleaf_t;
        leafnum = leaf.offset_from((*loadmodel).leafs) as libc::c_long as libc::c_int;
        if (*leaf).contents & 1 as libc::c_int != 0 {
            return;
        }
        r_leaftovis[leafnum as usize] = r_numvisleafs;
        r_vistoleaf[r_numvisleafs as usize] = leafnum;
        r_numvisleafs += 1;
        return;
    }
    R_NumberLeafs((*node).children[0 as libc::c_int as usize]);
    R_NumberLeafs((*node).children[1 as libc::c_int as usize]);
}
#[no_mangle]
...
pub unsafe extern "C" fn Mod_LoadVertexes(mut l: *mut lump_t) {
    ...
    count = ((*l).filelen as libc::c_ulong)
        ...
        as libc::c_int;
    out = Hunk_Alloc(
        ((count + 8 as libc::c_int) as libc::c_ulong)
...
pub unsafe extern "C" fn Mod_LoadSubmodels(mut l: *mut lump_t) {
    ...
    out = Hunk_Alloc(
        (count as libc::c_ulong)
            .wrapping_mul(::std::mem::size_of::<dmodel_t>() as libc::c_ulong)
            as libc::c_int,
    ) as *mut dmodel_t;
...
pub unsafe extern "C" fn Mod_LoadEdges(mut l: *mut lump_t) {
    ...
    out = Hunk_Alloc(
        ((count + 13 as libc::c_int) as libc::c_ulong)
...
pub unsafe extern "C" fn Mod_LoadTexinfo(mut l: *mut lump_t) {
    ...
    count = ((*l).filelen as libc::c_ulong)
        ...
        as libc::c_int;
    out = Hunk_Alloc(
        ((count + 6 as libc::c_int) as libc::c_ulong)
    ...
    *fresh14 = out;
    ...
    while i < count {
        ...
        len1 = VectorLength(((*out).vecs[0 as libc::c_int as usize]).as_mut_ptr());
        len2 = VectorLength(((*out).vecs[1 as libc::c_int as usize]).as_mut_ptr());
        len1 = (len1 + len2) / 2 as libc::c_int as libc::c_float;
        if (len1 as libc::c_double) < 0.32f64 {
            (*out).mipadjust = 4 as libc::c_int as libc::c_float;
        } else if (len1 as libc::c_double) < 0.49f64 {
            (*out).mipadjust = 3 as libc::c_int as libc::c_float;
        } else if (len1 as libc::c_double) < 0.99f64 {
            (*out).mipadjust = 2 as libc::c_int as libc::c_float;
        } else {
            (*out).mipadjust = 1 as libc::c_int as libc::c_float;
        }
        ...
        let ref mut fresh16 = (*out).image;
        *fresh16 = R_FindImage(name.as_mut_ptr(), it_wall);
        if ((*out).image).is_null() {
            let ref mut fresh17 = (*out).image;
            *fresh17 = r_notexture_mip;
    ...
    while i < count {
        ...
        while !step.is_null() && step != out {
            let ref mut fresh18 = (*out).numframes;
            *fresh18 += 1;
            step = (*step).next;
        }
        i += 1;
...
pub unsafe extern "C" fn CalcSurfaceExtents(mut s: *mut msurface_t) {
    ...
    while i < 2 as libc::c_int {
        ...
        (*s)
            ...
            as libc::c_short;
        if ((*s).extents[i as usize] as libc::c_int) < 16 as libc::c_int {
            (*s).extents[i as usize] = 16 as libc::c_int as libc::c_short;
        }
        if (*tex).flags & (0x8 as libc::c_int | 0x4 as libc::c_int) == 0
            && (*s).extents[i as usize] as libc::c_int > 256 as libc::c_int
        {
            (ri.Sys_Error)
                .expect(
                    "non-null function pointer",
                ...
                1 as libc::c_int,
                b"Bad surface extents\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
            );
        }
        i += 1;
...
pub unsafe extern "C" fn Mod_LoadFaces(mut l: *mut lump_t) {
    ...
    let ref mut fresh19 = (*loadmodel).surfaces;
    *fresh19 = out;
    ...
    while surfnum < count {
        ...
        if (*out).numedges < 3 as libc::c_int {
            (ri.Sys_Error)
                .expect(
                    "non-null function pointer",
                )(
                1 as libc::c_int,
                b"Surface with %s edges\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                (*out).numedges,
            );
        }
        ...
        let ref mut fresh20 = (*out).plane;
        *fresh20 = ((*loadmodel).planes).offset(planenum as isize);
        let ref mut fresh21 = (*out).texinfo;
        *fresh21 = ((*loadmodel).texinfo)
            .offset(LittleShort((*in_0).texinfo) as libc::c_int as isize);
        ...
        if i == -(1 as libc::c_int) {
            let ref mut fresh22 = (*out).samples;
            *fresh22 = 0 as *mut byte;
        } else {
            let ref mut fresh23 = (*out).samples;
            *fresh23 = ((*loadmodel).lightdata).offset((i / 3 as libc::c_int) as isize);
        }
        if !((*(*out).texinfo).image).is_null() {
            if (*(*out).texinfo).flags & 0x4 as libc::c_int != 0 {
                (*out).flags |= 4 as libc::c_int;
            } else if (*(*out).texinfo).flags & 0x8 as libc::c_int != 0 {
                ...
                while i < 2 as libc::c_int {
                    ...
                    (*out)
                        .texturemins[i
                        as usize] = -(8192 as libc::c_int) as libc::c_short;
                    i += 1;
                }
            } else if (*(*out).texinfo).flags & 0x40 as libc::c_int != 0 {
                (*out).flags |= 0x10 as libc::c_int | 0x100 as libc::c_int;
                i = 0 as libc::c_int;
                while i < 2 as libc::c_int {
                    (*out).extents[i as usize] = 16384 as libc::c_int as libc::c_short;
                    (*out)
...
pub unsafe extern "C" fn Mod_SetParent(
    ...
    let ref mut fresh24 = (*node).parent;
    *fresh24 = parent;
    if (*node).contents != -(1 as libc::c_int) {
        return;
    }
...
pub unsafe extern "C" fn Mod_LoadNodes(mut l: *mut lump_t) {
    ...
    let ref mut fresh25 = (*loadmodel).nodes;
    *fresh25 = out;
    ...
    while i < count {
        j = 0 as libc::c_int;
        while j < 3 as libc::c_int {
            (*out).minmaxs[j as usize] = LittleShort((*in_0).mins[j as usize]);
            (*out)
                .minmaxs[(3 as libc::c_int + j)
                as usize] = LittleShort((*in_0).maxs[j as usize]);
            j += 1;
        }
        p = LittleLong((*in_0).planenum);
        let ref mut fresh26 = (*out).plane;
        *fresh26 = ((*loadmodel).planes).offset(p as isize);
        (*out)
        ...
        while j < 2 as libc::c_int {
            ...
            if p >= 0 as libc::c_int {
                let ref mut fresh27 = (*out).children[j as usize];
                *fresh27 = ((*loadmodel).nodes).offset(p as isize);
            } else {
                let ref mut fresh28 = (*out).children[j as usize];
                *fresh28 = ((*loadmodel).leafs)
...
pub unsafe extern "C" fn Mod_LoadLeafs(mut l: *mut lump_t) {
    ...
    let ref mut fresh29 = (*loadmodel).leafs;
    *fresh29 = out;
    ...
    while i < count {
        ...
        let ref mut fresh30 = (*out).firstmarksurface;
        *fresh30 = ((*loadmodel).marksurfaces)
            .offset(
...
pub unsafe extern "C" fn Mod_LoadMarksurfaces(mut l: *mut lump_t) {
    ...
    let ref mut fresh31 = (*loadmodel).marksurfaces;
    *fresh31 = out;
    ...
    while i < count {
        ...
        let ref mut fresh32 = *out.offset(i as isize);
        *fresh32 = ((*loadmodel).surfaces).offset(j as isize);
        i += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn Mod_LoadSurfedges(mut l: *mut lump_t) {
    ...
    count = ((*l).filelen as libc::c_ulong)
        ...
        as libc::c_int;
    out = Hunk_Alloc(
        ((count + 24 as libc::c_int) as libc::c_ulong)
            .wrapping_mul(::std::mem::size_of::<libc::c_int>() as libc::c_ulong)
            as libc::c_int,
    ) as *mut libc::c_int;
    let ref mut fresh33 = (*loadmodel).surfedges;
    *fresh33 = out;
...
pub unsafe extern "C" fn Mod_LoadPlanes(mut l: *mut lump_t) {
    ...
    out = Hunk_Alloc(
        ((count + 6 as libc::c_int) as libc::c_ulong)
            .wrapping_mul(::std::mem::size_of::<mplane_t>() as libc::c_ulong)
            as libc::c_int,
    ) as *mut mplane_t;
    let ref mut fresh34 = (*loadmodel).planes;
    *fresh34 = out;
...
pub unsafe extern "C" fn Mod_LoadAliasModel(
    ...
    while i < (*pheader).num_skins {
        let ref mut fresh35 = (*mod_0).skins[i as usize];
        *fresh35 = R_FindImage(
...
pub unsafe extern "C" fn Mod_LoadSpriteModel(
    ...
    while i < (*sprout).numframes {
        ...
        let ref mut fresh36 = (*mod_0).skins[i as usize];
        *fresh36 = R_FindImage(
            ((*((*sprout).frames).as_mut_ptr().offset(i as isize)).name).as_mut_ptr(),
            it_sprite,
        );
...
pub unsafe extern "C" fn R_BeginRegistration(mut model: *mut libc::c_char) {
    ...
    r_worldmodel = R_RegisterModel(fullname.as_mut_ptr());
    R_NewMap();
}
#[no_mangle]
